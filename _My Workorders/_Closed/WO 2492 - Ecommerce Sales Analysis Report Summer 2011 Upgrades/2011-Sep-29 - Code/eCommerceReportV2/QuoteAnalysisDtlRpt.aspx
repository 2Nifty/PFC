...
<head id="Head1" runat="server">
    ...
    function PrintReport()
    {
        ...
        var hwin=window.open('QuoteAnalysisDtlRptPreview.aspx?'+url, '', 'height=700,width=1010,scrollbars=no,status=no,top='+((screen.height/2) - (1010/2))+',left='+((screen.width/2) - (1010/2))+',resizable=NO',"");
        hwin.focus();
    }
...
<body>
    <form id="frmDtl" runat="server">        
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td>
                    <div class="Sbar" id="div-datagrid" style="overflow-x: auto; overflow-y: auto; position: relative; top: 0px; left: 0px; width: 1020px; height: 500px; border: 0px solid;">
                            <asp:DataGrid UseAccessibleHeader="true" ID="dgQuoteAnalysis" Width="1270" runat="server"
                                ...
                                <Columns>                                    
                                    <asp:BoundColumn HeaderStyle-Width="100" HeaderText="Quote Method" ItemStyle-Width="100" FooterStyle-HorizontalAlign="Center"
                                        DataField="QuoteMethod" SortExpression="QuoteMethod" />                                   
                                    <asp:TemplateColumn HeaderText="Quotation Date">
                                        <HeaderStyle Width="70px" />
                                        <ItemTemplate>
                                            <asp:Label Style="cursor:hand;" ID="lblQuoteDate" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"QuotationDate")%>' Font-Underline="true" />
                                    ...
                                    <asp:BoundColumn HeaderStyle-Width="70" HeaderText="Expiry Date" ItemStyle-HorizontalAlign="left" FooterStyle-HorizontalAlign="left"
                                        DataField="ExpiryDate" DataFormatString="{0:MM/dd/yyyy}" SortExpression="ExpiryDate" />
