<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DEL_QuoteAnalysisHdrRpt.aspx.cs" Inherits="QuoteAnalysisHdrRpt" %>
...
<head id="Head1" runat="server">
    <title>Quote Header Analysis Report</title>
    ...
    <script type="text/javascript">
        ...
        function PrintReport()
        {
            ...
            var hwin=window.open('QuoteAnalysisHdrRptPreview.aspx?'+url, '', 'height=700,width=1010,scrollbars=no,status=no,top='+((screen.height/2) - (1010/2))+',left='+((screen.width/2) - (1010/2))+',resizable=NO',"");
            hwin.focus();
        }
        ...
        {
            var str=QuoteAnalysisHdrRpt.DeleteExcel('QuoteAnalysisHdrRpt'+session).value.toString();
            parent.window.close();
        }    
    </script>     
</head>
<body>
    <form id="frmQuoteHdr" runat="server">
                ...
                <td>
                    <div class="Sbar" id="div-datagrid" style="overflow-x: auto; overflow-y: auto; position: relative;
                        top: 0px; left: 0px; width: 1010px; height: 510px; border: 0px solid;">
                            <asp:DataGrid UseAccessibleHeader="true" ID="dgQuoteAnalysis" Width="695px" runat="server"
                                ...
                                <Columns>
                                    <asp:BoundColumn HeaderStyle-Width="100" HeaderText="Quote Method" ItemStyle-Width="100"
                                        ItemStyle-HorizontalAlign="Left" ItemStyle-CssClass="5pxLeft" DataField="QuoteMethod" SortExpression="QuoteMethod" />
