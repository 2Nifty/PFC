...
alert('PrintReport');
        ...
        var hwin=window.open(eCommerceSalesAnalysisCustRptPreview.aspx?'+url, '', 'height=700,width=750,scrollbars=no,status=no,top='+((screen.height/2) - (700/2))+',left='+((screen.width/2) - (750/2))+',resizable=NO',"");
        hwin.focus();
    }
                                        ...
                                        <td align="right" style="width: 30%; padding-right: 5px;">
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img id="btnPrint" src="../common/images/Print.gif" style="cursor: hand" onclick="javascript:PrintReport();" /></td>
                                                    <td>
                                                        <img id="btnClose" src="../Common/images/close.gif" style="cursor: hand" onclick="javascript:Close('<%=Session["SessionID"].ToString() %>');" /></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                ...
                                top: 0px; left: 0px; width: 1020px; height: 500px; border: 0px solid;">
                                    <asp:DataGrid ID="dgECommSales" Width="1750px" runat="server" GridLines="both" BorderWidth="1px"
                                        ...
                                        <FooterStyle CssClass="GridHead" BackColor="#DFF3F9" BorderColor="#DAEEEF" Height="20px"
                                            HorizontalAlign="Center" Wrap="false" />
                                        <Columns>
                                            <asp:BoundColumn HeaderStyle-Width="40" HeaderText="Cust #" ItemStyle-Width="40"
                                                DataField="CustomerNumber" SortExpression="CustomerNumber" />
                                            <asp:BoundColumn HeaderStyle-Width="250" HeaderText="Name" ItemStyle-Width="250"
                                                FooterStyle-HorizontalAlign="right" DataField="CustomerName" SortExpression="CustomerName" />
                                            <asp:BoundColumn HeaderStyle-Width="20" HeaderText="Brn" ItemStyle-Width="20" FooterStyle-HorizontalAlign="right"
                                                DataField="SalesLocationCode" SortExpression="SalesLocationCode" />
                                            <asp:TemplateColumn HeaderStyle-Width="40" HeaderText="# of Quotes" ItemStyle-Width="40"
                                                ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="right" SortExpression="NoOfECommQuotes">
                                                <ItemTemplate>
                                            ...
                                            <asp:BoundColumn HeaderStyle-Width="100" HeaderText="Extended $ Amt" ItemStyle-Width="100"
                                                ItemStyle-HorizontalAlign="right" FooterStyle-HorizontalAlign="right" DataField="ECommExtAmount"
                                                DataFormatString="{0:c}" SortExpression="ECommExtAmount" />
                                            <asp:BoundColumn HeaderStyle-Width="100" HeaderText="Extended Weight" ItemStyle-Width="100"
                                                ItemStyle-HorizontalAlign="right" FooterStyle-HorizontalAlign="right" DataField="ECommExtWeight"
                                                DataFormatString="{0:#,##0.00}" SortExpression="ECommExtWeight" />
                                            <asp:TemplateColumn HeaderStyle-Width="40" HeaderText="# of Orders" ItemStyle-Width="40"
                                                ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="right" SortExpression="NoOfECommOrders">
                                                <ItemTemplate>
                                            ...
                                            <asp:BoundColumn HeaderStyle-Width="100" HeaderText="Extended $ Amt" ItemStyle-Width="100"
                                                ItemStyle-HorizontalAlign="right" FooterStyle-HorizontalAlign="right" DataField="ECommExtOrdAmount"
                                                DataFormatString="{0:c}" SortExpression="ECommExtOrdAmount" />
                                            <asp:BoundColumn HeaderStyle-Width="100" HeaderText="Extended Weight" ItemStyle-Width="100"
                                                ItemStyle-HorizontalAlign="right" FooterStyle-HorizontalAlign="right" DataField="ECommExtOrdWeight"
                                                SortExpression="ECommExtOrdWeight" DataFormatString="{0:#,##0.00}" />
                                            <asp:TemplateColumn HeaderStyle-Width="40" HeaderText="# of Quotes" ItemStyle-Width="40"
                                                ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="right" SortExpression="NoOfManualQuotes">
                                                <ItemTemplate>
                                            ...
                                            <asp:BoundColumn HeaderStyle-Width="100" HeaderText="Extended $ Amt" ItemStyle-Width="100"
                                                ItemStyle-HorizontalAlign="right" FooterStyle-HorizontalAlign="right" DataField="ManualExtAmount"
                                                DataFormatString="{0:c}" SortExpression="ManualExtAmount" />
                                            <asp:BoundColumn HeaderStyle-Width="100" HeaderText="Extended Weight" ItemStyle-Width="100"
                                                ItemStyle-HorizontalAlign="right" FooterStyle-HorizontalAlign="right" DataField="ManualExtWeight"
                                                DataFormatString="{0:#,##0.00}" SortExpression="ManualExtWeight" />
                                            <asp:TemplateColumn HeaderStyle-Width="40" HeaderText="# of Orders" ItemStyle-Width="40"
                                                ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="right" SortExpression="NoOfManualOrders">
                                                <ItemTemplate>
                                            ...
                                            <asp:BoundColumn HeaderStyle-Width="100" HeaderText="Extended $ Amt" ItemStyle-Width="100"
                                                ItemStyle-HorizontalAlign="right" FooterStyle-HorizontalAlign="right" DataField="ManualExtOrdAmount"
                                                DataFormatString="{0:c}" SortExpression="ManualExtOrdAmount" />
                                            <asp:BoundColumn HeaderStyle-Width="100" HeaderText="Extended Weight" ItemStyle-Width="100"
                                                ItemStyle-HorizontalAlign="right" FooterStyle-HorizontalAlign="right" DataField="ManualExtOrdWeight"
                                                SortExpression="ManualExtOrdWeight" DataFormatString="{0:#,##0.00}" />
                                            <asp:TemplateColumn HeaderStyle-Width="40" HeaderText="# of Quotes" ItemStyle-Width="40"
                                                ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="right" SortExpression="NoOfMissedECommQuotes">
                                                <ItemTemplate>
                                            ...
                                            <asp:BoundColumn HeaderStyle-Width="100" HeaderText="Extended $ Amt" ItemStyle-Width="100"
                                                ItemStyle-HorizontalAlign="right" FooterStyle-HorizontalAlign="right" DataField="MissedECommExtAmount"
                                                DataFormatString="{0:c}" SortExpression="MissedECommExtAmount" />
                                            <asp:BoundColumn HeaderStyle-Width="100" HeaderText="Extended Weight" ItemStyle-Width="100"
                                                ItemStyle-HorizontalAlign="right" FooterStyle-HorizontalAlign="right" DataField="MissedECommExtWeight"
                                                DataFormatString="{0:#,##0.00}" SortExpression="MissedECommExtWeight" />
                                            <asp:TemplateColumn HeaderStyle-Width="40" HeaderText="# of Quotes" ItemStyle-Width="40"
                                                ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="right" SortExpression="NoOfMissedManualQuotes">
                                                <ItemTemplate>
                                            ...
                                            <asp:BoundColumn HeaderStyle-Width="100" HeaderText="Extended $ Amt" ItemStyle-Width="100"
                                                ItemStyle-HorizontalAlign="right" FooterStyle-HorizontalAlign="right" DataField="MissedManualExtAmount"
                                                DataFormatString="{0:c}" SortExpression="MissedManualExtAmount" />
                                            <asp:BoundColumn HeaderStyle-Width="100" HeaderText="Extended Weight" ItemStyle-Width="100"
                                                ItemStyle-HorizontalAlign="right" FooterStyle-HorizontalAlign="right" DataField="MissedManualExtWeight"
                                                SortExpression="MissedManualExtWeight" DataFormatString="{0:#,##0.00}" />
                                        </Columns>
                                    </asp:DataGrid>
                                    <center>
