select [Bill-to Customer No_], [Last Date Modified], [Last Modified By], * from [Porteous$Customer]
where [No_]='201696' or [No_]='100455'


update [Porteous$Customer]
set 	--[Bill-to Customer No_] = '100455',
[Last Date Modified]=CAST(FLOOR(CAST(GetDate() AS FLOAT))AS DATETIME),
	[Last Modified By]='TOD'
where [No_]='100455' --'201696' --or [No_]='062651'



select fBillToNo, * from tERPCustUpdate
