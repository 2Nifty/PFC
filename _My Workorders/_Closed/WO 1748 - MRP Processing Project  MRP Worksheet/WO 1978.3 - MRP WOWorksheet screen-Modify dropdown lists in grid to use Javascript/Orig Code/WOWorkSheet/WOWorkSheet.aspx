    ...
    <script>
        ...
        function ShowToolTip(event,strURL1,strURL2,strURL3,ctlID)
        {
            if(event.button==2)
            {
                ...
                URL2 = strURL2;
                URL3 = strURL3;
                xstooltip_show('divToolTip', ctlID, 0, 0, event);
                return false;
            }
        }
...
<body onunload="javascript:UnloadPage();" onmouseout="javascript:if(document.getElementById('Tooltip')!=null)document.getElementById('Tooltip').style.display = 'none';">
                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td class="Left2pxPadd Right2pxPadd">
                                                    <asp:DropDownList Width="150" ID="ddlActionStatus" Height="20px" TabIndex="1" CssClass="FormCtrl" runat="server"></asp:DropDownList>
                                                </td>
                                                <td colspan="2">&nbsp;</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="Left2pxPadd Right2pxPadd">
                                                    <asp:DropDownList Width="150" ID="ddlPriorityCd" Height="20px" TabIndex="2" CssClass="FormCtrl" runat="server"></asp:DropDownList>
                                                </td>
                                        ...
                                        <div runat="server" id="divWSGrid" visible="true">
                                            <div id="divdatagrid" class="Sbar" align="left" runat="server" onscroll="SetCoord()"
                                                style="overflow:auto; width:1020px; position:relative; top:0px; left:0px; height:473px; border:0px solid; vertical-align:top; overflow-y:scroll;">
                                                    <asp:DataGrid ID="dgWorkSheet" Width="1200px" runat="server" BorderWidth="1px" BorderColor="#DAEEEF" CssClass="grid"
                                                        ...
                                                        OnItemDataBound="dgWorkSheet_ItemDataBound" OnSortCommand="dgWorkSheet_SortCommand" AllowPaging="True" PageSize="17">
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateColumn HeaderText="Action Status" SortExpression="ActionStatus">
                                                                    <ItemTemplate>
                                                                        <asp:DropDownList Width="125px" Height="18px" ID="ddlActionStatusGrid" CssClass="FormCtrl" runat="server"
                                                                            OnSelectedIndexChanged="ddlActionStatusGrid_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                                                    </ItemTemplate>
                                                                ...
                                                                <asp:TemplateColumn HeaderText="Priority Code" SortExpression="PriorityCd">
                                                                    <ItemTemplate>
                                                                        <asp:DropDownList Width="125px" Height="18px" ID="ddlPriorityCdGrid" CssClass="FormCtrl" runat="server"
                                                                            OnSelectedIndexChanged="ddlPriorityCdGrid_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                                                    </ItemTemplate>
                                                                    <ItemStyle Width="130px" HorizontalAlign="Center" VerticalAlign="Middle" />
                                                                </asp:TemplateColumn>
...
<%--onkeydown="ConvertKeyPress(this.id)"--%>
                                                                ...
                                                                <asp:TemplateColumn HeaderText="Branch" SortExpression="WOBranch">
                                                                    <ItemTemplate>
                                                                        <asp:DropDownList Width="50" Height="18px" ID="ddlWOBranch" CssClass="FormCtrl" runat="server"
                                                                            OnSelectedIndexChanged="ddlWOBranch_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                                                    </ItemTemplate>
                                                                    <ItemStyle Width="55px" HorizontalAlign="Center" VerticalAlign="Middle" />
                                                                </asp:TemplateColumn>
        ...
        <div id="divToolTip" oncontextmenu="Javascript:return false;" class=MarkItUp_ContextMenu_MenuTable style="display:none;word-break:keep-all;" onmousedown="HideToolTip(this.id)">
            <table width="125px"  border="0" cellpadding=0 cellspacing=0 bordercolor=#000099 class="MarkItUp_ContextMenu_Outline">
                  <tr>
                    <td class="bgmsgboxtile">
                        <table width="100%"  border="0" cellspacing="0" cellpadding=0>
                          <tr>
                            <td width="90%" class="txtBlue">Item No Options</td>
                            <td width="10%" align="center" valign="middle"><div align="right"><span class="bgmsgboxtile"><img src="../Common/images/closeicon.gif"  id=imgDivClose style="cursor:hand;" onmousedown="HideToolTip(this.id)" alt="Close"></span></div></td>
                          </tr>
                        </table>
                    </td>
                  </tr>
                        ...
                        <table width=100% border=0 cellspacing=0>
                            <tr onmouseover="this.className='MarkItUp_ContextMenu_MenuItemBar_Over'" onclick="OpenURL1();" onmouseout="this.className='MarkItUp_ContextMenu_MenuItem'" class=MarkItUp_ContextMenu_MenuItem>
                                ...
                                <td width=90% valign=middle>
                                    <div id=divCAS  style="vertical-align:middle;word-wrap:normal;" class=MarkItUp_ContextMenu_MenuItem onclick="OpenURL1();">CPR</div>
                                </td>
                            </tr>
                            <tr onmouseover="this.className='MarkItUp_ContextMenu_MenuItemBar_Over'" onclick="OpenURL2();" onmouseout="this.className='MarkItUp_ContextMenu_MenuItem'" class=MarkItUp_ContextMenu_MenuItem>
                                <td width=10% valign=middle><img src="../Common/images/email.gif" /></td>
                                <td width=90% valign=middle>
                                    <div id=divReport class=MarkItUp_ContextMenu_MenuItem style="vertical-align:middle;word-wrap:normal;" onclick="OpenURL2();">Stock Status</div>
                                </td>
                            </tr>
                            <tr onmouseover="this.className='MarkItUp_ContextMenu_MenuItemBar_Over'" onclick="OpenURL3();" onmouseout="this.className='MarkItUp_ContextMenu_MenuItem'" class=MarkItUp_ContextMenu_MenuItem>
                                <td width=10% valign=middle><img src="../Common/images/email.gif" /></td>
                                <td width=90% valign=middle>
                                    <div id=div1 class=MarkItUp_ContextMenu_MenuItem style="vertical-align:middle;word-wrap:normal;" onclick="OpenURL3();">BOM</div>
                                </td>
                            </tr>
                        </table>
                    </td>
