...
/*
select count(*) from tFix_ItemBranchUsage1
where CurPeriodNo ='200711' --and CurPeriodNo <='200808'



select CurPeriodNo, count(*)
from tFix_ItemBranchUsage1
group by CurPeriodNo


select distinct EntryId from tFix_ItemBranchUsage1
select distinct ChangeId from tFix_ItemBranchUsage1


update tFix_ItemBranchUsage1
set	ChangeID='WO2306_FixIBU_InitialLoadNR'
where Changeid='WO2306_FixIBU_InitialLoad'
