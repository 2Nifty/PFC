drop proc [pCustPriceGetHist-WO1832]
go
...
CREATE Procedure [dbo].[pCustPriceGetHist-WO1832]
@CustNo varchar(20)
as
/*
	=============================================
...
if isnull(@RecsFound,0) > 0
	...
	FROM
		...
		From
			...
			Left Outer Join CustomerPrice Price (Nolock) ON
				Price.ItemNo = CAS.GroupNo
				and Price.CustNo = SOH.SellToCustNo
