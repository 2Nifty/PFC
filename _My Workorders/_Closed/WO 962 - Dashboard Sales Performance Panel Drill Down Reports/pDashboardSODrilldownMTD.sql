...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[pDashboardSODrilldownMTD]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[pDashboardSODrilldownMTD]
GO
