...
(select IBUval.*, mainIBU.* from tempItemBranchUsageTOD mainIBU inner join
...
WHERE	tempItemBranchUsageTOD.pItemBranchUsageID = IBUupd.pItemBranchUsageID



select 
Location, ItemNo, CurPeriodNo, CurBegOnHandQty, CurBegOnHandDol, CurBegOnHandWght, CurEndOHQty, CurEndOHDol, CurEndOHWght, *
from tempItemBranchUsageTOD where ChangeDt > getdate()-1
