...
FROM	[Porteous$Actual Usage Entry] AUE
INNER JOIN tWO1112NucorNutsAndMetricsAUE ON AUE.[Item No_]=OldItem AND AUE.[Usage Location]=Location
--where [Item No_]='20056-0630-080'
order by [Variance No_]



select * from tWO1112NucorNutsAndMetricsAUE
where OldItem='20056-0630-080'


SELECT	DISTINCT tWO1112NucorNutsAndMetricsAUE.*, AUE.*
FROM	[Porteous$Actual Usage Entry] AUE
INNER JOIN tWO1112NucorNutsAndMetricsAUE ON AUE.[Item No_]=OldItem AND AUE.[Usage Location]=Location
...
--exists
SELECT * FROM [Porteous$Stockkeeping Unit] WHERE [Location Code]='10' AND [Item No_]='20056-0630-090'
select * from [Porteous$Actual Usage Entry] WHERE [Usage Location]='10' AND [Item No_]='20056-0630-080'

--does not exist
SELECT * FROM [Porteous$Stockkeeping Unit] WHERE [Location Code]='05' AND [Item No_]='00208-2400-040'