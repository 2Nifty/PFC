...
--BULK
--Create tempVelocity table of BULK Items that have a Super Equiv
...
WHERE	(EXISTS
	(SELECT * FROM tempVelocity
	 WHERE ((Quantity / 12) / [Super Equiv_ Qty_] >= 10.0) AND ([Item No_]=No_) AND ([Corp Fixed Velocity Code] = '')))
go
...
WHERE	(EXISTS
	(SELECT * FROM tempVelocity
	 WHERE ((Quantity / 12) / [Super Equiv_ Qty_] >= 4.0) AND ((Quantity / 12) / [Super Equiv_ Qty_] < 10.0) AND ([Item No_]=No_) AND ([Corp Fixed Velocity Code] = '')))
go
...
WHERE	(EXISTS
	(SELECT * FROM tempVelocity
	 WHERE ((Quantity / 12) / [Super Equiv_ Qty_] >= 1.6) AND ((Quantity / 12) / [Super Equiv_ Qty_] < 4.0) AND ([Item No_]=No_) AND ([Corp Fixed Velocity Code] = '')))
go
...
WHERE	(EXISTS
	(SELECT * FROM tempVelocity
	 WHERE ((Quantity / 12) / [Super Equiv_ Qty_] >= 0.7) AND ((Quantity / 12) / [Super Equiv_ Qty_] < 1.6) AND ([Item No_]=No_) AND ([Corp Fixed Velocity Code] = '')))
go
...
WHERE	(EXISTS
	(SELECT * FROM tempVelocity
	 WHERE ((Quantity / 12) / [Super Equiv_ Qty_] >= 0.3) AND ((Quantity / 12) / [Super Equiv_ Qty_] < 0.7) AND ([Item No_]=No_) AND ([Corp Fixed Velocity Code] = '')))
go
...
WHERE	(EXISTS
	(SELECT * FROM tempVelocity
	 WHERE ((Quantity / 12) / [Super Equiv_ Qty_] >= 0.1) AND ((Quantity / 12) / [Super Equiv_ Qty_] < 0.3) AND ([Item No_]=No_) AND ([Corp Fixed Velocity Code] = '')))
go
...
WHERE	(EXISTS
	(SELECT * FROM tempVelocity
	 WHERE ((Quantity / 12) / [Super Equiv_ Qty_] >= 0.01) AND ((Quantity / 12) / [Super Equiv_ Qty_] < 0.1) AND ([Item No_]=No_) AND ([Corp Fixed Velocity Code] = '')))
go
...
WHERE	(EXISTS
	(SELECT * FROM tempVelocity
	 WHERE ((Quantity / 12) / [Super Equiv_ Qty_] > 0) AND ((Quantity / 12) / [Super Equiv_ Qty_] < 0.01) AND ([Item No_]=No_) AND ([Corp Fixed Velocity Code] = '')))
go
