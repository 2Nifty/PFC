--select * from ErrorLog where appFunction='UPDCustMUGroup'
--delete from ErrorLog where appFunction='UPDCustMUGroup'

--select CustNo, ContractSchd3, ContractSchedule4, ContractSchedule5, ContractSchedule6, ContractSchedule7 from CustomerMaster

--update CustomerMaster
--set ContractSchd3='MARGIN 33',
-- ContractSchedule4='MARGIN 34',
-- ContractSchedule5='MARGIN 35',
-- ContractSchedule6='MARGIN 36',
-- ContractSchedule7='MARGIN 37'
--where CustNo='201512'
