...
<tr bgcolor="#DFF3F9">
    <td height="29" class="BluTopBord">
        <div id="Footer">
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <div align="right">
                            <asp:Image ImageUrl="~/Contractmaintenancereport/Common/Images/userinfo_left_rev.gif" runat="server"
                    ...
                    <td>
                        <div align="left">
                            <asp:Image ImageUrl="~/Contractmaintenancereport/Common/Images/userinfo_right_rev.gif" runat="server"
                                ID="imgFooterRightRev" /></div>
                    </td>
                    <td>
                        <a href="http://www.porteousfastener.com/" target=_blank class="tooltipAnchor" id="lnkCpyright" onmouseover="showHideCorporateTooltip(this.id,event,'show');";
                            >Copyright 2007. </a>
                    </td>
                    <td>
                        <div align="right">
        ...
        <div id="Tooltip" onmouseover="DisplayToolTip('true')" style="position:absolute;">
