<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SORecall.aspx.cs" Inherits="SORecall" %>
...
{
     var queryString="InvoiceNo="+document.getElementById ("txtInvoiceNo").value;
     var PopUp=window.open ("../InvoiceRecall.aspx?"+queryString,"Maximize",'height=420,width=570,scrollbars=no,status=no,top='+((screen.height/2) - (420/2))+',left='+((screen.width/2) - (570/2))+',resizable=NO',"");
     PopUp.focus();
}
//Invoice
...
<body>
    ...
    <asp:ScriptManager ID="ScriptManager1" EnablePartialRendering="true" runat="server">
        ...
        <table runat="server" cellpadding="0" cellspacing="0" width="100%" id="mainTable">
                        ...
                        <tr>
                            <td class="PageHead" style="height: 30px">
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                    <tr>
                                        <td valign="middle" align="left" width="25%" class="TabHead" style="padding-left: 10px;">
                                            Sales Order No:&nbsp;&nbsp;
                                                <asp:TextBox ID="txtOrderNo" runat="server" CssClass="lbl_whitebox" Font-Bold="false" Width="100px" AutoPostBack="true"
                                                    OnFocus="javascript:this.select();" OnTextChanged="txtOrderNo_TextChanged" OnChange="javascript:NewDocument();"></asp:TextBox>
                                        </td>
                                        <td valign="middle" align="left" width="21%" class="TabHead">
                                            Invoice No:&nbsp;&nbsp;
                                                <asp:TextBox ID="txtInvoiceNo" runat="server" CssClass="lbl_whitebox" Font-Bold="false" Width="100px" AutoPostBack="true"
                                                    OnFocus="javascript:this.select();" OnTextChanged="txtInvoiceNo_TextChanged" OnChange="javascript:NewDocument();"></asp:TextBox>
                                        </td>
                                        <td valign="middle" align="left" width="25%" class="TabHead">
                                            Orig Order No:&nbsp;&nbsp;
                                                <asp:TextBox ID="txtOrigOrderNo" runat="server" CssClass="lbl_whitebox" Font-Bold="false" Width="100px" AutoPostBack="true"
                                                    OnFocus="javascript:this.select();" OnTextChanged="txtOrigOrderNo_TextChanged" OnChange="javascript:NewDocument();"></asp:TextBox>
                                        </td>
                                        <td width="5%">
                                        </td>
                                        <td align="right" style="width:250px; padding-right: 3px;">
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                <tr>
                                                    <td>
                                                        <img align="middle" onclick ="javascript:OpenInvoiceForm();"
                                                            src="../SORecall/Images/btn_invoice.gif" style="cursor: hand; padding-right: 2px;" />
                                                    </td>
                                                    <td>
                                                        <img align="middle" onclick="javascript:LoadHelp();"
                                                            src="../Common/Images/help.gif" style="cursor: hand; padding-right: 2px;" />
                                                    </td>
                                                    <td>
                                                        <img align="right" onclick="javascript:Close();"
            ...
            <tr>
                <td>
                    <table id="tStatus" runat="server" visible="false" width="100%" height="570px" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td valign="top" style="padding-top:10px; padding-left:10px; padding-bottom:10px; font-size:large; font-weight:bold; color:Red;">
                    ...
                    <table id="tHeader1" runat="server" width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td width="10%" class="TabHead" style="padding-left: 10px;">
                                Order No:
                            </td>
                            <td width="11%">
                                <asp:Label ID="lblOrderNo" runat="server" Text="~Order No~"></asp:Label>
                            </td>
                            <td width="7%" style="padding-left:5px; border-left:solid thin lightblue;">
                                <asp:LinkButton ID="lnkSoldTo" runat="server" CssClass="TabHead" Text="Sold To:" Font-Bold="True"
                                    OnClientClick="Javascript:OpenSoldToForm();return false;"></asp:LinkButton>
                            </td>
                            <td width="24%">
                                <asp:Label ID="lblSellToName" runat="server" Text="~Sell To Name~"></asp:Label>
                            </td>
                            <td width="7%" style="padding-left:5px; border-left:solid thin lightblue;">
                                <asp:LinkButton ID="lnkShipTo" runat="server" CssClass="TabHead" Text="Ship To:" Font-Bold="True"
                                    OnClientClick="Javascript:OpenShipToForm();return false;"></asp:LinkButton>
                            </td>
                            <td width="24%">
                                <asp:Label ID="lblShipToName" runat="server" Text="~Ship To Name~"></asp:Label>
                            </td>
                            <td class="TabHead" width="10%" style="padding-left:5px; border-left:solid thin lightblue;">
                                Total Sales:
                            </td>
                        ...
                        <tr>
                            <td class="TabHead" style="padding-left: 10px;">Order Source:</td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td class="TabHead" style="padding-left:5px; border-left:solid thin lightblue;">
                                Total GM$/Lb:
                            </td>
                        ...
                        <tr>
                            <td style="padding-left: 10px" class="TabHead">
                                Order Date:
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblCustShipLoc" runat="server" Text="~Cust Ship~"></asp:Label>
                            </td>
                            <td style="padding-left:5px; border-left:solid thin lightblue;">
                                <asp:LinkButton ID="lnkBillTo" runat="server" CssClass="TabHead" Text="Bill To:" Font-Bold="True"
                                    OnClientClick="Javascript:OpenBillToForm();return false;"></asp:LinkButton>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblShipLoc" runat="server" Text="~Ship Loc~"></asp:Label>
                            </td>
                            <td style="padding-left:5px; border-left:solid thin lightblue;">
                        ...
                        <tr style="border-bottom:solid thin lightblue;">
                            <td class="TabHead" style="padding-left: 10px;">
                                Usage Loc:
                            </td>
                            <td>
                                <asp:Label ID="lblUsageLoc" runat="server" Text="~Usage Loc~"></asp:Label>
                            </td>
                            <td style="padding-left:5px; border-left:solid thin lightblue;">&nbsp;</td>
                            <td></td>
                            <td style="padding-left:5px; border-left:solid thin lightblue;">&nbsp;</td>
            ...
            <tr>
                <td>
                    <table id="tHeader2" runat="server" width="100%" style="border-top:solid thin lightblue; border-bottom:solid thin lightblue;" cellspacing="0" cellpadding="0">
                        <tr>
                            <td colspan="8">&nbsp;</td>
                        </tr>
                        <tr>
            ...
            <tr>
                <td>
                    <table id="tShipStatus1" visible="true" runat="server" width="100%" cellspacing="0" cellpadding="0">
                        <tr>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                            <td class="TabHead" width="10%" style="padding-left:5px;">
                                <asp:ImageButton ID="btnShipStatus" runat="server" ImageAlign="top" ImageUrl="Images/plus.jpg" OnClick="btnShipStatus_Click" />
                                Shipping Status
                            </td>
                        </tr>
                    ...
                    <table id="tShipStatus2" visible="false" runat="server" width="100%" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="200px">
                                <asp:Label ID="lblFlagID" runat="server" Text=""></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="TabHead" width="90px" style="padding-left:15px;">
                            ...
                            <td width="200">
                                <asp:Label runat="server" Text="Orig: " Font-Bold="true"></asp:Label>
                                <asp:Label ID="lblOrigShipDt" runat="server" Text="mm/dd/yyy"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:Label runat="server" Text="Act: " Font-Bold="true"></asp:Label>
                        ...
                        <tr>
                            ...
                            <td width="200px">
                                <asp:Label ID="lblResch" runat="server" Text=""></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td class="TabHead" width="90px" style="padding-left:15px;">
                            ...
                            <td width="200px">
                                <asp:Label ID="lblFrtCost" runat="server" Text=""></asp:Label>
                            </td>
                        </tr>
                    </table>
                    <table id="tShipStatus3" visible="false" runat="server" width="100%" style="border-bottom:solid thin lightblue;" cellspacing="0" cellpadding="0">
                        <tr>
                            <td class="TabHead" width="80px" style="padding-left:15px;">
                                Shipping Instr:
                            </td>
            ...
            <tr>
                <td>
                    <table id="tDetail" runat="server" width="100%" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td>
                                <div class="Sbar" runat="server" id="divdtlgrid" style="overflow: auto; position: relative;
                                    top: 2px; left: 0px; height: 250px; width: 1020px; border: 0px solid;">
                                    <asp:DataList ID="dlCommentTop" runat="server" Visible="false"  style="background-color:White; padding-top:3px; padding-bottom:3px; font-style: italic; font-weight: bold;">
                                        <ItemTemplate>
                                            <%# DataBinder.Eval(Container, "DataItem.CommText") %>
                                        </ItemTemplate>
                                        <ItemStyle Width="1865px" CssClass="lock" BackColor="white" />
                                    </asp:DataList>
                                    <asp:DataGrid ID="GridViewDtl1" UseAccessibleHeader="true" BackColor="#F4FBFD" runat="server" BorderWidth="0px"
                                        ShowFooter="False" AutoGenerateColumns="False" AllowPaging="false" Width="1865px"
                                        PagerStyle-Visible="false" OnItemDataBound="GridViewDtl1_ItemDataBound">
                                    ...
                                    <Columns>
                                        <asp:BoundColumn HeaderText="Cust. Item No" DataField="CustItemNo">
                                            <HeaderStyle CssClass="locked" Width="95px" Font-Bold="True" />
                                            <ItemStyle CssClass="locked" HorizontalAlign="Center" Width="95px" />
                                        </asp:BoundColumn>
                                        <asp:BoundColumn HeaderText="Item No" DataField="ItemNo">
                                         ...
                                         <asp:TemplateColumn HeaderText="Description">
                                            <ItemTemplate>
                                                ...
                                                <div style="padding-top:3px; padding-bottom:3px; padding-left:10px; padding-right:5px; font-style:italic; font-weight:bold;">
                                                    <asp:DataList ID="dlComment" runat="server" Visible="false">
                                                        <ItemTemplate>                                                        
 ...
 <%-- which field --%>
                                                ...
                                                <asp:DataList ID="dlExpense" runat="server" Width="100%" Style="padding-right: 0;" BorderWidth="0">
                                                    <ItemTemplate>
                                                        <table ID="tExpense" width="100%" cellpadding="0" cellspacing="0" align="right">
                                                            <tr>
                                                                <td width="235px" align="right" style="font-weight: bold; border: 0px; padding-left: 0px;">
                                                                    <%# DataBinder.Eval(Container, "DataItem.ExpenseDesc")%>&nbsp;
                                                                </td>
                                                                <td width="97px" align="right" style="font-weight: bold; border: 0px;">
                                    ...
                                    <asp:DataList ID="dlCommentBtm"  runat="server" Visible="false" style="background-color:White; padding-top:3px; padding-bottom:3px; font-style: italic; font-weight: bold;">
                                        <ItemTemplate>
                                            <%# DataBinder.Eval(Container, "DataItem.CommText") %>
                                        </ItemTemplate>
            ...
            <tr>
                <td align="right" width="100%" 
                            style="height: 25px; background-color: #B3E2F0;">
                                ...
                                <ContentTemplate>
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <asp:ImageButton ID="ibtnInvoice" ImageUrl="~/Common/Images/InvoiceIcon.gif"  ToolTip="Click here to Open Invoice " runat="server" OnClick="ibtnInvoice_Click" />
                                            </td>
                                            <td colspan="3">
                                                <uc3:PrintDialogue ID="Print" runat="server"></uc3:PrintDialogue>
                                            </td>
                                        </tr>
                                    </table>
                                </ContentTemplate>
            ...
            <tr>
                <td valign="top">
                    <table width="100%">
                        <uc2:BottomFooter ID="ucFooter" Title="SO Recall" runat="server" />
                    </table>
