<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AvailableShipper.aspx.cs" Inherits="AvailableShipper" %>

<%@ Register Src="Common/UserControls/Footer.ascx" TagName="Footer" TagPrefix="uc2" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Available Shippers </title>
        ...
        <asp:UpdatePanel ID="pnlContainer" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <table class="HeaderPanels" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                    <tr>
                        <td class="lightBg" style="padding: 5px;">
                            <table border="0" cellpadding="3" cellspacing="0" width="100%">
                                <tr>
                                    <td align="left">
                                        <asp:Label ID="lblCaption" runat="server" Font-Bold="True" Text="Shipper Selection for Order #"
                                ...
                                <table border="0" cellpadding="0" cellspacing="3" style="width: 100%;">
                                    <tr>
                                        <td style="width: 100px; font-weight: bold;" valign="top">
                                            <asp:Label ID="lblShipperOrder" runat="server" Height="20px" Text="Shippers"></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td style="width: 100%; padding-left: 20px;" valign="top">
                                            <asp:DataList ID="dlShipped" runat="server" OnItemCommand="dlShipped_ItemCommand">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkShipped" runat="server" CommandName="Load" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"OrderNo") %>'
                    ...
                    <tr>
                        <td>
                            <uc2:Footer ID="Footer1" Title="Available Shippers" runat="server"></uc2:Footer>
                        </td>
                    </tr>
                </table>
            </ContentTemplate>
