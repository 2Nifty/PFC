 ...
 * Description			:	Class which used to Encrypt and Decrypt Strings
 * History				: 
 * 
 * DATE					VERSION			AUTHOR			    ACTION
 * ****					*******			******				******
 * 17 August '05		Ver-1			Shiva		 		Created
 * 29 September '05		Ver-1			Shiva				Updated
 *********************************************************************************************/
...
namespace PFC.SOE.Securitylayer
{
	// 
	...
	{ 
		...
		// Global settings
		//
		protected const string PASSKEY = "nova";
		#endregion
		...
		/// <summary>
		/// Helper Function to make the programmers have simple string passing function
		/// </summary>
		...
		/// <summary>
		/// Helper function for programmer to have simple decryption
		/// </summary>
		...
		public static string Decrypt(string cipherText)
		{
			...
			//
			return Decrypt(cipherText, PASSKEY);
