                       ...
                       if(eval(document.getElementById(strCtlID.replace("txtQty","hidPrivousValue")).value) != eval(ctlValue))
                        {
                            ...
                            var url="AvailableStock.aspx?Type=Selected&mode=newquote&CustomerItemNo="+document.getElementById(strCtlID.replace("txtQty","lbl1")).innerHTML+"&QuoteNo="+document.getElementById(strCtlID.replace("txtQty","lbl9")).innerHTML+"&Quantity="+document.getElementById(strCtlID.replace("txtQty","hidReqQty")).value+"&Control="+strCtlID.replace("txtQty","lblAvailQty")+"&Base="+document.getElementById(strCtlID.replace("txtQty","lbl3")).innerHTML.replace("/","~");
           ...
           {   
                ...
                if(strSelectedCode.indexOf(',') == -1 || document.getElementById(strCtlID.replace("txtQty","hidFirstValue")).value == "first")
                {
                    ...
                    {                      
                        ...
                        document.getElementById(strCtlID.replace("txtQty","lblLocationName")).innerHTML=detail[2];
