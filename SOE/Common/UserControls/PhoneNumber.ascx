...
<table cellpadding=0 cellspacing=0 border=0>
    <tr>
        <td>
            <asp:TextBox ID=txtPhone onkeypress="Javascript:ValidateKeyPress(event);" runat=server MaxLength="18" onblur="javascript:ValidatePhone('txtPhone');"></asp:TextBox>
           
        </td>
        <td>
            <asp:CustomValidator ID="cvPhone" ControlToValidate=txtPhone runat="server" Display="Dynamic" SetFocusOnError=true
