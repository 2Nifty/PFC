...
function OpenDatePicker1(controlID,textBox)
{
  ...
  //  var url = PageName  + '?txtID='+controlID+"&soeID="+document.getElementById("CustDet_txtSONumber").value;
       var url = PageName  + '?txtID='+controlID.split("_")[0]+"_"+textBox+'&Validate=NO';
...
<asp:TextBox id="textBox" Width="55px"  runat="server" CssClass="lbl_whitebox"></asp:TextBox>&nbsp;<asp:ImageButton id="Image1" CausesValidation="False" runat="server" ImageUrl="~/Common/Images/datepicker.gif" OnClientClick="javascript:return OpenDatePicker1(this.id,'textBox')" ></asp:ImageButton>
