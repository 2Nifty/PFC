<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="StockCheck.aspx.cs"
    Inherits="StockCheck" %>
        ...
        <table border="0" class="HeaderPanels" cellpadding="0" cellspacing="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding-bottom: 5px; padding-left: 5px; padding-right: 5px;" valign="top">
                                                        <asp:TextBox ID="txtItemNumber" runat="server" CssClass="lbl_whitebox" Width="114px"
                                                            onkeydown="javascript:if(event.keyCode==9){ItemZItem(this.value); return false;}"
                                                            onkeyup="javascript:BindItemNumber(this);">
                                                        </asp:TextBox>
                                                        ...
                                                        <div id="divSearch" style="position: absolute; display: none;" runat="server">
                                                            ...
                                                            <asp:Button ID="btnLoadItem" runat="server" Style="display: none" Text="Load Item"
                                                                OnClick="btnLoadItem_Click" />
                                                        </div>
                                                    </td>
                                                    <td valign="top">
                                                    </td>
                    ...
                    <asp:UpdatePanel ID="upnlVendor" runat="server" UpdateMode="conditional">
                        <ContentTemplate>
                            <table cellpadding="2" cellspacing="0">
                                <tr>
                                    <td colspan="2">
                                        <asp:Label ID="Label1" runat="server" Text="Velocity Codes" Font-Bold="True" Width="85px" Font-Underline="True"></asp:Label>
                                    </td>
                                    <td style="width: 15px">
                                    </td>
                                    <td>
                                        <asp:Label ID="Label2" runat="server" Text="Mo Avg Sales:" Font-Bold="True" Width="90px"></asp:Label>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <asp:Label ID="Label11" runat="server" Text=" Replace Cost:" Font-Bold="True" Width="90px"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:Label ID="lblReplaceCost" runat="server" CssClass="lbl_whitebox" Width="90px"></asp:Label></td>
                                    <td style="width: 15px"> 
                                    </td>
                                    <td rowspan="4" colspan="2" valign="top" class="splitborder_b_v">
                                        <table cellpadding="1" cellspacing="0">
                                            <tr>
                                                <td align="center">
                                                    <asp:Label ID="Label3" runat="server" Text="Warnings" Font-Bold="True" Width="60px" Font-Underline="True"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblWarnings1" runat="server" Width="90px"></asp:Label></td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td colspan="1" rowspan="4" valign="top" class=splitborder_b_v>
                                        &nbsp;</td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:Label ID="Label4" runat="server" Text=" Cat:" Font-Bold="True" Width="60px"></asp:Label>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <asp:Label ID="Label5" runat="server" Text="Cur Usage:" Font-Bold="True" Width="90px"></asp:Label>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <asp:Label ID="Label6" runat="server" Text="DD:" Font-Bold="True" Width="90px"></asp:Label>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="Label8" runat="server" Text="Corp:" Font-Bold="True" Width="60px"></asp:Label></td>
                                    <td>
                                        <asp:Label ID="lblCorp" runat="server" CssClass="lbl_whitebox" Width="90px"></asp:Label></td>
                                    <td>
                                    </td>
                                    <td>
                                        <asp:Label ID="Label9" runat="server" Text="Last Mo Usage:" Font-Bold="True" Width="90px"></asp:Label></td>
                                    <td>
                                        <asp:Label ID="lblLastMoUsage" runat="server" CssClass="lbl_whitebox" Width="90px"></asp:Label></td>
                                    <td>
                                    </td>
                                    <td>
                                        <asp:Label ID="Label10" runat="server" Text="LT:" Font-Bold="True" Width="90px"></asp:Label></td>
                                    <td>
                                ...
                                <tr>
                                    <td style="width: 74px" class="splitborder_b_v" height="30" valign="top">
                                        <asp:Label ID="Label13" runat="server" Text="Sales:" Font-Bold="True" Width="60px"></asp:Label></td>
                                    ...
                                    <td class="splitborder_b_v">
                                        &nbsp;</td>
                                    <td valign="top"  class="splitborder_b_v">
                                        <asp:Label ID="Label14" runat="server" Text="Buyer:" Font-Bold="True" Width="90px"></asp:Label></td>
                                    <td valign="top"  class="splitborder_b_v">
                                        <asp:Label ID="lblBuyer" runat="server" CssClass="lbl_whitebox" Width="90px"></asp:Label></td>
                                    <td  class="splitborder_b_v">&nbsp; &nbsp;</td>
                                    <td  class="splitborder_b_v">
                                        &nbsp;</td>
                                    <td  class="splitborder_b_v">
                                        &nbsp;</td>
                                ...
                                <tr>
                                    <td class="splitborder_t_v " style="width: 74px; height: 26px;">
                                        <asp:Label ID="Label15" runat="server" Text="Sell UM:" Font-Bold="True" Width="60px"></asp:Label></td>
                                    ...
                                    <td class="splitborder_t_v " style="height: 26px">
                                        &nbsp;</td>
                                    <td class="splitborder_t_v " style="height: 26px">
                                        <asp:Label ID="Label16" runat="server" Text="Cost/ Pur UM:" Font-Bold="True" Width="90px"></asp:Label></td>
                                    <td class="splitborder_t_v " style="height: 26px">
                                        <asp:Label ID="lblCostUM" runat="server" CssClass="lbl_whitebox" Width="90px"></asp:Label></td>
                                    <td class="splitborder_t_v  " style="height: 26px">
                                    </td>
                                    <td class="splitborder_t_v  " style="height: 26px">
                                        <asp:Label ID="Label17" runat="server" Text="OAQ:" Font-Bold="True" Width="90px"></asp:Label></td>
                                    <td class="splitborder_t_v " style="height: 26px">
                                ...
                                <tr>
                                    <td style="width: 74px">
                                        <asp:Label ID="Label19" runat="server" Text="Price:" Font-Bold="True" Width="60px"></asp:Label></td>
                                    <td>
                                        <asp:Label ID="lblPrice" runat="server" CssClass="lbl_whitebox" Width="90px"></asp:Label></td>
                                    <td>
                                    </td>
                                    <td>
                                        <asp:Label ID="Label20" runat="server" Text=" Std Cost:" Font-Bold="True" Width="90px"></asp:Label></td>
                                    <td>
                                        <asp:Label ID="lblStdCost" runat="server" CssClass="lbl_whitebox" Width="90px"></asp:Label></td>
                                    <td>
                                    </td>
                                    <td>
                                        <asp:Label ID="Label21" runat="server" Text=" Mstr Crtn:" Font-Bold="True" Width="90px"></asp:Label></td>
                                    <td>
                                ...
                                <tr>
                                    <td style="width: 74px">
                                        <asp:Label ID="Label12" runat="server" Text="Sell Basis:" Font-Bold="True" Width="60px"></asp:Label></td>
                                    <td>
                                        <asp:Label ID="lblSellBasis" runat="server" CssClass="lbl_whitebox" Width="90px"></asp:Label></td>
                                    <td>
                                    </td>
                                    <td>
                                        <asp:Label ID="Label25" runat="server" Text=" Cost Basis:" Font-Bold="True" Width="90px"></asp:Label></td>
                                    <td>
                                        <asp:Label ID="lblCostBasis" runat="server" CssClass="lbl_whitebox" Width="90px"></asp:Label></td>
                                    <td>
                                    </td>
                                    <td>
                                        <asp:Label ID="Label27" runat="server" Text="OPQ:" Font-Bold="True" Width="90px"></asp:Label></td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        &nbsp;</td>
                                    <td>
                                        <asp:Label ID="Label31" runat="server" Text="Planner:" Font-Bold="True" Width="90px"></asp:Label></td>
                                    <td>
                                ...
                                <asp:UpdatePanel ID="upnlStockGrid" runat="server" UpdateMode="conditional">
                                    <ContentTemplate>
                                        <div class="Sbar" oncontextmenu="Javascript:return false;" id="div-datagrid" style="overflow-x: hidden;
                                            ...
                                            width: 670px; background-color: White; scrollbar-3dlight-color: white; scrollbar-arrow-color: #1D7E94;
                                            ...
                                            <asp:GridView UseAccessibleHeader="true" ID="gvStock" PagerSettings-Visible="false"
                                                ...
                                                AutoGenerateColumns="false" ShowFooter="false" OnSorting="gvStock_Sorting">
                                                ...
                                                <tr>
                                                    <td style="height: 22px" class="lightBlueBg">
                                                        <asp:CheckBox ID="chkSelectAll" runat="server" Text="Locations" Width="140px" AutoPostBack="True"
                                                            CssClass="GridHead" Font-Bold="True" BackColor="#DFF3F9" OnCheckedChanged="chkSelectAll_CheckedChanged" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="blueBorder" style="padding-top: 1px; height: 138px;" valign="top">
                                                        <asp:CheckBoxList ID="chkSelection" runat="server" Width="140px" CssClass="item"
                                                            AutoPostBack="True" RepeatColumns="1" OnSelectedIndexChanged="chkSelection_SelectedIndexChanged">
                                                        </asp:CheckBoxList>
                                                    </td>
                                                </tr>
                                            </table>
            ...
            <tr>
                <td align="right" width="100%" id="tdButton" class="commandLine splitborder_t_v splitborder_b_v"
                    colspan="2" style="height: 18px; background-position: -80px  left;">
            ...
            <tr>
                <td colspan="2">
                    <uc2:Footer ID="Footer1" Title="Customer Stock Check" runat="server"></uc2:Footer>
                </td>
            </tr>
        </table>
    </form>
