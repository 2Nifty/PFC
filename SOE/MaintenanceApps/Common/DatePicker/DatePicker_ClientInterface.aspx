...
<HTML>
	<HEAD>
		...
		<style type="text/css">
            ...
            .calBk {BACKGROUND-POSITION: left top; BACKGROUND-IMAGE: url(../Images/calBk.jpg); BACKGROUND-REPEAT: repeat-x; BACKGROUND-COLOR: #ffffff}
	       ...
	       .cnt 
{
	...
	<body bottomMargin="2" leftMargin="2" topMargin="2" rightMargin="2">
		<form id="frmFrame" runat="server">
			...
			<table class="calBk" cellSpacing="2" cellPadding="2" width="200" border="0">
				<tr>
