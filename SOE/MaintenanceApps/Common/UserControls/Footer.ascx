        ...
        <div id="Footer" class="Footer">
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <a href="http://www.porteousfastener.com/" target=_blank class="tooltipAnchor" id="lnkCpyright" onmouseover="showHideCorporateTooltip(this.id,event,'show');">Copyright 2011. </a>
                    </td>
                    <td>
                        <div align="right">
                            <a href="http://www.novantus.com" target="_blank">
                                <asp:Image ImageUrl="~/MaintenanceApps/Common/Images/umbrellaPower.gif" runat="server" alt="Powered By www.novantus.com" 
                                ID="Image1" /> </a></div>
                    </td>
                </tr>
            </table>
