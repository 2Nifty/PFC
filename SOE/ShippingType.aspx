<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShippingType.aspx.cs" Inherits="ShippingType" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ReloadPO(tableType,orderNo)
        {   
            if(window.opener.document.getElementById("hidTableName"))  
            {
            window.opener.document.getElementById("txtSONumber").value =orderNo; 
            
              window.opener.document.getElementById("hidIsMultiple").value="true";
                window.opener.document.getElementById("hidTableName").value=tableType;
                window.opener.document.getElementById("btnBind").click();
                window.close();
            }
            return false;
        }  
                    ...
                    <tr>
                        <td class="lightBg" style="padding: 5px;">
                            <table border="0" cellpadding="3" cellspacing="0" width="100%">
                                <tr>
                                    <td align="left">
                                        <asp:Label ID="lblCaption" runat="server" Font-Bold="True" Text="Sales Order Available For Order#" Width="275px"></asp:Label></td>
