<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SoldToAddressExport.aspx.cs"
                    ...
                    <table border="0" cellpadding="3" cellspacing="0">
                        <tr>
                            <td style="width: 50px; padding-left: 8px;">
                                <asp:Label ID="Label9" style="display:inline-block;width:250px" runat="server" Font-Bold="True" Text="Sold To Information For Sales Order Number:"
                                    ></asp:Label></td>
                            <td>
