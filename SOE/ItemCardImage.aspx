        ...
        function LoadRefData()
        {
            ...
            if (document.getElementById('HasProcessed').value != '1') 
            {
                ...
                document.getElementById('ItemNoTextBox').value = 
                    window.opener.parent.document.getElementById('lblItem').innerText;
                document.getElementById('DescriptionTextBox').value = 
                    window.opener.parent.document.getElementById('lblDescription').innerText;
                    document.getElementById ('Location').value=
                    window.opener.parent.document.getElementById('lblLoc').innerText;
                // show the data
                 ...
                 <table width="890px" style="border:1px solid #88D2E9; ">
                    <tr class="bold">
                        ...
                        <td>
                            ...
                            <asp:TextBox CssClass="lbl_whitebox" ID="Location" runat="server" Text=" " Width="250px" Visible ="false" >
                            </asp:TextBox>
                        </td>
                        <td align="right">
