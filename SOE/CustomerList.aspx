    ...
    function BindCustomer(customerno)
    {
       var _fName = document.getElementById("hidfname").value;
        switch (_fName) 
        {
            ...
            CallBtnClick("CustNoSubmit");          
            break; 
            case 'OpenOrdRpt':  // refresh Quote Recall page           
            window.opener.document.getElementById("iCustNo").value=customerno; 
            break; 
...
<body onload="javascript:SetCustNameFocus();"  AsyncPostBackTimeout ="360000"  bgcolor="#ECF9FB" scroll="no" style="margin: 3px" >
                ...
                <tr>
                    <td class="splitBorder">
                        <div id="divdatagrid" class="Sbar" style="overflow: auto; position: relative; top: 0px;
                                    left: 0px; width: 850px; height: 350px; border: 0px solid; color:White">
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="right" class="splitborder_t_v splitborder_b_v" style="padding-top: 5px"
                                    ...
                                    <uc1:Pager ID="gridPager" OnBubbleClick="Pager_PageChanged" runat="server" />
                                </td>
                            </tr>
                            <tr>
