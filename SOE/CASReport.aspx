<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CASReport.aspx.cs" Inherits="CASReport" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            <table border="0" cellpadding="0" cellspacing="0" style="width: 700px">
                                                            ...
                                                            <td width="100%">
                                                                <table width="100%" height="60px" rules="all" cellpadding="0" align="right" border="0"
                                                                    ...
                                                                    <tr style="padding-left: 3px">
                                                                        ...
                                                                        <td width="108" style="border: solid 1px #B0E0E6;">
                                                                            <div align="center" class="BlackBold">
                                                                                DSO
                                                                            </div>
                                                                        </td>
                                                                    ...
                                                                    <tr style="padding-left: 5px">
                                                                        ...
                                                                        <td rowspan="2" style="border: solid 1px #B0E0E6;">
                                ...
                                <td colspan="2" style="height:185px;" valign=top>
                                    <asp:DataGrid ID="dgSalesDetails" runat="server" Width="700px" BorderColor="#c9c6c6"
                                        ...
                                        <HeaderStyle HorizontalAlign="Center" CssClass="GridHead" BackColor="#DFF3F9" Font-Bold="True"
                                            Height="20px" />
                                        <ItemStyle CssClass="GridItem" Wrap="False" BackColor="#F4FBFD" Height="20px" />
                ...
                <tr>
                    <td align="right" width="100%" id="tdButton" class="splitborder_t_v splitborder_b_v"
                ...
                <tr>
                    <td>
                        <uc1:Footer ID="Footer1" runat="server" Title="Customer Activity Sheet" />
                    </td>
                </tr>
            </table>
        </div>
