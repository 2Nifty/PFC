...
<head id="Head1" runat="server"  >
    <title id="pageCaption" runat="server">Untitled Page</title>
</head>
...
<frameset rows="40,*" border="0" id="Frame1" onunload="javascript:return OpenOrderTypeUpdate();" >
    <frame name="banner" scrolling="no" noresize src="TopFrame.aspx">
    <frameset cols="25,*" border="0" name="soeFrame">
        <frame name="menuFrame" src="SOEMenu.aspx" scrolling="no" noresize  />
        <frame id="bodyFrame" name="bodyFrame" src="OrderEntry.aspx?UserID=<%=Request.QueryString["UserID"] %>&UserName=<%=Request.QueryString["UserName"] %>">
    </frameset>
</frameset>
