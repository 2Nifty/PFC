<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuoteExport.aspx.cs" Inherits="QuoteExport" %>
...
<!-- special style sheet for printing -->
    <style type="text/css">
    /* Styles are local to make sure the document is self contained */
    .printPage
    {
        width : 7.5in;
        height : 10in;
    ...
    <form id="form1" runat="server">
       <center><div class="printPage"><div id="TestWatermark" runat="server">
            <asp:Table ID="DocTable" runat="server" Width="100%" CellPadding="0" CellSpacing="0">
                <asp:TableRow ID="header" CssClass="pageHeader" runat="server">
                            ...
                            <tr>
                                ...
                                <td width="70%" align="center" valign="top">
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td colspan="4" class="docTitle">
                                                Porteous Fastener Company SALES QUOTE
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <asp:Label ID="QuoteDateLabel" runat="server"></asp:Label>
                                            </td>
                                            <td align="right">
                                                <asp:Label ID="QuoteNumberLabel" runat="server"></asp:Label>
                                            </td>
