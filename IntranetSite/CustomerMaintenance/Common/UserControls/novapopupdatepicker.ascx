...
<asp:TextBox id="textBox" Width="55px"  runat="server" CssClass="lbl_whitebox"></asp:TextBox>&nbsp;<asp:ImageButton id="Image1" CausesValidation="False" runat="server" ImageUrl="~/customermaintenance/Common/Images/datepicker.gif" OnClientClick="javascript:return OpenDatePicker1(this.id,'textBox')" ></asp:ImageButton>
