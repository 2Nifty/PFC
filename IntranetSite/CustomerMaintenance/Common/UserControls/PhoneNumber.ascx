...
function ValidateKeyPress(e)
{
    if((navigator.appName == 'Netscape' || navigator.appName =='Mozilla Firefox'))
    {
        ...
        if (parseInt(e.which) < 47 || parseInt(e.which)> 57)
        {
...
<table>
    <tr>
        <td>
            <asp:TextBox ID=txtPhone onkeypress="Javascript:ValidateKeyPress(event);" runat=server CssClass=cnt MaxLength="18" onblur="javascript:ValidatePhone(this.id);"></asp:TextBox>
           
        </td>
        <td nowrap=nowrap>
            <asp:CustomValidator ID="cvPhone" ControlToValidate=txtPhone runat="server" Display="Dynamic"
                ErrorMessage="Invalid #" ClientValidationFunction=ValidatePhoneNumber></asp:CustomValidator></td>
