...
<head runat="server">
    ...
    function LoadPage(report)
    {
        switch (report){
		case "CM": 
			var hwnd=window.open('CustomerMaintenance.aspx' ,'CustomerMaintenance','height=710,width=1020,Addressbar=0,scrollbars=no,location=no,status=no,top='+((screen.height/2) - (760/2))+',left='+((screen.width/2) - (1020/2))+',resizable=no','');	
			hwnd.focus();
		break;				
            ...
            <tr>
                <td valign="middle" class="PageHead">
                    <span class="Left5pxPadd">
                        <asp:Label ID="lblParentMenuName" CssClass="BannerText" runat="server" Text="Customer Management"></asp:Label></span>
                </td>
            </tr>
            <tr>
                                ...
                                <table width="100%"  border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td id="5TD" class="blackTxt" style="padding-bottom:20px" valign=middle >
                                            <br />
                                            <p class="10pxPadding">
                                                <img src="../Common/Images/Bullet.gif" width="10" height="9" onclick="LoadPage('CM');">&nbsp;&nbsp;
                                                <a onclick="LoadPage('CM');"
                                                    href="#" id="x"
                                                    alt="View Customer Maintenance" onmouseover="ToolTip(this,window.event);"
                                                    onmouseout="ToolTip(this,window.event);">&nbsp;Customer Maintenance</a>
                                                <br />
                                            </p>
                                        </td>
                                    </tr>
