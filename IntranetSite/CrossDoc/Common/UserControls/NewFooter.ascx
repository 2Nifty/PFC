        ...
        <div id="Footer">
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <div align="right">
                            <asp:Image ImageUrl="~/ReadyToShip/Common/Images/userinfo_left_rev.gif" runat="server"
                    ...
                    <td>
                        <div align="left">
                            <asp:Image ImageUrl="~/ReadyToShip/Common/Images/userinfo_right_rev.gif" runat="server"
                    ...
                    <td>
                        <div align="right">
                            <a href="http://www.novantus.com" target="_blank">
                                <asp:Image ImageUrl="~/Common/Images/umbrellaPower.gif" runat="server" alt="Powered By www.novantus.com" ID="Image1" /> </a></div>
                    </td>
                </tr>
            </table>
        </div>
