<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CycleCountPrompt.aspx.cs"
...
<head id="Head1" runat="server">
    ...
    function ViewReport()
    {
        ...
        {              
            var Url =   "CycleCountReport.aspx" + 
                        "?StartDate=" + document.getElementById("hidStartDt").value + 
                        "~EndDate=" + document.getElementById("hidEndDt").value + 
                        "~Branch=" + branchID + 
                        "~BranchName=" + branchDesc +
                        "~MinAdjValue=" +  document.getElementById("txtMinAdjValue").value +
                        "~RFUserId=" + document.getElementById("txtRFUserId").value;
                        
            Url = "ProgressBar.aspx?destPage="+Url;
        
            var hwnd=window.open(Url,"CycleCountReport" ,'height=700,width=1020,scrollbars=no,status=no,top='+((screen.height/2) - (760/2))+',left='+((screen.width/2) - (1020/2))+',resizable=no',"");
            hwnd.focus();            
        }
    }
                                                ...
                                                <tr id="tdRange" runat="server">
                                                    ...
                                                    <td colspan="1" style="width: 560px; height: 20px; padding-top: 20px;" valign="top">
                                                        ...
                                                        <table border="0" cellpadding="5" cellspacing="0" style="width: 200px;">
                                                            ...
                                                            <tr>
                                                                <td style="width: 100px">
                                                                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Text="RF User ID:" Width="82px"></asp:Label></td>
                                                                <td colspan="3">
                                                                    <asp:TextBox ID="txtRFUserId" runat="server" CssClass="FormCtrl"></asp:TextBox></td>
                                                            </tr>
                                                            <tr>
                                                                <td style="width: 100px">
                                                                    <asp:Label ID="Label3" runat="server" Font-Bold="True" Text="Min Adjustment Value:"
                                                                        Width="130px"></asp:Label></td>
                                                                <td colspan="3">
                                                                    <asp:TextBox ID="txtMinAdjValue" runat="server" CssClass="FormCtrl"></asp:TextBox></td>
                                                            </tr>
                                                            <tr>
                                                                <td style="width: 100px">
                                                                </td>
