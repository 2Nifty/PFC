                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                        ...
                                        <td class="TabHeadBk" width="100%" style="height: 30px">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <strong class="redtitle2">Item Builder</strong></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td id="5TD" class="blackTxt" style="height: 92px" width="100%">
                                            <img src="../Common/Images/Bullet.gif" width="10" height="9" onclick="LoadItemBuilder();">&nbsp;
                                            <a style="cursor: hand; color: Black;" onclick="javascript:window.open('ItemBuilder.aspx' ,'Order','height=710,width=1020,Addressbar=0,scrollbars=no,location=no,status=no,top='+((screen.height/2) - (760/2))+',left='+((screen.width/2) - (1020/2))+',resizable=YES','');"
                                                id="A2" alt="Sales Order Entry System" onmouseover="ToolTip(this,window.event);"
                                                onmouseout="ToolTip(this,window.event);">&nbsp;Item Builder1</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td id="Td1" class="blackTxt" style="height: 92px" width="100%">
                                            <img src="../Common/Images/Bullet.gif" width="10" height="9" onclick="LoadItemBuilder();">&nbsp;
                                            <a style="cursor: hand; color: Black;" onclick="javascript:window.open('Reference.aspx' ,'Order','height=710,width=1020,Addressbar=0,scrollbars=no,location=no,status=no,top='+((screen.height/2) - (760/2))+',left='+((screen.width/2) - (1020/2))+',resizable=YES','');"
                                                id="A1" alt="Sales Order Entry System" onmouseover="ToolTip(this,window.event);"
                                                onmouseout="ToolTip(this,window.event);">&nbsp;Item Builder2</a>
                                        </td>
                                    </tr>
                                </table>
                            </td>
