...
namespace PFC.Intranet.MaintenanceApps
{
    ...
    public class OrgStandardComment 
    {
        ...
        string connection = ConfigurationManager.AppSettings["PFCERPConnectionString"].ToString();
        ...
        public DataTable GetTablesData(string searchText,string tableName,string number)
        {
            try
            {
                ...
                if (tableName == "cust")
                {
                    ...
                    _tableName = "CustomerMaster INNER JOIN OrganizationStandardComments AS OrganizationStandardComments_1 ON CustomerMaster.CustNo = OrganizationStandardComments_1.OrganizationNo";
        ...
        public DataSet GetCustomerSelect(string customer)
        {
            ...
            try
            {
                ...
                //DataSet dsCustomer = SqlHelper.ExecuteDataset(connection, "UGEN_SP_Select",
