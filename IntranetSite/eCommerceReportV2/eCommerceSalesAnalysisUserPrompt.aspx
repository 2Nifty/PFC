                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                            <tr>
                                                <td>
                                                    ...
                                                    <asp:DropDownList ID="ddlYear" runat="server" CssClass="FormCtrl" Width="60px" Height="20px" TabIndex="4" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                        ...
                                        <table>
                                            <tr>
                                                <td>
                                                    ...
                                                    <asp:ImageButton runat="server" ID="ibtnStartDt" ImageUrl="../Common/Images/datepicker.gif"
                                                ...
                                                <td>
                                                    ...
                                                    <asp:ImageButton runat="server" ID="ibtnEndDt" ImageUrl="../Common/Images/datepicker.gif" OnClick="ibtnEndDt_Click" />
                                                </td>
                                                <td>
...
--%>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlCSR" runat="server" CssClass="FormCtrl" Width="190px" Height="20px"  TabIndex="6" />
                                    </td>
                                    <td colspan="2">&nbsp;</td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtCustNo" runat="server" MaxLength="20" CssClass="FormCtrl" Width="185px" TabIndex="7" Height="20px" />
                                    </td>
                                    <td colspan="2">&nbsp;</td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlOrderSource" runat="server" CssClass="FormCtrl" Width="190px" Height="20px" TabIndex="8" />
                                    </td>
                                    <td colspan="2">&nbsp;</td>
                                </tr>
                                <tr>
