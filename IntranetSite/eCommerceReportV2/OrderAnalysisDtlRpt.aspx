...
//            var url= "Sort="+document.getElementById("hidSort").value+"&Month=" + '<%= (Request.QueryString["Month"] != null) ? Request.QueryString["Month"].ToString().Trim() : "" %>&Year=<%= (Request.QueryString["Year"] != null) ? Request.QueryString["Year"].ToString().Trim() : "" %>&CustomerNumber=<%= (Request.QueryString["CustomerNumber"] != null) ? Request.QueryString["CustomerNumber"].ToString().Trim() : ""%>&BranchNumber=<%= (Request.QueryString["BranchNumber"] != null) ? Request.QueryString["BranchNumber"].ToString().Trim() : ""%>&StartDate=<%= Request.QueryString["StartDate"].ToString()%>&EndDate=<%= Request.QueryString["EndDate"].ToString()%>&CustomerName=<%= Request.QueryString["CustomerName"].ToString()%>';
            ...
            var hwin=window.open('OrderAnalysisDtlRptPreview.aspx?'+url, '', 'height=700,width=1010,scrollbars=no,status=no,top='+((screen.height/2) - (1010/2))+',left='+((screen.width/2) - (1010/2))+',resizable=NO',"");
            hwin.focus();
        }

        function DeleteFiles(session)
        {
            var str=OrderAnalysisDtlRpt.DeleteExcel('OrderAnalysisDtlRpt'+session).value.toString();
            window.close();
        }
            ...
            <tr>
                <td>
                    <div class="Sbar" id="div-datagrid" style="overflow-x: auto; overflow-y: auto; position: relative; top: 0px; left: 0px; width: 1020px; height: 510px; border: 0px solid;">
                        <asp:DataGrid ID="dgOrderAnalysis" Width="1230" runat="server"
                            ...
                            <Columns>                                    
                                <asp:BoundColumn HeaderStyle-BorderColor="#DAEEEF" HeaderStyle-Width="100" HeaderText="Order Method" ItemStyle-Width="100" FooterStyle-BorderColor="#DAEEEF" FooterStyle-HorizontalAlign="Center"
                                    DataField="QuoteMethod" SortExpression="QuoteMethod" />                                  
                                <asp:TemplateColumn HeaderStyle-BorderColor="#DAEEEF" HeaderText="PO Number" SortExpression="PurchaseOrderNo" ItemStyle-Width="80" FooterStyle-BorderColor="#DAEEEF">
                                    <HeaderStyle Width="70px" />  
                                    <ItemTemplate>
                                        <asp:Label ID="lblPONo" runat="server" Text='<%# DataBinder.Eval(Container.DataItem,"PurchaseOrderNo")%>' />
                                        <div id="divToolTips" class="list" runat="server" style="display: none; position: absolute;z-index:99;" >
                                ...
                                <asp:BoundColumn HeaderStyle-BorderColor="#DAEEEF" HeaderStyle-Width="70" HeaderText="PO Date" ItemStyle-Width="70" ItemStyle-HorizontalAlign="center" FooterStyle-BorderColor="#DAEEEF"
                                    DataField="PurchaseOrderDate" DataFormatString="{0:MM/dd/yyyy}" SortExpression="PurchaseOrderDate" />
                                <asp:BoundColumn HeaderStyle-BorderColor="#DAEEEF" HeaderStyle-Width="150" HeaderText="User Item #" ItemStyle-Width="150" FooterStyle-BorderColor="#DAEEEF" FooterStyle-HorizontalAlign="right"
                                    DataField="UserItemNo" DataFormatString="{0:#,##0.00}" SortExpression="UserItemNo" />
                                <asp:BoundColumn HeaderStyle-BorderColor="#DAEEEF" HeaderStyle-Width="120" HeaderText="PFC Item #" ItemStyle-Width="120" FooterStyle-BorderColor="#DAEEEF" 
                                    DataField="PFCItemNo" DataFormatString="{0:#,##0.00}" SortExpression="PFCItemNo" />
                                <asp:BoundColumn HeaderStyle-BorderColor="#DAEEEF" HeaderStyle-Width="300" HeaderText="Description" ItemStyle-Width="300" FooterStyle-BorderColor="#DAEEEF" 
                                    DataField="Description" DataFormatString="{0:#,##0.00}" SortExpression="Description" />
                                <asp:BoundColumn HeaderStyle-BorderColor="#DAEEEF" HeaderStyle-Width="40" HeaderText="Sls Brn" ItemStyle-Width="40" FooterStyle-BorderColor="#DAEEEF" 
                                ...
                                <asp:BoundColumn HeaderStyle-BorderColor="#DAEEEF" HeaderStyle-Width="40" HeaderText="Req Qty" ItemStyle-Width="40" ItemStyle-HorizontalAlign="right" FooterStyle-BorderColor="#DAEEEF" FooterStyle-HorizontalAlign="right"
                                    DataField="RequestQuantity" DataFormatString="{0:#,##0}" SortExpression="RequestQuantity" />
                                <asp:BoundColumn HeaderStyle-BorderColor="#DAEEEF" HeaderStyle-Width="40" HeaderText="Avl Qty" ItemStyle-Width="40" ItemStyle-HorizontalAlign="right" FooterStyle-BorderColor="#DAEEEF" FooterStyle-HorizontalAlign="right"
                                    DataField="RunningAvailQty" DataFormatString="{0:#,##0}" SortExpression="RunningAvailQty" />                                                                          
                                <asp:BoundColumn HeaderStyle-BorderColor="#DAEEEF" HeaderStyle-Width="40" HeaderText="Unit Price" ItemStyle-Width="40" ItemStyle-HorizontalAlign="right" FooterStyle-BorderColor="#DAEEEF" FooterStyle-HorizontalAlign="right"
                                    DataField="UnitPrice" DataFormatString="{0:c}" SortExpression="UnitPrice" />
                                <asp:BoundColumn HeaderStyle-BorderColor="#DAEEEF" HeaderStyle-Width="40" HeaderText="Mgn %" ItemStyle-Width="40" ItemStyle-HorizontalAlign="right" FooterStyle-BorderColor="#DAEEEF" FooterStyle-HorizontalAlign="right"
                                    DataField="MarginPercentage" DataFormatString="{0:#,##0.0}" SortExpression="MarginPercentage" />
                                <asp:BoundColumn HeaderStyle-BorderColor="#DAEEEF" HeaderStyle-Width="40" HeaderText="Avg Cost" ItemStyle-Width="40" ItemStyle-HorizontalAlign="right" FooterStyle-BorderColor="#DAEEEF" FooterStyle-HorizontalAlign="right"
                                    DataField="AvgCost" DataFormatString="{0:c}" SortExpression="AvgCost"  />
                                <asp:BoundColumn HeaderStyle-BorderColor="#DAEEEF" HeaderStyle-Width="40" HeaderText="Price UOM" ItemStyle-Width="40" FooterStyle-BorderColor="#DAEEEF" 
                                    DataField="PriceUOM" DataFormatString="{0:#,##0.00}" SortExpression="PriceUOM" />
                                <asp:BoundColumn HeaderStyle-BorderColor="#DAEEEF" HeaderStyle-Width="70" HeaderText="Total Price" ItemStyle-Width="70" ItemStyle-HorizontalAlign="right" FooterStyle-BorderColor="#DAEEEF" FooterStyle-HorizontalAlign="right"
                                    DataField="TotalPrice" DataFormatString="{0:c}" SortExpression="TotalPrice" />                                        
                                <asp:BoundColumn HeaderStyle-BorderColor="#DAEEEF" HeaderStyle-Width="70" HeaderText="Total Weight" ItemStyle-Width="70" ItemStyle-HorizontalAlign="right" FooterStyle-BorderColor="#DAEEEF" FooterStyle-HorizontalAlign="right"
