<%@ Page Language="C#" AutoEventWireup="true" Trace="false" CodeFile="CustBudgetReport.aspx.cs"
    EnableEventValidation="false" ValidateRequest="false" Inherits="CustBudgetReport" %>
...
<head id="Head1" runat="server">
    ...
    {
        CustBudgetReport.DeleteExcel('CustomerBudgetReport'+session).value
        parent.window.close();           
    }
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                    <tr>
                                        <td class="Left5pxPadd BannerText" width="40%">
                                            Customer Sales Forecast Maintenance</td>
