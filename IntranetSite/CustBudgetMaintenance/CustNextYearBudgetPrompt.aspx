<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustNextYearBudgetPrompt.aspx.cs" Inherits="PFC.Intranet.CustNextYearBudgetPrompt" %>
...
<head id="Head1" runat="server">
    ...
    function ViewReport()
    {
        ...
        var Url = "CustNextYearBudgetReport.aspx?SortType=" + sortType;
        var windHeight = "710";
    ...
    {
        var hwnd=window.open("BranchNextYearReport.aspx","CustNextYearALLRpt" ,'height=710,width=1020,scrollbars=no,status=no,top='+((screen.height/2) - (710/2))+',left='+((screen.width/2) - (1020/2))+',resizable=no',"");
        hwnd.focus();   
    }
                                        ...
                                        <td class="PageHead" style="height: 40px" width="75%">
                                            <div class="LeftPadding">
                                                <div align="left" class="BannerText">
                                                    Customer Sales Next Year Forecasting Maintenance Filter Menu</div>
                                            </div>
                                        </td>
