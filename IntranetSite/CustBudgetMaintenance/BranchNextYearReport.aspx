<%@ Page Language="C#" AutoEventWireup="true" Trace="false" CodeFile="BranchNextYearReport.aspx.cs" EnableEventValidation="false" ValidateRequest="false" Inherits="BranchNextYearReport" %>
...
<head id="Head1" runat="server">
    <title>Branch Next Year Sales Forecasting</title>
    ...
    {
				//var ToDelete = 'BranchNextYearReport'+session
				//alert(ToDelete);
        //status = BranchNextYearReport.DeleteExcel(ToDelete).value;
				//alert(status);
        window.close();           
    }
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                    <tr>
                                        <td class="Left5pxPadd BannerText" width="40%">
                                            Branch Sales Next Year Forecast Maintenance</td>
