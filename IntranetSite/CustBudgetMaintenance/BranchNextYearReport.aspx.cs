...
public partial class BranchNextYearReport : System.Web.UI.Page
{
    ...
    {
        Ajax.Utility.RegisterTypeForAjax(typeof(BranchNextYearReport));
        Response.Cache.SetCacheability(HttpCacheability.NoCache);

        if (!IsPostBack)
        {
            hidFileName.Value = "BranchNextYearReport" + Session["SessionID"].ToString() + ".xls";           
            BindDataGrid();
        }
    }
    ...
    {
        DataSet dsBranches = customerBudget.GetCustomerNextYearData("getbudgetbranches", "");
    ...
    protected void gvCustBudget_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        {            
            ...
            dsBranchBudgetData = customerBudget.GetCustomerNextYearReport(_hidBranchId.Value, "", "", "", "BRANCH", sortType, "yes", "");
    ...
    private string GenerateExportData(string dataFormat)
    {
        ...
        headerContent +=    "<tr><th colspan='16' style='color:blue' align=left><center>Branch Next Year Sales Forecast Report</center></th></tr>";      
