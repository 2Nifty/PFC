...
public partial class CustBudgetReport : System.Web.UI.Page
{
    ...
    {        
        Ajax.Utility.RegisterTypeForAjax(typeof(CustBudgetReport));
        ...
        if (!IsPostBack)
        {
            ...
            DataSet dsFicalCal = customerBudget.GetFiscalPeriod();
            ...
            hidFileName.Value = "CustomerBudgetReport" + Session["SessionID"].ToString() + ".xls";
    ...
    {
        dsCustBudgetData = customerBudget.GetCustomerBudgetReport(branchCd, salesRepNo, chainCd, custNo, SummaryRptType, sortType, "no", ShowFSNL);                
    ...
    protected void gvCustBudget_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            if (_tblCustBudget != null)
            {
                ...
                _hidLYpCustSalForecastId.Value = dtBranchSalesDol.Rows[1]["pCustSalesForecastID"].ToString();
                ...
                _hidpCustSalForecastId.Value = dtBranchSalesDol.Rows[2]["pCustSalesForecastID"].ToString();
    ...
    private void UpdateForeCastDolAmt(string txtBoxId, string nextControlId, string columnName)
    {
        ...
        string updateQuery = "Update CustomerSalesForecast " +
                             "Set " + columnName + "='" + _CurrentTxtDolFYearCtl.Text.Replace(",", "") + "', ChangeID='" + Session["UserName"].ToString() +"', ChangeDt='" + DateTime.Now.ToString() + "' " +
                             "Where pCustSalesForecastID=" + pCustSalForecastId;
        
        PFCDBHelper.ExecuteERPUpdateQuery(updateQuery);
        DataSet dsSummaryData = customerBudget.ReExtendGrids(pCustSalForecastId, branchCd, "0", "0", "forecastdol", salesRepNo, chainCd, custNo, SummaryRptType, ShowFSNL);
    ...
    protected void txtDolFYearGrowthPct_TextChanged(object sender, EventArgs e)
    {
        ...
        if (_txtDolFYearGrowthPct.Text != "")
        {
            ...
            DataSet dsSummaryData = customerBudget.ReExtendGrids(hidpCustSalForecastIdTemp.Value,
                                                             branchCd,
