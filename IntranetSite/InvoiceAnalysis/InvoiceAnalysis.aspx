<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InvoiceAnalysis.aspx.cs" Inherits="PFC.Intranet.DailySalesReports.InvoiceAnalysisReport" %>
...
<head runat="server">
    <title>Invoice Analysis Report</title>
    ...
    <script>
        ...
        {
            var hwin=window.open('InvoiceAnalysisPreview.aspx?'+url, 'InvoiceAnalysisPreview', 'height=700,width=1010,scrollbars=no,status=no,top='+((screen.height/2) - (1010/2))+',left='+((screen.width/2) - (1010/2))+',resizable=NO',"");
            hwin.focus();
        }
        ...
        {
            InvoiceAnalysisReport.DeleteExcel('InvoiceAnalysisReport'+session).value
            parent.window.close();
        }
        ...
        <table cellpadding="0" cellspacing="0" width="100%" id="mainTable">
                    ...
                    <asp:UpdatePanel ID="upnlGrid" UpdateMode="conditional" runat="server">
                        <ContentTemplate>
                            <div class="Sbar" id="div-datagrid" style="overflow-x: auto; overflow-y: auto; position: relative;
                                top: 0px; left: 0px; height: 489px; width: 1010px; border: 0px solid;">
                                <asp:GridView UseAccessibleHeader="true" PagerSettings-Visible="false" PageSize="19"
                                    Width="1590px" ID="dvInvoiceAnalysis" runat="server" AllowPaging="true" ShowHeader="true"
            ...
            <tr>
                <td colspan="2" valign="top">
                    <table width="100%">
                        <uc2:BottomFooter ID="ucFooter" Title="Invoice Analysis Report" runat="server" />
                    </table>
                </td>
            </tr>
        </table>
