<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CSRReportByCustPreview.aspx.cs" Inherits="SystemFrameSet_CSRReportByCustPreview" %>
...
{
     var prtContent = "<html><head><link href='../common/StyleSheet/styles.css' rel='stylesheet' type='text/css' /> <link href='../ReadyToShip/Common/StyleSheet/RTS_Styles.css' rel='stylesheet' type='text/css' /></head><body>"
     prtContent=prtContent+"<table cellspacing=0 cellpadding=0 width='100%'><tr><td style='width:350px;'colspan=3><h3>CSR Report - By Assigned Customers</h3></td></tr>";
