<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PFCVisionWOLogin.aspx.cs" Inherits="SystemFrameSet_PFCVision" %>
...
<head runat="server">
    ...
    <script>
        ...
        function ShowMessage()
        {
            var MsgWidth = 900;
            var MsgHeight = 400;
            MessageWindow=window.open('PFCVisionMessage.aspx','VisionMessage','height='+MsgHeight+',width='+MsgWidth+',toolbar=0,scrollbars=0,status=0,top='+(window.screenTop + (document.documentElement.clientHeight/2) - (MsgHeight/2))+',left='+(window.screenLeft + (document.documentElement.clientWidth/2) - (MsgWidth/2))+',resizable=No','');    
        }
    </script>
</head>
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%" class="BlueBorder" id="TABLE1">
        ...
        <tr>
            <td height=25px><span class="Content">
                ...
                to say, “<font color=#CC0000><strong>That’s a helluva company!</strong></font>”</span></td>
        </tr>
        <tr>
        ...
        <tr>
            <td height=40px><span class="Content">
                ...
                &nbsp; &nbsp; &nbsp; &nbsp; Employees are family, and <font color=#CC0000><strong>First Class Service</strong></font>
        ...
        <tr>
            <td height=40px><span class="Content">
                We will always provide our customers with <font color=#CC0000><strong>First Class Service</strong></font>.
                <br />
                &nbsp; &nbsp; &nbsp; &nbsp;
            ...
            <td >
                <table border="0" cellpadding="0" cellspacing="0" width=100%>
                    ...
                    <tr>
                        <td valign=top>
                            <span class="Content">
                            We are all part of “<font color=#CC0000><strong>Team PFC</strong></font>”. 
                            <br />
