<%@ Page Language="C#" AutoEventWireup="true" Trace="false" CodeFile="POPastDueReport.aspx.cs"
    EnableEventValidation="false" ValidateRequest="false" Inherits="POPastDueReport" %>
        ...
        <table cellpadding="0" cellspacing="0" width="100%" id="mainTable">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td style="width: 339px">
                                            <asp:Label ID="lblReportGroup" runat="server" Text="Label"></asp:Label></td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <ContentTemplate>
                            <div class="Sbar" id="div-datagrid" style="overflow-x: auto; overflow-y: auto; position: relative;
                                ...
                                <asp:GridView UseAccessibleHeader="true" PagerSettings-Visible="false" Width="1018px"
                                    ID="gvPOPastDue" runat="server" ShowHeader="true" ShowFooter="true" AllowSorting="True"
                                    ...
                                    <EmptyDataRowStyle VerticalAlign="Top" BorderWidth="0px" CssClass="GridHead" BackColor="#DFF3F9"
                                        HorizontalAlign="Center" />
                                    <Columns>
                                        <asp:BoundField HeaderText="Report Grp" DataField="ReportGrp" SortExpression="ReportGrp" Visible=false>
                                            <ItemStyle HorizontalAlign="Left" CssClass="Left5pxPadd" />                                            
                                            <HeaderStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:TemplateField SortExpression="Buy Grp" ItemStyle-HorizontalAlign="center" 
                                        HeaderText="Buy Grp">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="hplReportGrp" Target="_blank" runat="server" Visible="true" 
                                                NavigateUrl='<%# "POPastDueDetailReport.aspx?BuyGrpNo=" + DataBinder.Eval(Container,"DataItem.BuyGrpNo")+"&BuyGrpDesc="+ DataBinder.Eval(Container,"DataItem.BuyGrp") + "&ReportGrp=" + Request.QueryString["ReportGrp"].ToString() %>'
                                                Text='<%#DataBinder.Eval(Container,"DataItem.BuyGrp")%>'></asp:HyperLink>                                            
                                        </ItemTemplate>                                                             
                                        ...
                                        <asp:BoundField HtmlEncode="False" DataField="OpenPOMosSupply" HeaderText="Open PO Mos Supply"
                                            SortExpression="OpenPOMosSupply" >
            ...
            <tr>
                <td colspan="2" valign="top">                    
                        <uc2:BottomFooter ID="ucFooter" Title="PO Past Due By Buy Group" runat="server" />
