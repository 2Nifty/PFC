<%@ Page Language="C#" AutoEventWireup="true" Trace="false" CodeFile="POPastDueByReportGroup.aspx.cs"
    EnableEventValidation="false" ValidateRequest="false" Inherits="POPastDueByReportGrp" %>
...
<head id="Head1" runat="server">
    ...
    {
        POPastDueByReportGrp.DeleteExcel('POPastDueByReportGrp'+session).value
        parent.window.close();           
    }
    </script>
        ...
        <table cellpadding="0" cellspacing="0" width="100%" id="mainTable">
                            ...
                            <div class="Sbar" id="div-datagrid" style="overflow-x: auto; overflow-y: auto; position: relative;
                                ...
                                <asp:GridView UseAccessibleHeader="true" PagerSettings-Visible="false" Width="1018px"
                                    ...
                                    <EmptyDataRowStyle VerticalAlign="Top" BorderWidth="0px" CssClass="GridHead" BackColor="#DFF3F9"
                                        HorizontalAlign="Center" />
                                    <Columns>
                                        <asp:TemplateField SortExpression="ReportGrp" ItemStyle-HorizontalAlign="center" 
                                        HeaderText="Report Grp">
                                        <ItemTemplate>
                                            <asp:HyperLink ID="hplReportGrp" Target="_blank" runat="server" Visible="true" 
                                                NavigateUrl='<%# "POPastDueReport.aspx?ReportGrp="+ DataBinder.Eval(Container,"DataItem.ReportGrp")%>'
                                                Text='<%#DataBinder.Eval(Container,"DataItem.ReportGrp")%>'></asp:HyperLink>                                            
                                        </ItemTemplate>                                                             
                                        ...
                                        <asp:BoundField HtmlEncode="False" DataField="TotOpenPOLbs" HeaderText="Tot Open PO Lbs"
                                            ...
                                            <ItemStyle HorizontalAlign="Right" Width="83px" />
                                            <HeaderStyle Wrap="True" HorizontalAlign="Center" Width="83px" />
                                        </asp:BoundField>
            ...
            <tr>
                <td colspan="2" valign="top">                    
                        <uc2:BottomFooter ID="ucFooter" Title="PO Past Due By Report Group" runat="server" />
