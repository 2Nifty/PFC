...
namespace PFC.Intranet.SalesByPackageGroupDashboard
{
    public partial class SalesByPackageGroup : System.Web.UI.Page
    {
        ...
        private DataTable dtMain, dtTotal; //dtGroup
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {   
                ...
                //if (_locSalesGrp == "")
                //    _locSalesGrp = "ALL";
                lblSalesGrp.Text = "Sales Region: " + _locSalesGrp;  

                lblOrderSource.Text = "Order Source: " + (_orderSourceDesc == "" ? salesbyPackingGroupBL.GetListDesc("SOEOrderSource", _orderSource) : _orderSourceDesc);
        ...
        public void BindDataGrid()
        {
            ...
            dtInvoiceAnalysis = salesbyPackingGroupBL.GetLostLeadersDatabyBuyGrppp(_startDate, _endDate, _branchID, _orderSource, _locSalesGrp, _pkgType); 
        ...
        {
            sortExpression = ((hidSort.Value != "") ? hidSort.Value : "SequenceNo ASC");
        ...
        public void BindPrintDialog()
        {
            ...
            pdInvoice.PageTitle = "Sales By Package Group";
        ...
        protected void ibtnExcelExport_Click(object sender, ImageClickEventArgs e)
        {
            ...
            //_orderSourceDesc = Request.QueryString["OrderSourceDesc"].ToString();  
            //_orderSourceDesc = Request.QueryString["PkgType"].ToString();   
            ...
            if (dtInvoiceAnalysis != null && dtInvoiceAnalysis.Rows.Count > 0)
            {
                ...
                headerContent += "<tr><th colspan='7' style='color:blue' align=left><center>Sales By Package Grouping</center></th></tr>" +
                                 "<td colspan='2'><b>Beginning Date: " + cldStartDt.SelectedDate.ToShortDateString() + "</b></td>" +
                                 "<td colspan='2'><b>Ending Date: " + cldEndDt.SelectedDate.ToShortDateString() + "</b></td>" +
                ...
                headerContent += "<tr>" +
                                 "<th width='80'  nowrap align='center'>PkgType</td>" +
                ...
                {                  
                    foreach (DataRow drSalesAnalysis in dtMain.Rows)
                    {
                        ...
                        excelContent += "<tr>"+
                                        ...
                                        drSalesAnalysis["PkgType"] + "</td><td nowrap>" +
