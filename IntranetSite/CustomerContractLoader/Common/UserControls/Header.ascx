<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Header.ascx.cs" Inherits="PFC.Intranet.ListMaintenance.Header" %>
    ...
    <div id="PageHeader" style="color:#FFFFFF;">
         ...
         <table width=100%>
            <tr>
                <td><asp:Label ID="Label1" runat="server"  CssClass="BannerText" Text="Customer Contract Loader"></asp:Label> </td>     
                <%--<td align=right style="padding-right:10px;">
                    <asp:Label ID="Label2" ForeColor=#CC0000 Font-Bold=true runat="server" Text="Customer Name:"> </asp:Label>&nbsp;
                    <asp:Label ForeColor=#CC0000 ID="lblCustNo" runat="server" Font-Bold=true></asp:Label>
                </td>--%>
            </tr>
         </table>
