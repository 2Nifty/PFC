...
<head>
    ...
    {
        var hwin=window.open("CommonPrint.aspx?ScriptX=YES&PageURL="+url,"LanscapePrint",'height=100,width=100,scrollbars=no,status=no,top='+((screen.height/2) - (280/2))+',left='+((screen.width/2) - (505/2))+',resizable=NO',"");
        hwin.focus();
    }
                                        ...
                                        <td style="width: 600px;" valign="top">
                                            ...
                                            <table cellpadding="0" cellspacing="0" border="0" runat="server" id="tblPrinter">
                                                <tr>
                                                    ...
                                                    <td style="width: 80px; height: 27px;">
                                                        <asp:Label ID="Label7" runat="server" Text="Branch Name " Width="80px" Font-Bold="True"></asp:Label></td>
                                                    <td style="width: 80px">
                                                        <asp:DropDownList ID="ddlLocation" runat="server" Width="120px" OnSelectedIndexChanged="ddlPrinterServer_SelectedIndexChanged"
                                                    ...
                                                    <td style="width: 100px">
                                                        <asp:DropDownList ID="ddlPrinterName" runat="server" Width="147px" Enabled="False"
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td style="height: 20px; padding-left: 10px">
                                                        <asp:Label ID="Label1" runat="server" Font-Bold="True" Text="Branch Name" Width="80px"></asp:Label></td>
                                                    <td style="width: 100px; height: 20px;">
                                                        <asp:DropDownList ID="ddlDefaultLocation" runat="server" Width="120px" Enabled="False"
