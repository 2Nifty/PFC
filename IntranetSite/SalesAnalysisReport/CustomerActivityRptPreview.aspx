<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomerActivityRptPreview.aspx.cs" Inherits="CustomerActivityRptPreview" %>
                        ...
                        <tr>
                            <td>
                                <span class="BanText" style="padding-left: 5px;">
                                    <asp:Label ID="lblBanner" runat="server" Text="Employee Version: "></asp:Label>
...
<%--                            <td align="center" class="tdPad" style="font-weight:bold; width:25%">
                            ...
                            <td align="right" class="tdPadTop2 tdPadLeft" style="font-weight:bold; width:15%">
            ...
            <tr>
                <td>
                    <%--Main Report Panel--%>
                        <table cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                <td valign="top" class="tdBordLeft">
                                    <table cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td style="width:100%;">
                                                <%--Customer Info--%>
                                                ...
                                                <%--A/R Aging--%>
                                                        <table id="tblAging" width="825px" cellpadding="0" cellspacing="0" border="0">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="center" class="tdPadTop5 tdPadRight10 tdBordRight tdBordTop">
                                                                    <asp:Label ID="lblARTot" runat="server" Text="n/a"></asp:Label>
                                                                </td>
                                                            </tr>
                                                        </table>
                                            </td>
                                ...
                                <td class="tdBordLeft">
                                    <table cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td style="width:100%;">
                                                <%--Sales History--%>
                                                        <table id="tblHist" width="825px" cellpadding="0" cellspacing="0" border="0" class="tdBordBtm">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="center" class="tdPadTop5 tdPadRight10 tdBordRight tdBordTop">
                                                                    <asp:Label ID="lblDlrPctChgLastMth" runat="server" Text="n/a"></asp:Label>
                                                                </td>
                                                                <td align="right" class="tdPadTop5 tdPadRight10 tdBordRight tdBordTop">
                                                                    <asp:Label ID="lblDlrPctChgCurYr" runat="server" Text="DlrPctChg CurYr"></asp:Label>
                                                                </td>
                                                                <td align="center" class="tdPadTop5 tdPadRight10 tdBordRight tdBordTop">
                                                                    <asp:Label ID="lblDlrPctChgLastYr" runat="server" Text="n/a"></asp:Label>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <tr id="trSlsHist" runat="server">
                                                                ...
                                                                <td align="center" class="tdPadTop5 tdPadRight10 tdBordRight tdBordTop">
                                                                    <asp:Label ID="lblSlsHistCurMth" runat="server" Text="n/a"></asp:Label>
                                                                </td>
                                                                <td align="center" class="tdPadTop5 tdPadRight10 tdBordRight tdBordTop">
                                                                    <asp:Label ID="lblSlsHistLastMth" runat="server" Text="n/a"></asp:Label>
                                                                </td>
                                                                <td align="right" class="tdPadTop5 tdPadRight10 tdBordRight tdBordTop">
                                                            ...
                                                            <tr id="trLbsHist" runat="server">
                                                                ...
                                                                <td align="center" class="tdPadTop5 tdPadRight10 tdBordRight tdBordTop">
                                                                    <asp:Label ID="lblLbsHistCurMth" runat="server" Text="n/a"></asp:Label>
                                                                </td>
                                                                <td align="center" class="tdPadTop5 tdPadRight10 tdBordRight tdBordTop">
                                                                    <asp:Label ID="lblLbsHistLastMth" runat="server" Text="n/a"></asp:Label>
                                                                </td>
                                                                <td align="right" class="tdPadTop5 tdPadRight10 tdBordRight tdBordTop">
                                                            ...
                                                            <tr id="trCurWkGoal" runat="server">
                                                                ...
                                                                <td align="center" class="tdPadTop5 tdPadRight10 tdBordRight tdBordTop">
                                                                    <asp:Label ID="lblCurWkGoalLastMth" runat="server" Text="n/a"></asp:Label>
                                                                </td>
                                                                <td align="right" class="tdPadTop5 tdPadRight10 tdBordRight tdBordTop">
                                                                    <asp:Label ID="lblCurWkGoalCurYr" runat="server" Text="CurWkGoal CurYr"></asp:Label>
                                                                </td>
                                                                <td align="center" class="tdPadTop5 tdPadRight10 tdBordRight tdBordTop">
                                                                    <asp:Label ID="lblCurWkGoalLastYr" runat="server" Text="n/a"></asp:Label>
                                                                </td>
                                                            </tr>
                            ...
                            <tr>
                                <td id="tdWhiteSpace" runat="server" style="height:88px; width:825px;">
                                    &nbsp;
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div style="page-break-before:always;">
                                        <table id="tblGrid" runat="server" cellpadding="0" cellspacing="0" width="825px" class="tdBordLeft tdBordRight tdBordBtm">
                                        <tr class="BluBg">
                                            <td align="center" class="tdPadTop5 tdBordBtm" style="border-top:solid 2px Gray; font-weight:bold; font-size:medium;">
                                        ...
                                        <tr>
                                            <td style="width:100%;">
                                                <%--Group Summary Grid--%>
                                                            ...
                                                            <asp:DataGrid ID="dgSummary" Width="1425px" runat="server" BorderWidth="1px" BorderColor="#DAEEEF" Style="height: auto;"
                                                                ShowHeader="true" ShowFooter="true" AutoGenerateColumns="False" OnItemDataBound="dgSummary_ItemDataBound">
<%--                                                            
