<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BranchItemShippingSalesAnalysisUserPrompt.aspx.cs"    Inherits="BranchItemShippingSalesAnalysisUserPrompt" %>
...
<head id="Head1" runat="server">
    <title>Branch Item Shipping Sales Analysis User Prompt</title>
...
function ViewReport()
{
    var Url = "BranchItemShippingSalesAnalysis.aspx?Month=" + document.form1.ddlMonth.value + "~Year=" + document.form1.ddlYear.value + "~Branch=" + document.form1.ddlBranch.value + "~Agent=" + document.form1.ddlAgent.value +"~MonthName="+document.form1.ddlMonth.options[document.form1.ddlMonth.selectedIndex].text +"~BranchName="+document.form1.ddlBranch.options[document.form1.ddlBranch.selectedIndex].text +
                ...
                <td width="100%" height="100%" valign="top">
                    <table width="100%" border="0" cellspacing="0" cellpadding="2" >
                        <tr>
                            ...
                            <div class="LeftPadding"><div align="left" class="BannerText"> Branch Item Shipping Agent Sales Analysis Report</div></div></td>
                            <td class="PageHead"  style="height: 40px" >
...
<table border="0" cellspacing="0" cellpadding="3" style="width: 794px; height: 131px" >
    ...
    <tr>
        <td style="width: 93px"><span class="LeftPadding">Ship Agent</span></td>
        <td colspan="3" style="width: 288px">
            <asp:DropDownList ID="ddlAgent" runat="server" CssClass="FormCtrl" Width="190px">
            </asp:DropDownList></td>
    </tr>
    <tr>
