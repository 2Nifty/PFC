<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BranchItemShippingSalesAnalysisPreview.aspx.cs" Inherits="Sales_Analysis_Report_BranchItemShippingSalesAnalysisPreview" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Branch Item Shipping Agent Sales Analysis Report</title>
    ...
    <table width="100%"  border="0" cellspacing="1" cellpadding="0">
        <tr>
            <td class="PageHead" colspan="2" valign="middle">
                <div id="PrintDG1">                  
                    <div align="left" class="LeftPadding">Branch Item Shipping Agent Sales Analysis</div>
                </div>
            </td>
        </tr>
      <tr>
            ...
            <tr>
              <td valign="top" width="100%" >
                ...
                <asp:DataGrid ID=dgAnalysis  BackColor=#f4fbfd runat=server BorderColor="#c9c6c6" Width=2000px AutoGenerateColumns=false PagerStyle-Visible="false" OnItemDataBound="dgAnalysis_ItemDataBound"  BorderWidth=1 GridLines=both ShowFooter="true" >
                    ...
                    <Columns>
                        <asp:BoundColumn HeaderText="Agent" DataField="ShippingAgent" SortExpression="ShippingAgent" ItemStyle-Wrap=false FooterStyle-CssClass=GridHead HeaderStyle-CssClass=GridHead ItemStyle-CssClass=GridItem></asp:BoundColumn>
