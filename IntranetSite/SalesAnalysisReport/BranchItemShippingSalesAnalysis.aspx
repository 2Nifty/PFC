<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BranchItemShippingSalesAnalysis.aspx.cs"
    Inherits="BranchItemShippingSalesAnalysis" %>

<%@ Register Src="../Common/UserControls/pager.ascx" TagName="pager" TagPrefix="uc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Branchwise Item Shipping Agent Sales Analysis Report</title>
    ...
    <script> 
        ...
        function PrintReport(version,period)
        {
                     var url= "period="+period+"&version="+version+"&Month=" + '<%= (Request.QueryString["Month"] != null) ? Request.QueryString["Month"].ToString().Trim() : "" %>' +
                              ...
                              "&Agent=" + '<%= (Request.QueryString["Agent"] != null) ? Request.QueryString["Agent"].ToString().Trim() :"" %>' +
                    ...
                    window.open('BranchItemShippingSalesAnalysisPreview.aspx?'+url, '', 'height=700,width=1020,scrollbars=no,status=no,top='+((screen.height/2) - (760/2))+',left='+((screen.width/2) - (1020/2))+',resizable=NO',"");
        }
       ...
       function DeleteFiles(session)
       {
           ...
           var str=BranchItemShippingSalesAnalysis.DeleteExcel('BranchItemShippingSalesAnalysis'+session).value.toString();
           parent.window.close();
       }
                    ...
                    <table width="100%" border="0" cellspacing="1" cellpadding="0">
                        <tr>
                            <td colspan="2" valign="middle" class="PageHead">
                                <table width=100% border="0" cellspacing="0" cellpadding="0">
                                    <tr height=20px>
                                        <td style="height: 20px"><div align="left" class="LeftPadding">Branch Item Shipping Agent Sales Analysis</div></td>
                            ...
                            <td colspan="2" align="left" class="PageBg">
                                <table width="100%" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td class="TabHead">
                                            <span class="LeftPadding">Agent :
                                                <%=Request.QueryString["Agent"].ToString() %>
                                            </span>
                                        </td>
                                        <td class="TabHead">
                                        ...
                                        <td valign="top" width="100%">
                                            <div id="div-datagrid" class="Sbar" style="overflow: auto; position: relative; top: 0px;
                                                ...
                                                <asp:DataGrid ID="dgAnalysis" BackColor="#f4fbfd" AllowPaging="true" runat="server"
                                                    ...
                                                    <Columns>
                                                        <asp:BoundColumn HeaderText="Agent" DataField="ShippingAgent" SortExpression="ShippingAgent" ItemStyle-Wrap=false></asp:BoundColumn>
