<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="CustomerActivityRptPrompt.aspx.cs" Inherits="CustomerActivityRptPrompt" %>
...
//                _Group = "Category";
            ...
            _Group = document.getElementById("ddlRptGroup").options[document.getElementById("ddlRptGroup").selectedIndex].value;
            ...
            hwnd=window.open(Url,"CustomerActivityRpt" ,'height=700,width=843,scrollbars=no,status=no,top='+((screen.height/2) - (760/2))+',left='+((screen.width/2) - (843/2))+',resizable=no',"");
            hwnd.focus();
        }
    </script>
</head>
                        ...
                        <tr>
                            <td valign="middle">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td class="PageHead" style="height: 40px; width:300px;">
                                            <div class="LeftPadding BannerText" align="left">Customer Activity Report</div>
                                        </td>

                                        <td class="PageHead" align="right" style="height: 40px;">
                                            <asp:UpdatePanel ID="uplReportContentTop" UpdateMode="Conditional" RenderMode="Inline" runat="server">
                                                <ContentTemplate>
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td>
                                                                <asp:ImageButton ID="btnSubmitTop" runat="server" ImageUrl="../Common/images/submit.gif" OnClick="btnSubmit_Click" />
                                                                <asp:ImageButton ID="btnClearTop" Visible="false" runat="server" ImageUrl="../Common/images/btnClear.gif" OnClick="btnClear_Click" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </ContentTemplate>
                                        ...
                                        <td class="PageHead" align="left" style="height: 40px;">
                                ...
                                <table width="765" border="0" cellspacing="0" cellpadding="3">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" valign="middle">
                                            <asp:UpdatePanel runat="server" ID="pnlBrSumm" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <asp:CheckBox ID="chkBrSumm" runat="server" AutoPostBack="true" Text="&nbspBranch Summary" OnCheckedChanged="chkBrSumm_CheckedChanged" />
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td valign="top" colspan="2" rowspan="5" class="LeftPadding">
                                            <asp:UpdatePanel ID="pnlResults" runat="server" UpdateMode="conditional">
                                                <ContentTemplate>
                                                    <div id="divdatagrid" class="Sbar" align="left" runat="server" visible="false" style="overflow:auto; width:350px; position:relative; top:0px; left:0px; height:128px; border:0px solid; vertical-align:top; overflow-y:scroll;">
                                                        <asp:DataGrid ID="dgResults" Width="330px" runat="server" BorderWidth="1px" BorderColor="#DAEEEF" CssClass="grid" style="height: auto;"
                                                            ...
                                                            PagerStyle-Visible="false" AllowPaging="false" OnItemDataBound="dgResults_ItemDataBound">
                                                                ...
                                                                <%--<asp:BoundColumn DataField="pCustMstrID">
                                                                    ...
                                                                    <asp:BoundColumn DataField="RecID">
                                                                        <ItemStyle Width="30px" HorizontalAlign="Center" Wrap="False" />
                                                                    </asp:BoundColumn>
                                                                    
                                                                    <asp:BoundColumn DataField="RecName">
                                    ...
                                    <tr>
                                        ...
                                        <td valign="middle">
                                            <asp:UpdatePanel runat="server" ID="pnlRptGroup" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="ddlRptGroup" runat="server" CssClass="FormCtrl" Width="195px">
<%--                                                         <asp:ListItem>Category</asp:ListItem>
                                                         <asp:ListItem>Category Buy Group</asp:ListItem>
                                                         <asp:ListItem>Product Family</asp:ListItem>--%>
                                                    </asp:DropDownList>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td id="tdPrinter" runat="server" align="left" valign="middle" colspan="2" class="TabHead LeftPadding" style="height:20px;">
                                            <asp:UpdatePanel runat="server" ID="pnlPrinter" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <div id="divPrinter" runat="server" visible="false">
                                                        Print Server&nbsp;
                                                       <asp:DropDownList ID="ddlPrintServer" runat="server" Width="77px" OnSelectedIndexChanged="ddlPrintServer_SelectedIndexChanged" CssClass="FormControls" AutoPostBack="True" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        Printer&nbsp;
                                                       <asp:DropDownList ID="ddlPrintName" runat="server" Width="135px" CssClass="FormControls" />
                                                    </div>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </td>
                                    ...
                                    <tr>
                                        <td align="left" valign="middle" class="TabHead LeftPadding" style="height:20px;">
                                            <asp:UpdatePanel runat="server" ID="pnlBuyGrpRpt" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <asp:CheckBox ID="chkBuyGrpRpt" Text="Category Buy Group" runat="server" AutoPostBack="true" OnCheckedChanged="chkBuyGrpRpt_CheckedChanged" />
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </td>
                                        <td align="left" valign="middle" class="TabHead">
                                        ...
                                        <td runat="server" align="left" valign="middle" colspan="2" class="TabHead LeftPadding" style="height:20px;">
                                            <asp:UpdatePanel runat="server" ID="pnlPrinter" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                    <div id="divPrinter" runat="server" visible="false">
                                                        Print Server&nbsp;
...
--%>
                        ...
                        <tr class="PageBg" height="30">
                            <td align="left" class="TabHead" colspan="2" valign="middle">
                                <asp:UpdatePanel ID="uplReportContentBtm" UpdateMode="Conditional" RenderMode="Inline" runat="server">
                                    <ContentTemplate>
                                        <table border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td style="width: 420px">&nbsp;</td>
                                                <td>
                                                    <asp:ImageButton ID="btnSubmitBtm" runat="server" ImageUrl="../Common/images/submit.gif" OnClick="btnSubmit_Click" />
                                                    <asp:ImageButton ID="btnClearBtm" Visible="false" runat="server" ImageUrl="../Common/images/btnClear.gif" OnClick="btnClear_Click" />
                                                </td>
                                                <td style="padding-right:15px; width:280px;" align="right">
                                                    <asp:ImageButton ID="btnPrint" Visible="false" runat="server" ImageUrl="../Common/images/print.gif" OnClick="btnPrint_Click" />
                                                </td>
                                            </tr>
                                        </table>
                                    </ContentTemplate>
                                    <Triggers>
                                        <asp:PostBackTrigger ControlID="btnSubmitBtm" />
                                    </Triggers>
                                </asp:UpdatePanel>
                            </td>
                        </tr>
