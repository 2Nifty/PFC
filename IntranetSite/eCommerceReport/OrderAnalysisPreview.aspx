<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrderAnalysisPreview.aspx.cs"
    Inherits="OrderAnalysisPreview" %>
...
<head id="Head1" runat="server">
    <title>eCommerce Order Analysis Preview</title>
                                ...
                                <td class="PageHead" colspan="5" style="height: 40px">
                                    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                        <tr>
                                            ...
                                            <asp:Label Text="eCommerce Order Analysis Preview" style="word-wrap:normal" ID="lblReportCap" runat="server" Width="350px"></asp:Label>                                                
                                            </td>
                ...
                <tr>
                    <td>
                        <div class="Sbar" id="div-datagrid" style="overflow-x: auto; overflow-y: auto;
                            ...
                            <div id="PrintDG2">
                                <asp:DataGrid ID="dgOrderAnalysis" BackColor="#f4fbfd" runat="server" Width="1050"
                                ...
                                <FooterStyle HorizontalAlign="Right" CssClass="GridHead" Height=20px BackColor="#DFF3F9" />
                                    ...
                                    <asp:BoundColumn HeaderStyle-Width="70" ItemStyle-HorizontalAlign="left" HeaderText="P.O. Number" FooterStyle-HorizontalAlign="left"
                                        DataField="PurchaseOrderNo" DataFormatString="{0:MM/dd/yyyy}" SortExpression="PurchaseOrderNo" ItemStyle-Wrap="false"
                                    ...
                                    <asp:BoundColumn HeaderStyle-Width="80" ItemStyle-HorizontalAlign="Left" HeaderText="Sales Branch Of Record" FooterStyle-HorizontalAlign="Left"
                                        DataField="SalesLocationCode" DataFormatString="{0:#,##0}" SortExpression="SalesLocationCode" ItemStyle-Wrap="false"
 ...
 function PrintReport(strid1,strid2)
{
     ...
     prtContent=prtContent+"<table cellspacing=0 cellpadding=0 width='100%'><tr><td style='width:350px;'colspan=3><h3>eCommerce Order Analysis Report</h3></td></tr>";
...
{ 
    var table = document.getElementById("dgOrderAnalysis"); // the id of your DataGrid
