<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrderAnalysisReport.aspx.cs"
    Inherits="OrderAnalysisReport" %>
...
<body>
            ...
            <tr>
                <td>
                    <div class="Sbar" id="div-datagrid" style="overflow-x: auto; overflow-y: auto; position: relative;
                        ...
                        <div id="PrintDG2">
                            <asp:DataGrid  UseAccessibleHeader=true ID="dgOrderAnalysis" Width="1100" runat="server" GridLines="both" BorderWidth="1px" ShowFooter="true" AllowSorting="true"
                                AutoGenerateColumns="false" BorderColor="#DAEEEF" AllowPaging="true" PageSize="19" PagerStyle-Visible="false" OnItemDataBound="dgOrderAnalysis_ItemDataBound" OnPageIndexChanged="dgOrderAnalysis_PageIndexChanged" OnSortCommand="dgOrderAnalysis_SortCommand">
                                ...
                                <FooterStyle CssClass="GridHead" BackColor="#DFF3F9" BorderColor="#DAEEEF" Height="20px"
                                    HorizontalAlign="Center" />
                                <Columns>                                    
                                    <asp:BoundColumn HeaderStyle-Width="100" ItemStyle-HorizontalAlign="left" HeaderText="Order Method" FooterStyle-HorizontalAlign=Center
                                        DataField="OrderMethod" SortExpression="OrderMethod" ItemStyle-Wrap="false"
                                    ...
                                    <asp:TemplateColumn HeaderText="P.O. Number" SortExpression="PurchaseOrderNo" ItemStyle-Width="80">
                                        <ItemTemplate>
                                            <asp:Label Style="cursor:hand;" ID="lblPONo" runat=server Text='<%# DataBinder.Eval(Container.DataItem,"PurchaseOrderNo")%>' Font-Underline=true></asp:Label>
                                    ...
                                    <asp:BoundColumn HeaderStyle-Width="70" ItemStyle-HorizontalAlign="left" HeaderText="P.O. Date" FooterStyle-HorizontalAlign="left"
                                        DataField="PurchaseOrderDate" DataFormatString="{0:MM/dd/yyyy}" SortExpression="PurchaseOrderDate" ItemStyle-Wrap="false"
                                    ...
                                    <asp:BoundColumn ItemStyle-HorizontalAlign="left" HeaderText="User Item #" DataField="UserItemNo" SortExpression="UserItemNo" DataFormatString="{0:#,##0.00}" ItemStyle-Wrap="false" FooterStyle-HorizontalAlign="right"
                                        ItemStyle-Width="150" HeaderStyle-Wrap="false"></asp:BoundColumn>
                                    ...
                                    <asp:BoundColumn HeaderStyle-Width="80" ItemStyle-HorizontalAlign="Left" HeaderText="Sales Branch Of Record" FooterStyle-HorizontalAlign="Left"
                                        DataField="SalesLocationCode" DataFormatString="{0:#,##0.00}" SortExpression="SalesLocationCode" ItemStyle-Wrap="false"
                                    ...
                                    <asp:BoundColumn HeaderStyle-Width="40" ItemStyle-HorizontalAlign="right" HeaderText="Ava. Qty" FooterStyle-HorizontalAlign="right"
                                        DataField="AvailableQuantity" DataFormatString="{0:#,##0}" SortExpression="AvailableQuantity" ItemStyle-Wrap="false"
                                        ItemStyle-Width="40" HeaderStyle-Wrap="false"></asp:BoundColumn>                                                                            
                                    ...
                                    <asp:BoundColumn HeaderStyle-Width="40" ItemStyle-HorizontalAlign="right" HeaderText="Margin %" FooterStyle-HorizontalAlign="right"
                                        DataField="MarginPercentage" DataFormatString="{0:#,##0.0}" SortExpression="MarginPercentage" ItemStyle-Wrap="false"
                                        ItemStyle-Width="40" HeaderStyle-Wrap="false"></asp:BoundColumn>
                                    ...
                                    <asp:BoundColumn HeaderStyle-Width="40" ItemStyle-HorizontalAlign="Left" HeaderText="Price UOM" FooterStyle-HorizontalAlign="Left"
                                        ...
                                        ItemStyle-Width="40" HeaderStyle-Wrap="false"></asp:BoundColumn>
                                    <asp:BoundColumn HeaderStyle-Width="70"  HeaderText="Total Price" FooterStyle-HorizontalAlign="right"
                                        DataField="TotalPrice" DataFormatString="{0:#,##0.00}" SortExpression="TotalPrice" ItemStyle-Wrap="false"
                                        ItemStyle-Width="70" HeaderStyle-Wrap="false" ItemStyle-HorizontalAlign="right"></asp:BoundColumn>                                        
                                    <asp:BoundColumn HeaderStyle-Width="70"  HeaderText="Total Weight" FooterStyle-HorizontalAlign="right"
                                        DataField="Weight" DataFormatString="{0:#,##0.00}" SortExpression="Weight" 
                                        ItemStyle-Width="70" HeaderStyle-Wrap="false" ItemStyle-HorizontalAlign="right"></asp:BoundColumn>                                        
    ...
    </form><script type="text/javascript" >installTable ("dgOrderAnalysis","~Order Method~Expiry Date~User Item #~PFC Item #~Description~");</script>
</body>
</html>
