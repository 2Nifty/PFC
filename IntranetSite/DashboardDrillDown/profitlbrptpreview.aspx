<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProfitLbRptPreview.aspx.cs" Inherits="ProfitLbRptPreview" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Dashboard Performance Drilldown - Margin Per Pound Report Preview</title>
                                    ...
                                    <tr>
                                        <td valign="top" width="100%">
                                            <div class="Sbar" id="div-datagrid" style="overflow: auto; position: relative;
                                                top: 0px; left: 5px; bottom: 0px; height: 590px; width: 695px; border: 0px solid;">
                                                <div id="PrintDG3">
