<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProfitRpt.aspx.cs" Inherits="ProfitRpt" %>
...
<head id="Head1" runat="server">
    <title>Dashboard Performance Drilldown - Profit Report</title>
...
{
    var str=ProfitRpt.DeleteExcel('ProfitRpt_'+Session).value.toString();
    parent.window.close();
}

function PrintReport(Location, LocName, Range)
{
    var URL = "ProfitRptPreview.aspx?Location=" + Location + "&LocName=" + LocName + "&Range=" + Range;
                    ...
                    <asp:UpdatePanel ID="upnlGrid" UpdateMode="conditional" runat="server">
                        <ContentTemplate>
                            <div class="Sbar" id="div-datagrid" style="overflow: auto; position: relative;
                                top: 0px; left: 5px; height: 555px; width: 715px; border: 0px solid;">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundColumn HeaderText="Profit $" DataField="Profit" SortExpression="Profit">
                                ...
                                <table class="BluBordAll" width="675" border="0" cellspacing="0" cellpadding="0"
                                  style="position: relative; top: 0px; left: 0px; height: 30px; width: 715px; border: 1px solid;">
                                    <tr style="border:1px solid #e1e1e1; background-color:#B3E2F0;">
                                        <td class="GridHead" align="left" style="border:1px solid #e1e1e1; font-weight:bold; width:80px">Grd-Tot:</td>
                                        <td class="Left5pxPadd" align="right" style="border:1px solid #e1e1e1; font-weight:bold; width:127px">
                                            <asp:Label ID="lblTotProfit" runat="server" Text="n/a"></asp:Label></td>
                                        <td class="Left5pxPadd" align="right" style="border:1px solid #e1e1e1; font-weight:bold; width:126px">
                                            <asp:Label ID="lblTotMgnDollars" runat="server" Text="n/a"></asp:Label></td>
                                        <td class="Left5pxPadd" align="right" style="border:1px solid #e1e1e1; font-weight:bold; width:100px">
                                            <asp:Label ID="lblTotPounds" runat="server" Text="n/a"></asp:Label></td>
                                        <td class="Left5pxPadd" align="right" style="border:1px solid #e1e1e1; font-weight:bold; width:49px">
                                            <asp:Label ID="lblTotMgnPerLb" runat="server" Text="n/a"></asp:Label></td>
                                        <td class="Left5pxPadd" align="right" style="border:1px solid #e1e1e1; font-weight:bold; width:80px">
                                            <asp:Label ID="lblTotMgnPct" runat="server" Text="n/a"></asp:Label></td>
                                        <td class="Left5pxPadd" align="right" style="border:1px solid #e1e1e1; font-weight:bold; width:126px">
                                            <asp:Label ID="lblTotSales" runat="server" Text="n/a"></asp:Label></td>                                                                                                
                                        <td class="Left5pxPadd" align="right" style="border:1px solid #e1e1e1; font-weight:bold; width:50px">
