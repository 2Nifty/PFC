<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CSRMarginRpt.aspx.cs" Inherits="CSRMarginRpt" %>
...
{
    var str=CSRMarginRpt.DeleteExcel('MarginRpt_'+Session).value.toString();
    parent.window.close();
}

function PrintReport(Location, LocName, Range, csrName)
{
    var URL = "CSRMarginRptPreview.aspx?Location=" + Location + "&LocName=" + LocName + "&Range=" + Range + "&CSRName=" + csrName;
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img Style="cursor: hand" src="../Common/Images/Print.gif"
                                                            align="middle" onclick="Javascript:PrintReport('<%=Request.QueryString["Location"] %>', '<%=Request.QueryString["LocName"] %>', '<%=Request.QueryString["Range"] %>','<%= Request.QueryString["CSRName"] %>');" />
                                                    </td>
                                                    <td>
                        ...
                        <ContentTemplate>
                            <div class="Sbar" id="div-datagrid" style="overflow: auto; position: relative;
                                ...
                                <table class="BluBordAll" border="0" cellspacing="0" cellpadding="0"
                                  style="position: relative; top: 0px; left: 0px; height: 30px; width: 590px; border: 1px solid;">
                                    <tr style="border:1px solid #e1e1e1; background-color:#B3E2F0;">
                                        <td class="GridHead" align="left" style="border:1px solid #e1e1e1; font-weight:bold; width:63px">Grd-Tot:</td>
                                        ...
                                        <td class="Left5pxPadd" align="right" style="border:1px solid #e1e1e1; font-weight:bold; width:60px">
