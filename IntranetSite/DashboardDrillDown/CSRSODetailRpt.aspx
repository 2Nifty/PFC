<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CSRSODetailRpt.aspx.cs" Inherits="CSRSODetailRpt" %>
...
<script>
    ...
    {
        var str = CSRSODetailRpt.DeleteExcel('SODetail_'+Session).value.toString();
        parent.window.close();
    }

    function PrintReport(Location, LocName, InvoiceNo, Range, csrName)
    {
        var URL = "CSRSODetailRptPreview.aspx?Location=" + Location + "&LocName=" + LocName + "&Customer=000000&Invoice=" + InvoiceNo + "&Range=" + Range + "&Source=" + document.getElementById("hidSource").value+ "&CSRName=" + csrName;
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="right" style="padding-right:10px">
                                                        <img Style="cursor: hand" src="../Common/Images/Print.gif"
                                                            align="middle" onclick="Javascript:PrintReport('<%=Request.QueryString["Location"] %>', '<%=Request.QueryString["LocName"] %>', '<%=Request.QueryString["Invoice"] %>', '<%=Request.QueryString["Range"] %>','<%=Request.QueryString["CSRName"] %>');" />
                                                    </td>
                                                    <td align="right" style="padding-right:10px">
                    ...
                    <asp:UpdatePanel ID="upnlGrid" UpdateMode="conditional" runat="server">
                        <ContentTemplate>
                            <div class="Sbar" id="div-datagrid" style="overflow: auto; position: relative;
                                top: 0px; left: 5px; height: 560px; width: 1010px; border: 0px solid;">
                                    <asp:DataGrid ID="GridView1" BackColor="#F4FBFD" runat="server" BorderWidth="1px"
                                        ...
                                        OnItemDataBound="ItemDataBound" width="1095px">
                                ...
                                <table class="BluBordAll" border="0" cellspacing="0" cellpadding="0"
                                  style="position: relative; top: 0px; left: 0px; height: 30px; border: 1px solid;">
                                    <tr style="border:1px solid #e1e1e1; background-color:#B3E2F0;">
                                        <td class="GridHead" style="border:1px solid #e1e1e1;"><table width="60px"><tr><td>&nbsp;</td></tr></table></td>
                                        <td class="GridHead" style="border:1px solid #e1e1e1;"><table width="60px"><tr><td>&nbsp;</td></tr></table></td>
                                        <td class="GridHead" style="border:1px solid #e1e1e1;" align="left"><table width="204px"><tr><td>Grand Totals:</td></tr></table></td>
                                        <td class="GridHead" style="border:1px solid #e1e1e1;"><table width="28px"><tr><td>&nbsp;</td></tr></table></td>
                                        <td class="GridHead" style="border:1px solid #e1e1e1;"><table width="71px"><tr><td>&nbsp;</td></tr></table></td>
                                        <td class="GridHead" style="border:1px solid #e1e1e1;"><table width="81px"><tr><td>&nbsp;</td></tr></table></td>
                                        <td class="GridHead" style="border:1px solid #e1e1e1;"><table width="52px"><tr><td>&nbsp;</td></tr></table></td>
                                        <td class="GridHead" style="border:1px solid #e1e1e1; padding-right:3px;" align="right"><table width="60px"><tr><td><asp:Label ID="lblTotShipQty" runat="server" Text="n/a"></asp:Label></td></tr></table></td>
                                        <td class="GridHead" style="border:1px solid #e1e1e1; padding-right:3px;" align="right"><table width="75px"><tr><td><asp:Label ID="lblTotSales" runat="server" Text="n/a"></asp:Label></td></tr></table></td>
                                        <td class="GridHead" style="border:1px solid #e1e1e1; padding-right:3px;" align="right"><table width="75px"><tr><td><asp:Label ID="lblTotPounds" runat="server" Text="n/a"></asp:Label></td></tr></table></td>
                                        <td class="GridHead" style="border:1px solid #e1e1e1; padding-right:3px;" align="right"><table width="56px"><tr><td><asp:Label ID="lblTotPricePerLb" runat="server" Text="n/a"></asp:Label></td></tr></table></td>
                                        <td class="GridHead" style="border:1px solid #e1e1e1; padding-right:3px;" align="right"><table width="75px"><tr><td><asp:Label ID="lblTotMgnDollars" runat="server" Text="n/a"></asp:Label></td></tr></table></td>
                                        ...
                                        <td class="GridHead" style="border:1px solid #e1e1e1; padding-right:3px;" align="right"><table width="57px"><tr><td><asp:Label ID="lblTotMgnPct" runat="server" Text="n/a"></asp:Label></td></tr></table></td>
                                        <td class="GridHead" style="border:1px solid #e1e1e1;"><table width="32px"><tr><td>&nbsp;</td></tr></table></td>
                                    </tr>
                                </table>
                            </div>
                        </ContentTemplate>
