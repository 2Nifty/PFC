<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SOHeaderRpt.aspx.cs" Inherits="SOHeaderRpt" %>
...
<head id="Head1" runat="server">
    ...
    {
        var str=SOHeaderRpt.DeleteExcel('SOHeader_'+Session).value.toString();
        parent.window.close();
    }

    function PrintReport(Location, LocName, CustNo, Range)
    {
        var URL = "SOHeaderRptPreview.aspx?Location=" + Location + "&LocName=" + LocName + "&Customer=" + CustNo + "&Invoice=0000000000&Range=" + Range + "&Source=" + document.getElementById("hidSource").value;
    ...
    function OpenCatPriceSched(custNo)
    {
        window.open('../CustomerMaintenance/CatPriceSchedMaint.aspx?CustNo=' + custNo ,'CatPriceSchedMaint','height=710,width=1020,Addressbar=0,scrollbars=no,location=no,status=no,top='+((screen.height/2) - (760/2))+',left='+((screen.width/2) - (1020/2))+',resizable=yes','');	
    }
    </script>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                    <tr>
                                        <td class="Left5pxPadd BannerText" width="70%">
                                            ...
                                            <asp:ImageButton runat="server" Style="cursor: hand" ID="btnCatPriceSchd" ImageUrl="~/Common/Images/CatSchd.GIF"
                    ...
                    <asp:UpdatePanel ID="upnlGrid" UpdateMode="conditional" runat="server">
                        <ContentTemplate>
                            <div class="Sbar" id="div-datagrid" style="overflow: auto; position: relative; top: 0px;
                                left: 5px; height: 545px; width: 1015x; border: 0px solid;">
                                <asp:DataGrid ID="GridView1" BackColor="#F4FBFD" runat="server" BorderWidth="1px"
                                    ...
                                    <Columns>
                                        <asp:HyperLinkColumn HeaderText="Invoice" DataTextField="InvoiceNo" DataNavigateUrlField="InvoiceNo"
                                            SortExpression="InvoiceNo" DataNavigateUrlFormatString="javascript:ViewDetail('{0}');">
                                        ...
                                        <asp:BoundColumn HeaderText="Post Date" DataField="ARPostDt" SortExpression="ARPostDt"
                                ...
                                <table class="BluBordAll" border="0" cellspacing="0" cellpadding="0" style="position: relative;
                                    top: 0px; left: 0px; height: 30px; border: 1px solid;">
                                    <tr style="border: 1px solid #e1e1e1; background-color: #B3E2F0;">
                                        <td class="GridHead" style="border: 1px solid #e1e1e1;">
                                            <table width="59px">
                                                <tr>
                                                    <td>
                                                        &nbsp;</td>
