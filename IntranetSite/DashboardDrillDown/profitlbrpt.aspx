<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProfitLbRpt.aspx.cs" Inherits="ProfitLbRpt" %>
...
<head id="Head1" runat="server">
    <title>Dashboard Performance Drilldown - Margin Per Pound Report</title>
...
{
    var str=ProfitLbRpt.DeleteExcel('ProfitLbRpt_'+Session).value.toString();
    parent.window.close();
}

function PrintReport(Location, LocName, Range)
{
    var URL = "ProfitLbRptPreview.aspx?Location=" + Location + "&LocName=" + LocName + "&Range=" + Range;
                    ...
                    <asp:UpdatePanel ID="upnlGrid" UpdateMode="conditional" runat="server">
                        <ContentTemplate>
                            <div class="Sbar" id="div-datagrid" style="overflow: auto; position: relative;
                                top: 0px; left: 5px; height: 555px; width: 695px; border: 0px solid;">
                                ...
                                <table class="BluBordAll" width="675" border="0" cellspacing="0" cellpadding="0"
                                  style="position: relative; top: 0px; left: 0px; height: 30px; width: 695px; border: 1px solid;">
                                    <tr style="border:1px solid #e1e1e1; background-color:#B3E2F0;">
                                        ...
                                        <td class="Left5pxPadd" align="right" style="border:1px solid #e1e1e1; font-weight:bold; width:56px">
                                            <asp:Label ID="lblTotMgnPerLb" runat="server" Text="n/a"></asp:Label></td>
                                        <td class="Left5pxPadd" align="right" style="border:1px solid #e1e1e1; font-weight:bold; width:120px">
                                            <asp:Label ID="lblTotMgnDollars" runat="server" Text="n/a"></asp:Label></td>
                                        <td class="Left5pxPadd" align="right" style="border:1px solid #e1e1e1; font-weight:bold; width:125px">
                                            <asp:Label ID="lblTotProfit" runat="server" Text="n/a"></asp:Label></td>
                                        <td class="Left5pxPadd" align="right" style="border:1px solid #e1e1e1; font-weight:bold; width:95px">
