<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MarginRpt.aspx.cs" Inherits="MarginRpt" %>
...
{
    var str=MarginRpt.DeleteExcel('MarginRpt_'+Session).value.toString();
    parent.window.close();
}

function PrintReport(Location, LocName, Range)
{
    var URL = "MarginRptPreview.aspx?Location=" + Location + "&LocName=" + LocName + "&Range=" + Range;
                    ...
                    <asp:UpdatePanel ID="upnlGrid" UpdateMode="conditional" runat="server">
                        <ContentTemplate>
                            <div class="Sbar" id="div-datagrid" style="overflow: auto; position: relative;
                                ...
                                <table class="BluBordAll" width="940" border="0" cellspacing="0" cellpadding="0"
