<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SODetailRptPreview.aspx.cs" Inherits="SODetailRptPreview" %>
                                    ...
                                    <tr>
                                        <td valign="top" width="100%">
                                            <div class="Sbar" id="div-datagrid" style="overflow: auto; position: relative;
                                                ...
                                                <div id="PrintDG3">
                                                <asp:DataGrid ID="GridView1" BackColor="#F4FBFD" runat="server" BorderWidth="1px" width="1275px"
