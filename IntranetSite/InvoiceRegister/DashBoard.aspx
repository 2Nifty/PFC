...
<head runat="server">
    ...
    function LoadPage(report)
    {
        switch (report)
        {
		    ...
		    break;	
		    case "IRSmoothAvg": 
			    window.open('InvoiceRegisterSmoothAvg.aspx' ,'SmoothAvg','height=700,width=1020,Addressbar=0,scrollbars=no,location=no,status=no,top='+((screen.height/2) - (760/2))+',left='+((screen.width/2) - (1020/2))+',resizable=no',"");	
		    break;	     
		}
                                        ...
                                        <td id="5TD" class="blackTxt" style="height: 92px" width="100%">
                                            ...
                                            <p class="10pxPadding">
                                                ...
                                                <a style="cursor: hand; color: Black;" onclick="LoadPage('IRCSRFilter');" id="A1"
                                                    alt="View invoice register with customer & CSR filters" onmouseover="ToolTip(this,window.event);"
                                                    onmouseout="ToolTip(this,window.event);">&nbsp;Invoice Register (CSR Filter)</a></p>
                                            <p class="10pxPadding">
                                                <img src="../Common/Images/Bullet.gif" width="10" height="9" onclick="LoadPage();">&nbsp;&nbsp;
                                                <a style="cursor: hand; color: Black;" onclick="LoadPage('IRFilterTbl');" id="A3"
                                                    alt="View invoice register - Only for filter table customers" onmouseover="ToolTip(this,window.event);"
                                                    onmouseout="ToolTip(this,window.event);">&nbsp;Invoice Register Filter Table</a></p>
                                            <% 
                                            ...
                                            <p class="10pxPadding">
                                                <img src="../Common/Images/Bullet.gif" width="10" height="9" onclick="LoadPage();">&nbsp;&nbsp;
                                                <a style="cursor: hand; color: Black;" onclick="LoadPage('IRSmoothAvg');" id="A5"
                                                    alt="View invoice register - Avg Cost with new Smooth Avg Cost" onmouseover="ToolTip(this,window.event);"
                                                    onmouseout="ToolTip(this,window.event);">&nbsp;Smooth Average Invoice Register</a></p>
                                            <%
                                                } %>
                                        </td>
                                    </tr>
