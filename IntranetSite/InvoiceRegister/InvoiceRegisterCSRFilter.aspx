<%@ Page Language="C#" AutoEventWireup="true" Trace="false" CodeFile="InvoiceRegisterCSRFilter.aspx.cs"
    ValidateRequest="false" Inherits="InvoiceRegister" %>
        ...
        <table cellpadding="0" cellspacing="0" width="100%" id="mainTable">
                            ...
                            <table cellspacing="0" cellpadding="0" height="40" width="100%">
                                <tr>
                                    ...
                                    <td align="right" rowspan="2">
                                        ...
                                        <img src="Common/Images/btn_hidecal.gif" style="display: none;" id="imgHide" onclick="javascript: document.getElementById('leftPanel').style.display='none';document.getElementById('imgShow').style.display='';this.style.display='none';document.getElementById('div-datagrid').style.width='1018px';hidShowMode.value='Hide';" />&nbsp;
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                            ...
                                            <tr>
                                                <td valign="top">
                                                    ...
                                                    <asp:DropDownList ID="ddlSubTotals" CssClass="FormCtrl" AutoPostBack="true" runat="server"
                                                        Width="200px" OnSelectedIndexChanged="ddlSubTotals_SelectedIndexChanged">
                                                ...
                                                <td style="padding-left: 10px">
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td style="width: 100px; padding-right: 5px;" align="right">
                                                                <asp:Label ID="Label5" runat="server" Text="CSR:  "></asp:Label>
                                                            </td>
                                                            <td style="width: 100px">
                                                                <asp:DropDownList ID="ddlCSR" CssClass="FormCtrl" AutoPostBack="true" runat="server"
                                                                    Width="140px" OnSelectedIndexChanged="ddlCSR_SelectedIndexChanged">
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width: 100px; padding-right: 5px;" align="right">
                                                                <asp:Label ID="Label6" runat="server" Text="Customer No:"></asp:Label>
                                                            </td>
                                                            <td style="width: 100px;padding-top:3px;">
                                                                <asp:DropDownList ID="ddlCustNo" CssClass="FormCtrl" AutoPostBack="true" runat="server"
                                                                    Width="140px" OnSelectedIndexChanged="ddlCustNo_SelectedIndexChanged">
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                    </table>
                    ...
                    <asp:UpdatePanel ID="upnlGrid" UpdateMode="conditional" runat="server">
                        <ContentTemplate>
                            <div class="Sbar" id="div-datagrid" style="overflow-x: auto; overflow-y: auto; position: relative;
                                top: 0px; left: 0px; height: 480px; width: 1008px; border: 0px solid;">
            ...
            <tr>
                <td colspan="2" valign="top">
                    <table width="100%">
                        <uc2:BottomFooter ID="ucFooter" Title="Invoice Register " runat="server" />
