<%@ Page Language="C#" AutoEventWireup="true" Trace="false" CodeFile="NewInvoiceRegisterFilterTable.aspx.cs"
    ValidateRequest="false" Inherits="NewInvoiceRegister" %>
...
function ShowHide(SHMode)
{
 ...
 function PrintReport1(url)
       ...
       {
           NewInvoiceRegister.DeleteExcel('InvoiceRegisterReport'+session).value
            parent.window.close();
    ...
    <form id="form1" runat="server">
        ...
        <table cellpadding="0" cellspacing="0" width="100%" id="mainTable">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                    <tr>
                                        <td class="Left5pxPadd BannerText" width="70%">
                                            Invoice Register Filter Table</td>
            ...
            <tr id="trHead" class="PageBg">
                <td class="LeftPadding TabHead" style="height: 10px" colspan="1">
                                         ...
                                         <table border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td align="right" valign="middle">
                                                    <asp:Label ID="Label4" runat="server" Text="Register &nbsp;Filter:&nbsp;&nbsp;" Width="70px"></asp:Label></td>
                                                <td valign="middle">
                                                    <asp:DropDownList ID="FilterDropDownList" runat="server" DataTextField="ListDesc" DataValueField="ListName">
                                                    </asp:DropDownList>
                                                    </td>
                                                <td valign="middle">
                                                    <asp:Label ID="Label6" runat="server" Text="" Width="10px" Height="20px"></asp:Label></td>
                                                <td>
                                                </td>
                                                <td>
                                                        <asp:ImageButton runat="server" ID="FilterImageButton" ImageUrl="~/Common/Images/submit.gif"
                                                            ImageAlign="middle" OnClick="ibtnFilter_Click" />
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                                ...
                                                <asp:GridView UseAccessibleHeader="true" PagerSettings-Visible="false" PageSize="17"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField HtmlEncode="false" DataField="Item" HeaderText="Item" SortExpression="Item">
                                                            ...
                                                            <FooterStyle HorizontalAlign="Right" />
                                                            <HeaderStyle Wrap="False" HorizontalAlign="Left" Width="110" />
                                                        </asp:BoundField>
                                                        ...
                                                        <asp:BoundField HtmlEncode="false" DataField="PricingType" HeaderText="Pricing Type"
                                                            SortExpression="PricingType">
