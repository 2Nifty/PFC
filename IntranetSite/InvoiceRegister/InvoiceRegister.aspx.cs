...
public partial class InvoiceRegister : System.Web.UI.Page
{
    ...
    private void BindDataGrid()
    {
        ...
        if (dtInvoice != null && dtInvoice.Rows.Count > 0)
        {
            ...
            if (dtInvoice.DefaultView.ToTable(true, "BranchSls").Rows.Count > 0)
            {
                ...
                // Session["InvoiceRegisterExcel"] = dtInvoice;
                // dvPager.InitPager(gvInvoiceRegister, pagesize);
    ...
    public void BindPrintDialog()
    {
        ...
        string pageURL = "InvoiceRegister/InvoiceRegisterExport.aspx?UserName=" + Session["UserName"].ToString();
        ...
        PrintCtl.FormName = "InvoiceRegister";
        pnlPrint.Update();
    }
