...
<head runat="server">
    ...
    {
   	    window.open("http://pfcwebapp1/SOE/frame.aspx?UserID="+'<%= Session["UserID"].ToString().Trim() %>'+"&UserName="+'<%= Session["UserName"].ToString().Trim() %>' ,'Order','height=710,width=1020,Addressbar=0,scrollbars=no,location=no,status=no,top='+((screen.height/2) - (760/2))+',left='+((screen.width/2) - (1020/2))+',resizable=YES',"");	
    }
    </script>
</head>
<body>
                  ...
                  <tr>
                    <td class="TabHeadBk" width="100%" style="height: 30px"><table width="100%"  border="0" cellspacing="0" cellpadding="3">
                        <tr>
                          ...
                          <td ><strong class="redtitle2">Sales Order Entry System</strong></td>
                        </tr>
                    </table></td>
                  </tr>
                  ...
                  <tr>
                    <td id="5TD" class="blackTxt" style="height: 92px" width="100%">
                             <p class="10pxPadding">
                                                ...
                                                <a style="cursor: hand; color: Black;" onclick="LoadPage('SOE');" id="A2" alt="Sales Order Entry System"
                                                    onmouseover="ToolTip(this,window.event);" onmouseout="ToolTip(this,window.event);">
                                                    &nbsp;Sales Order Entry System</a></p>
                             <p class="10pxPadding">
                                 &nbsp;</p>
                              <p class="10pxPadding">
                                  &nbsp;</p>
