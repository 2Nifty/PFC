<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" CodeFile="RTSRecommendations.aspx.cs"
    Inherits="ReadyToShip_RTSRecommendations" %>
...
<body scroll=no onclick="javascript:document.getElementById('lblMessage').innerText='';" onmouseout="javascript:if(document.getElementById('Tooltip')!=null)document.getElementById('Tooltip').style.display = 'none';">
                                    ...
                                    <td valign="top" rowspan="3">
                                        <table border="0" cellpadding="2" cellspacing="0" style="width: 100%">
                                                                    ...
                                                                    <td>
                                                                        <table border="0" cellspacing="0" cellpadding="1">
                                                                            <tr>
                                                                                ...
                                                                                <td align="right">
                                                                                    <a onclick="javascript:CPRReport();" style="cursor:hand" class="redhead" title="CLICK HERE TO RUN A CPR REPORT FOR THIS ITEM" >CPR Report</a>
                                                                                    Factor:
                                            ...
                                            <div class="blueBorder">                                 
                                                <div id="div1"  class="Sbar" align=center style="overflow-x: hidden;
                                                            overflow-y: auto; position: relative; top: 0px; left: 0px;width: 470px; height: 512px; border: 0px solid;">
                                                <asp:DataGrid CssClass="grid BlueBorder" BackColor="white"  Width="100%" ID="dgItemDtl" GridLines="both" runat="server"
                                                    AutoGenerateColumns="false" OnItemCommand="dgItemDtl_ItemCommand"  UseAccessibleHeader="true" 
                                                    OnItemDataBound="dgItemDtl_ItemDataBound"
                                                    ShowFooter="True">
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateColumn HeaderText="Br" SortExpression="LocationCode">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="lnkLocation" Font-Underline=true CommandName="Action" runat="server" Text='<%#DataBinder.Eval(Container,"DataItem.LocationCode")%>'></asp:LinkButton>
                                                        ...
                                                        <asp:BoundColumn DataField="ROPHubCalc" DataFormatString="{0:#,##0.0}" SortExpression="ROPHubCalc" HeaderText="ROP">
                                                            <HeaderStyle Width="40px" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        </asp:BoundColumn>
                                                        <asp:BoundColumn DataField="ROPDays" DataFormatString="{0:#,##0}" SortExpression="ROPDays" HeaderText="Days">
                                                            <HeaderStyle Width="40px" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        </asp:BoundColumn>
                                                        <asp:BoundColumn DataField="AvailQty" DataFormatString="{0:#,##0}" SortExpression="AvailQty" HeaderText="Avl">
                                                            <ItemStyle HorizontalAlign="Right" />
                                                            <HeaderStyle Width="40px" />
                                                        </asp:BoundColumn>
                                                        ...
                                                        <asp:BoundColumn DataField="InTransit" DataFormatString="{0:#,##0}" SortExpression="InTransit" HeaderText="Trf OW">
                                                            <HeaderStyle Width="55px" />
                                                            <ItemStyle HorizontalAlign="Right" />
                                                        </asp:BoundColumn>
                                                        <asp:BoundColumn HeaderText="Req'd" DataField="Required" DataFormatString="{0:#,##0}" SortExpression="Required">
                                                            <ItemStyle HorizontalAlign="Right" Width="55px" />
                                                            <FooterStyle HorizontalAlign="Right" />
                                                        </asp:BoundColumn>
                                                        <asp:BoundColumn HeaderText="S E" DataField="SupEqQty" DataFormatString="{0:#,##0.0}" SortExpression="SupEqQty">
                                                            <ItemStyle HorizontalAlign="Right" Width="55px" />
                                                            <FooterStyle HorizontalAlign="Right" />
                                                        </asp:BoundColumn>
...
--%>                                                        <asp:TemplateColumn HeaderText="Comm." SortExpression="CommitQty">
                                                            ...
                                                            <ItemStyle HorizontalAlign="Center" />
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="lnkCommit" Font-Underline=true CommandName="Commit" runat="server" Text='<%#DataBinder.Eval(Container,"DataItem.CommitQty")%>'></asp:LinkButton>
                                                            </ItemTemplate>
                                                            <FooterStyle VerticalAlign="Top" />
                                                        </asp:TemplateColumn>
                                                    </Columns>
                                                ...
                                                <asp:HiddenField ID="hidBranch" runat="server" /><input type=hidden ID="hidSortBranch" runat=server />
                                            </div>  
                                            </div>                                            
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                                ...
                                                <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        Lines<br />
                                                            ...
                                                            <ContentTemplate>
                                                                <asp:RadioButton ID="POQtyShowAll" runat="server" GroupName="POLineFilter" Text="All" OnCheckedChanged="SetQtyFilter" AutoPostBack="true"/><br />
                                                                <asp:RadioButton ID="POQtyShowDone" runat="server" GroupName="POLineFilter" Text="Consumed" OnCheckedChanged="SetQtyFilter" AutoPostBack="true" /><br />
                                                                <asp:RadioButton ID="POQtyShowRem" runat="server" GroupName="POLineFilter" Text="Qty Rem." OnCheckedChanged="SetQtyFilter" AutoPostBack="true" /></b>
                                                            </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="splitBorder_r_h">
                                                            <asp:Label ID="lblQtyPer" runat="server"></asp:Label></td>
                                                        <td class="splitBorder_r_h">
                                                            <div align="right">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="splitBorder_r_h">
                                                            <asp:Label ID="lblSuperEqu" runat="server"></asp:Label></td>
                                                        <td class="splitBorder_r_h">
                                                            <div align="right">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            Wgt/100 :</td>
                                                        <td class="splitBorder_r_h">
                                                            <asp:Label ID="lblWgt" runat="server"></asp:Label></td>
                                                        <td colspan="2">
                                                            Low Profile Pallet Qty :</td>
                                                        <td class="splitBorder_r_h">
                                                            <asp:Label ID="lblLowProfileQty" runat="server"></asp:Label></td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            HarmCode :</td>
                                                        <td class="splitBorder_r_h">
                                                            <asp:Label ID="lblHarmCode" runat="server"></asp:Label></td>
                                                        <td colspan="2">
                                                            Corp Fixed Velocity :</td>
                                                        <td  class="splitBorder_r_h">
                                                            <asp:Label ID="lblVelocity" runat="server"></asp:Label></td>
                                                ...
                                                <tr>
                                                    <td>   
                                                        <div class="blueBorder shadeBgDown">  
                                                            ...
                                                            <tr>
                                                                <td >
                                                                    <strong>Total PO lines</strong></td>
                                                                <td style="width:40px">
                                                                    :
                                                                    <asp:Label ID="lblTotlaPo" runat="server" Text=""></asp:Label></td>
                                                                <td >
                                                                    <strong>Qty Pallet Partner</strong></td>
                                                                <td style="width:40px">
                                                                    :
                                                                    <asp:Label ID="lblPallet" runat="server" Text="0"></asp:Label></td>
                                                                <td >
                                                                ...
                                                                <td >
                                                                    <strong>Qty [Non Pallet Partner]</strong></td>
                                                                <td style="width:40px">
                                                                    :
                                                                    <asp:Label ID="lblNonPallet" runat="server" Text="0"></asp:Label></td>
                                                            </tr>
                                                    ...
                                                    <tr>
                                                    <td class="blueBorder">
                                                    <div id="div-datagrid" class="Sbar" align=center style="overflow-x: hidden;
                                                    overflow-y:visible; position: relative; top: 0px; left: 0px;height: 257px;width:100%; border: 0px solid;">
                                                    <asp:Panel ID="VendorPanel" runat="server" Width="100%"  Height="100%" ScrollBars="Vertical">
                                                    <asp:DataGrid  CssClass="grid" Width="96%" runat="server" ID="dgVendor"
                                                        GridLines="both" AutoGenerateColumns="false" UseAccessibleHeader="true" OnItemDataBound="dgVendor_ItemDataBound" 
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateColumn HeaderText="Vendor" SortExpression="Vendor">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton ID="lnkVendor" Font-Underline=true CommandName="Action" runat="server" Text='<%#DataBinder.Eval(Container,"DataItem.Vendor")%>'></asp:LinkButton>
                                                            ...
                                                            <asp:BoundColumn DataField="Lbs" DataFormatString="{0:#,##0.00}" HeaderText="Lbs" SortExpression="Lbs">
                                                                <ItemStyle HorizontalAlign="Right" Width="50px" />
                                                            </asp:BoundColumn>
                            ...
                            <asp:UpdatePanel ID="pnlAction" RenderMode="Block" runat="server" UpdateMode="conditional">
                                <ContentTemplate>
                                    <div class="blueBorder">
                                    <table width=100% cellpadding=0 cellspacing=0 border=0  class="blueBorder lightBlueBg" style="border-left:none;border-right:none;border-top:none">
                                        <tr>
                                            <td><span style="color:#CC0000;font-size:18px;margin:0px;padding:0px;font-weight:normal;line-height:35px;margin-left:10px;">
                                                Ready To Ship Actions</span></td><td align=right ><asp:ImageButton runat=server ID=ibtnClose OnClientClick="javascript:return GetStatus();" ImageUrl="~/ReadyToShip/Common/Images/close.jpg"  OnClick="ibtnClose_Click" />
                                            </td>
                                         <tr>                                         
                                    </table>                                    
                                    <div id="div2" class="Sbar" align=left style="overflow-x: hidden;                                        
                                        overflow-y: auto; position: relative; top: 0px; left: 0px; height: 70px;width:100%;  border: 0px solid;">
                                        <asp:Panel ID="pnlActions" runat="server">
                                        <asp:DataGrid CssClass="grid" Width="98%" ID="dgAction" GridLines="both" runat="server"
                                            AutoGenerateColumns="false"  UseAccessibleHeader="true"  OnItemDataBound="dgAction_ItemDataBound" OnItemCommand="dgAction_ItemCommand" AllowSorting="True"
                                            ShowFooter="False">
                                                ...
                                                <asp:TemplateColumn HeaderText="Action Qty">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtActQty" onfocus="javascript:this.select();" onkeypress="javascript:ActionEnter(this);"
                                                            onblur="javascript:CallClick(this);"
                                                            runat="server" CssClass="FormControls" Width="60px" Text='<%#DataBinder.Eval(Container,"DataItem.Action Qty") %>'></asp:TextBox>
                                      ...
                                      <div align="center"><asp:Label ID=lblFlag  runat=server Text="No Records Found" Font-Bold=true ForeColor=red></asp:Label></div>  
                                    </div>
                                    </div>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                                                    ...
                                                    <tr>
                                                        <td width="10%" height="8px">
                                                            <table id="Table3" cellspacing="0" cellpadding="2" width="40%" border="0">
                                                                <tr>
                                                                    <td>
                                                                        <asp:ImageButton ID="ibtnFirst" runat="server" ImageUrl="../Common/Images/PageFirst.jpg" OnClick="ibtnFirst_Click" /></td>
                                                                    <td>
...
alone" CssClass="Required" ForeColor=" " ControlToValidate="txtGotoPage" Operator="DataTypeCheck" Type="Integer"></asp:CompareValidator><div>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="Left2pxPadd">
                                                                        <asp:TextBox ID="txtGotoPage" onkeypress="javascript:if(event.keyCode==13){if(this.value!=''){document.getElementById('btnGo').click();return false;}}else{ValdateNumber();}" runat="server" CssClass="FormControls" Width="25px">0</asp:TextBox></td>
                                                                    <td class="Left2pxPadd">
                    ...
                    <tr>
                        <td>
                           <%-- <uc2:BottomFrame ID="BottomFrame1" runat="server" />--%>
                              <uc2:BottomFooter ID="BottomFrame2"  Title="Review Ready To Ship Recommendations"   runat="server" />
