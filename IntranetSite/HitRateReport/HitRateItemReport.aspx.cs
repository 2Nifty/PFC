...
public partial class HitRateItemReport : System.Web.UI.Page
{
    ...
    {
        Ajax.Utility.RegisterTypeForAjax(typeof(HitRateItemReport));
        ...
        if (!IsPostBack)
        {
            Session["RPTHitRateItemData"] = null;
            hidFileName.Value = "HitRateItemReport" + Session["SessionID"].ToString() + ".xls";
    ...
    {
        if (Session["RPTHitRateItemData"] == null)
        {
            DataSet _dsQuoteData = GetHitRateReportData(RegionCd, NoOfDays, SalesRepCd);
            Session["RPTHitRateItemData"] = _dsQuoteData;
            hidSort.Value = "";
        }

        dsQuoteData = Session["RPTHitRateItemData"] as DataSet;
        if (dsQuoteData != null)
        {
    ...
    private string GenerateExportData(string _dataFormat)
    {
        ...
        DataSet _dsQuoteData = Session["RPTHitRateItemData"] as DataSet;
        ...
        headerContent += "<tr><th colspan='21' style='color:blue' align=left><center>Hit Rate Report - Category/Item Level</center></th></tr>";
        headerContent += "<tr>  <td colspan='2'><b>Category :" + Category + "</b></td>" +
                                "<td colspan='2'><b>Region :" + RegionName + "</b></td>" + 
                                ...
                                "<td colspan='10'></td></tr>";                                
        headerContent += "<tr><th colspan='21' style='color:blue' align=left></th></tr>";
        ...
        if (dtExcelData.Rows.Count > 0)
        {
            ...
            bfExcel.HeaderText = "Desc";
            bfExcel.DataField = "";
            bfExcel.Visible = false;
    ...
    public DataSet GetHitRateReportData(string regionCd, string days, string salesRep)
    {
        ...
        try
        {
            DataSet dsHitRateData = SqlHelper.ExecuteDataset(connectionString , "[pDashboardHitRateRpt]",
                                                        ...
                                                        new SqlParameter("@reportType", "ItemReport"),
