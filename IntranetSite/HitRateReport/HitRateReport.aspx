<%@ Page Language="C#" AutoEventWireup="true" Trace="false" CodeFile="HitRateReport.aspx.cs"
    EnableEventValidation="false" ValidateRequest="false" Inherits="HitRateReport" %>
...
<head id="Head1" runat="server">
    <title>Hit Rate Report - Category/Region Level</title>
    ...
    {
        HitRateReport.DeleteExcel('HitRateReport'+session).value
        parent.window.close();           
    }
    
    function ViewCategoryDetailReport(category, regionCd)
    {   
        var Url =   "HitRateItemReport.aspx?RegionCd=" + regionCd + 
                    "&NoOfDays=" + '<%= Request.QueryString["NoOfDays"].ToString()  %>' +
                    "&SalesPersonCd=" +  '<%= Request.QueryString["SalesPersonCd"].ToString()  %>' +
                    "&SalesPersonName=" + '<%= Request.QueryString["SalesPersonName"].ToString()  %>' +
                    "&Category=" + category;
    
        var hwnd=window.open(Url,"HitRateItemReport" ,'height=700,width=1020,scrollbars=no,status=no,top='+((screen.height/2) - (760/2))+',left='+((screen.width/2) - (1020/2))+',resizable=no',"");
        hwnd.focus();            
        ...
        <table cellpadding="0" cellspacing="0" width="100%" id="mainTable">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                    <tr>
                                        <td class="Left5pxPadd BannerText" width="70%">
                                            Hit Rate Report - Category/Region Level</td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding-left: 10px; width: 220px;" valign="bottom">
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td colspan="3" style="height: 14px">
                                                                <asp:Label ID="Label3" runat="server" Text="Sales Rep:" Width="60px" Height="20px"></asp:Label><asp:Label
                                ...
                                <asp:GridView UseAccessibleHeader="true" PagerSettings-Visible="false" 
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Category" SortExpression="Category">
                                            <ItemTemplate>
                                                <a href="#" onclick="javascript:ViewCategoryDetailReport('<%#  DataBinder.Eval(Container.DataItem,"Category")%>','<%#  DataBinder.Eval(Container.DataItem,"LocSalesGrp")%>');" style="cursor:hand;text-decoration:underline;color:blue;" title="Click here to view hit rate category/item level report.">
                                        ...
                                        <asp:TemplateField HeaderText="Region" SortExpression="Region">
                                            <ItemTemplate>
                                                <asp:Label ID="lblRegion" runat=server Text='<%#DataBinder.Eval(Container,"DataItem.LocSalesGrp")%>' Width=60px></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
            ...
            <tr>
                <td colspan="2" valign="top">                    
                        <uc2:BottomFooter ID="ucFooter" Title="Hit Rate Report" runat="server" />
