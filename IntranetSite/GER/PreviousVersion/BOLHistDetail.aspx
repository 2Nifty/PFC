                    ...
                    <td align="right" class="PageBg" valign="bottom">
                        ...
                        <td style="padding-left: 5px">
                            ...
                            <asp:ImageButton ID="CloseButton" runat="server" ImageUrl="common/Images/close.jpg" 
                                PostBackUrl="javascript:window.close();" />
                        </td>
                        </tr>
                        </table>
                    </td>
            ...
            <tr><td><br />
                ...
                <asp:DataGrid ID="BOLDetail" runat="server" AllowSorting="true" AutoGenerateColumns="false" OnSortCommand="Sort_Grid" Width=1200 >
                    ...
                    <Columns>
                        ...
                        <asp:TemplateColumn HeaderText="Qty" SortExpression="RcptQty" HeaderStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                                <asp:Label ID="RcptQtyLabel" runat="server" CssClass="cntnopadding" Text='<%# Eval("RcptQty", "{0,-10:#,###,##0}")%>' ToolTip="Quantity Received"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="Cost" SortExpression="UOPOPerAlt" HeaderStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                                <asp:Label ID="UOPOPerAltLabel" runat="server" CssClass="cntnopadding" Text='<%# Eval("UOPOPerAlt", "{0,-10:$##,##0.00}")%>' ToolTip="Cost"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="Duty" SortExpression="UODutyAmt" HeaderStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                                <asp:Label ID="UODutyAmtLabel" runat="server" CssClass="cntnopadding" Text='<%# Eval("UODutyAmt", "{0,-10:$##,##0.00}")%>' ToolTip="Duty"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Right"  />
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="Oc. Fr." SortExpression="UOOceanFrghtAmt" HeaderStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                                <asp:Label ID="UOOceanFrghtAmtLabel" runat="server" CssClass="cntnopadding" Text='<%# Eval("UOOceanFrghtAmt", "{0,-10:$##,##0.00}")%>' ToolTip="Ocean Freight"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Right"  />
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="Broker" SortExpression="UOBrokerageAmt" HeaderStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                                <asp:Label ID="UOBrokerageAmtLabel" runat="server" CssClass="cntnopadding" Text='<%# Eval("UOBrokerageAmt", "{0,-10:$##,##0.00}")%>' ToolTip="Brokerage"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Right"  />
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="Dray." SortExpression="UODrayAmt" HeaderStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                                <asp:Label ID="UODrayAmtLabel" runat="server" CssClass="cntnopadding" Text='<%# Eval("UODrayAmt", "{0,-10:$##,##0.00}")%>' ToolTip="Drayage"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="Mrch. Pr." SortExpression="UOMerchProcFee" HeaderStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                                <asp:Label ID="UOMerchProcFeeLabel" runat="server" CssClass="cntnopadding" Text='<%# Eval("UOMerchProcFee", "{0,-10:$##,##0.00}")%>' ToolTip="Merchandise Processing Fee"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="Harbor" SortExpression="UOHarborMaintFee" HeaderStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                                <asp:Label ID="UOHarborMaintFeeLabel" runat="server" CssClass="cntnopadding" Text='<%# Eval("UOHarborMaintFee", "{0,-10:$##,##0.00}")%>' ToolTip="Harbor Maintenance Fee"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Right" />
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="Msc. Fee" SortExpression="UOMiscFeeAmt" HeaderStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                                <asp:Label ID="UOMiscFeeAmtLabel" runat="server" CssClass="cntnopadding" Text='<%# Eval("UOMiscFeeAmt", "{0,-10:$##,##0.00}")%>' ToolTip="Miscellaneous Fee"></asp:Label>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Right" Width="50px" />
                        </asp:TemplateColumn>
                        <asp:TemplateColumn HeaderText="Trk. Frt." SortExpression="UOTrkFrghtAmt" HeaderStyle-HorizontalAlign="Right">
                            <ItemTemplate>
                                <asp:Label ID="UOTrkFrghtAmtLabel" runat="server" CssClass="cntnopadding" Text='<%# Eval("UOTrkFrghtAmt", "{0,-10:$##,##0.00}")%>' ToolTip="Truck Freight"></asp:Label>
                            </ItemTemplate>
