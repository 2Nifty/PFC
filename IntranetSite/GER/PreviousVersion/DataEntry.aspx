...
{   
    var divHeight =  document.documentElement.clientHeight - ( document.getElementById('tdHeaderSection1').clientHeight + document.getElementById('tdHeaderSection2').clientHeight + document.getElementById('tdFooter').clientHeight+document.getElementById('tdBottom').clientHeight+12);
                        ...
                        <asp:UpdatePanel UpdateMode="Conditional" ID="plBillLoad" runat="server" RenderMode="inline">
                            <contenttemplate>
                             <div class="Sbar" id="div-datagrid" style="overflow-x:auto; overflow-y:auto; position:relative; top:0px;
                                    left: 0px; width: 100%; height: 400px; border: 0px solid;" >
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td class="splitBorder TabHead" align="center">
                                                                <asp:Label ID="Label2" runat="server" Width="52px">Invoice #</asp:Label></td>
                                                            <td class="splitBorder TabHead" align="center">
                                                            ...
                                                            <td class="splitBorder TabHead" align="center" style="width: 15%;">
                                                                <asp:Label ID="Label10" runat="server" Width="27px">UOM</asp:Label></td>
                                                            <td class="splitBorder TabHead" align="center">
                                                        ...
                                                        <tr>
                                                            <td style="width: 60px" class="splitBorder TabHead">
                                                                <asp:TextBox CssClass="cntnopadding" Width="60px" ID="txtInvNo" runat="server" MaxLength="20" onblur="return ValidateHeader(event,'btnInvNo');"/>
