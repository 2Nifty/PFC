    ...
    <form id="form1" runat="server">
        <table width=100%>
            ...
            <tr>
                ...
                <tr>
                <td>
                <asp:Panel ID="DataPanel" runat="server" height="100" Width="100%" ScrollBars="Vertical">
                    <table>
                        <tr>
                            <td valign=top>
                    <asp:DetailsView ID="BOLDetails" runat="server" Font-Size="Larger" AutoGenerateRows="false">
                        ...
                        <asp:GridView ID="GERInvoiceGridView" runat="server" AutoGenerateColumns="false" Font-Size="Larger" 
                         >
                        <Columns>
                            <asp:BoundField DataField="VendInvNo" HeaderStyle-HorizontalAlign="center" HeaderText=" Invoice #"
                                ItemStyle-HorizontalAlign="Right"  ItemStyle-Width="120"/>
                            <asp:BoundField DataField="ContainerNo" HeaderStyle-HorizontalAlign="center" HeaderText=" Container #"
                                ItemStyle-HorizontalAlign="Right"  ItemStyle-Width="120"/>
                            <asp:BoundField DataField="UOMatlAmt" HeaderText="Mat'l Amt $" HeaderStyle-HorizontalAlign="center" 
                                DataFormatString="${0:#,##0.00} " ItemStyle-HorizontalAlign="Right" ItemStyle-Width="100"/>
                        </Columns>
                        </asp:GridView>
                            </td>
                            </tr><tr>
                     ...
                     <asp:DetailsView ID="BOLAmounts" runat="server" Font-Size="Larger" CellPadding="1" AutoGenerateRows="false">
                         <Fields>
                            ...
                            <asp:TemplateField HeaderText="Ocean Freight" ItemStyle-HorizontalAlign="Right">
                            <ItemTemplate> 
                            ...
                            <asp:TemplateField HeaderText="Broker Sub Total" ItemStyle-HorizontalAlign="Right">
                            <ItemTemplate> 
                              <asp:Label ID="BrokerSubTotLabel" Runat="Server" Text='<%# Eval("BrokerSubTot", "{0,-10:$##,##0.00}") %>' />
                            </ItemTemplate>
                            </asp:TemplateField>                        
                            <asp:TemplateField HeaderText="Grand Total" ItemStyle-HorizontalAlign="Right">
                            <ItemTemplate> 
                              <asp:Label ID="GrandTotalLabel" Runat="Server" Text='<%# Eval("GrandTotal", "{0,-10:$##,##0.00}") %>' />
                            </ItemTemplate>
                            </asp:TemplateField>                        
                         </Fields>
                   </asp:DetailsView>
