<%@ Page Language="C#" AutoEventWireup="true" Trace="false" CodeFile="CSRQuoteMetricsReport.aspx.cs"
    EnableEventValidation="false" ValidateRequest="false" Inherits="CSRQuoteMetricsReport" %>
...
<head id="Head1" runat="server">
    ...
    {
        CSRQuoteMetricsReport.DeleteExcel('QuoteMetricsReport'+session).value
        parent.window.close();           
    }
    </script>
