...
public partial class CSRQuoteMetricsReport : System.Web.UI.Page
{
    ...
    {
        Ajax.Utility.RegisterTypeForAjax(typeof(CSRQuoteMetricsReport));
    ...
    private void BindDataGrid()
    {
        if (Session["RPTQuoteData"] == null || hidSort.Value != "")
        {
            ...
            DataSet _dsQuoteData = quoteMetrics.GetCSRQuoteMetricsData(StartDate, EndDate, BranchID, Request.QueryString["SalesPerson"].ToString(), hidSort.Value);
