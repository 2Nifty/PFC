<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InvBrActivityIssue.aspx.cs"
...
<link href="../ITotal/Common/StyleSheet/DHTMLPopUpMenu.css" rel="stylesheet" type="text/css" />
    ...
    {
        var hwin=window.open('InvBrActivityIssuePreview.aspx?'+url, 'InvBrActivityIssuePreview', 'height=700,width=900,scrollbars=no,status=no,top='+((screen.height/2) - (1010/2))+',left='+((screen.width/2) - (1010/2))+',resizable=NO',"");
        hwin.focus();
    }
                             ...
                             <div class="Sbar" id="div-datagrid" style="overflow-x: hidden; overflow-y: hidden; position: relative;
                                ...
                                <asp:GridView PagerSettings-Visible="false" PageSize="17" Width="100%" ID="dvBIOnhand"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="Avg PerLb" HtmlEncode="false" DataField="AcIssperLb" SortExpression="AcIssperLb"
                                        ...
                                        <asp:BoundField HtmlEncode="false" HeaderText="ERP PerLb" DataField="ERPIssperLb" SortExpression="ERPIssperLb" DataFormatString="{0:#,##0.000}">
                                            <ItemStyle HorizontalAlign="Right" Width="60px" />
                                            <FooterStyle HorizontalAlign="Right" Width="60px" CssClass="Right10pxPadd" />                                            
                                        </asp:BoundField>
                                        <asp:BoundField  />
