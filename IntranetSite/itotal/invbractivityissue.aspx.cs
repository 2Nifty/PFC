    ...
    public partial class InvBrActivityIssues : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                lblBranch.Text = branchDesc + "&nbsp;:&nbsp;Issues";
                BindDataGrid();               
            }

            hidFileName.Value = "InvBrActivityIssues_" + Session["SessionID"].ToString() + ".xls";
        ...
        protected void dvBIOnhand_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.Header)
            {
                ...
                e.Row.Cells[5].Text = "<table border='0' cellpadding='0' cellspacing='0'  width='100%'><tr><td class='GridHead splitBorder' style='border-bottom:solid 1px #c9c6c6;border-right:solid 0px #c9c6c6;' colspan=3 nowrap ><center>ERP</center></td></tr><tr><td width='70' class='GridHead splitBorders' nowrap  style='cursor:hand;border-right:solid 1px #c9c6c6;'><center>" +
                                        ...
                                        "<Div style='cursor:hand;' onclick=\"javascript:BindValue('ERPValue');\">Value</div></center></td><td width='61' class='GridHead splitBorders' nowrap align='center' nowrap  style='cursor:hand;border-right:solid 0px #c9c6c6;'>" +
                                        "<Div onclick=\"javascript:BindValue('ERPIssperLb');\">Per Lb</div></td></tr></table>";
        ...
        protected void ibtnExcelExport_Click(object sender, ImageClickEventArgs e)
        {
            ...
            headerContent += "<tr><th colspan='2' align='left'>" + branchDesc + "&nbsp;:&nbsp;Issues</th><th colspan=0 align='left'>Period :" + hidPeriod.Value + "</th><th colspan='1'></th><th colspan='2'>Run By : " + Session["UserName"].ToString() + "</th><th colspan='2' align='left'>Run Date :" + DateTime.Now.ToShortDateString() + "</th></tr><tr colspan='10'></tr>";
            ...
            if (dtTotal.Rows.Count > 0)
            {
                ...
                foreach (DataRow roiReader in dtTotal.Rows)
                {
                    excelContent += "<tr><td align='left'>" + roiReader["TypeofTransaction"].ToString() + "</td><td>" +
                            ...
                            String.Format("{0:#,##0.000}", roiReader["AcIssperLb"]) + "</td><td nowrap=nowrap>" +
                            String.Format("{0:#,##0.00}", roiReader["ERPWeight"]) + "</td><td nowrap=nowrap>" +
                            String.Format("{0:#,##0.00}", roiReader["ERPValue"]) + "</td><td>" +
                            String.Format("{0:#,##0.000}", roiReader["ERPIssperLb"]) + "</td></tr>";
