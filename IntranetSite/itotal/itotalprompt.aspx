...
<head runat="server">
    ...
    function LoadPage(report)
    {
        switch (report){
		case "CSA": 		
			 window.open("ProgressBar.aspx?destPage=BranchInventoryOnHand.aspx" ,'Orders','height=710,width=1020,Addressbar=0,scrollbars=no,location=no,status=no,top='+((screen.height/2) - (760/2))+',left='+((screen.width/2) - (1020/2))+',resizable=no','');				
		break;				
		case "Trend": 
		    var pageURL = "ITotalTrend.aspx";
            window.open(pageURL,"Trends" ,'height=710,width=1010,scrollbars=no,status=no,top='+((screen.height/2) - (760/2))+',left='+((screen.width/2) - (1020/2))+',resizable=YES',"");
		break;
            ...
            <tr>
                <td valign="middle" class="PageHead">
                    <span class="Left5pxPadd">
                        <asp:Label ID="lblParentMenuName" CssClass="BannerText" runat="server" Text="Inventory On Hand"></asp:Label></span>
                </td>
            </tr>
            <tr>
                                ...
                                <table width="100%"  border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td id="5TD" class="blackTxt" style="padding-bottom:20px" valign=middle >
                                            <br />
                                            <p class="10pxPadding">
                                                <img src="../Common/Images/Bullet.gif" width="10" height="9" onclick="LoadPage('CSA');">&nbsp;&nbsp;
                                                <a onclick="LoadPage('CSA');"
                                                    href="#" id="x"
                                                    alt="View PFC I-Total Report" onmouseover="ToolTip(this,window.event);"
                                                    onmouseout="ToolTip(this,window.event);">PFC I - Total Report<br /></a>
                                            </p>
                                            <p class="10pxPadding">
                                                <img src="../Common/Images/Bullet.gif" width="10" height="9" onclick="LoadPage('Trend');">&nbsp;&nbsp;
                                                <a onclick="LoadPage('Trend');"
                                                    href="#" id="A1"
                                                    alt="View PFC I-Total Trend Report" onmouseover="ToolTip(this,window.event);"
                                                    onmouseout="ToolTip(this,window.event);">PFC I - Total Trend Report<br /></a>
                                            </p>
                                        </td>
                                    </tr>
                                </table>
