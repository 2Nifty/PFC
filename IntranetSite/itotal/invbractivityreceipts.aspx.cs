...
{
    public partial class InvBrActivityReceipts : System.Web.UI.Page
    {
       ...
       string  sort = "";
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Ajax.Utility.RegisterTypeForAjax(typeof(InvBrActivityReceipts));
            ...
            if (!IsPostBack)
            {
                ...
                lblBranch.Text = branchDesc + "&nbsp;:&nbsp;Receipts";
                BindDataGrid();               
            }

            hidFileName.Value = "InvBrActivityReceipts_" + Session["SessionID"].ToString() + ".xls";
        ...
        protected void dvBIOnhand_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.Header)
            {
                ...
                e.Row.Cells[4].Text = "<table border='0' cellpadding='0' cellspacing='0'  width='100%'><tr><td class='GridHead splitBorder' style='border-bottom:solid 1px #c9c6c6;border-right:solid 0px #c9c6c6;' colspan=3 nowrap ><center>Average Cost System</center></td></tr><tr><td width='81' class='GridHead splitBorders' nowrap style='cursor:hand;border-right:solid 1px #c9c6c6;'><center>" +
                                        "<Div style='cursor:hand;' onclick=\"javascript:BindValue('ACWeight');\"><center>Weight</center></div></center></td><td width='73' class='GridHead splitBorders' nowrap align='center' style='cursor:hand;border-right:solid 1px #c9c6c6;'>" +
                                        "<Div style='cursor:hand;' onclick=\"javascript:BindValue('ACValue');\">Value</div></td><td width='33%' class='GridHead splitBorders' nowrap align='center' nowrap  style='cursor:hand;border-right:solid 0px #c9c6c6;'>" +
                                        "<Div onclick=\"javascript:BindValue('AcRecperLb');\">Per Lb</div></td></tr></table>";
                e.Row.Cells[5].Visible = false;
                e.Row.Cells[6].Visible = false;

                e.Row.Cells[7].ColumnSpan = 3;
                e.Row.Cells[7].Text = "<table border='0' cellpadding='0' cellspacing='0'  width='100%'><tr><td class='GridHead splitBorder' style='border-bottom:solid 1px #c9c6c6;border-right:solid 0px #c9c6c6;' colspan=3 nowrap ><center>ERP</center></td></tr><tr><td width='85' class='GridHead splitBorders' nowrap  style='cursor:hand;border-right:solid 1px #c9c6c6;'><center>" +
                                        "<Div style='cursor:hand;' onclick=\"javascript:BindValue('ERPWeight');\"><center>Weight</center></div></center></td><td width='73' class='GridHead splitBorders' nowrap align='center' nowrap style='cursor:hand;border-right:solid 1px #c9c6c6;'>" +
                                        "<Div style='cursor:hand;' onclick=\"javascript:BindValue('ERPValue');\">Value</div></center></td><td width='33%' class='GridHead splitBorders' nowrap align='center' nowrap  style='cursor:hand;border-right:solid 0px #c9c6c6;'>" +
        ...
        protected void ibtnExcelExport_Click(object sender, ImageClickEventArgs e)
        {
            ...
            headerContent += "<tr><th colspan='10' style='color:blue'>Inventory Branch Activity</th></tr>";
            headerContent += "<tr><th colspan='2' align='left'>" + branchDesc + "&nbsp;:&nbsp;Receipts</th><th colspan=2 align='left'>Period :" + hidPeriod.Value + "</th><th colspan='2'></th><th colspan='2'>Run By : " + Session["UserName"].ToString() + "</th><th colspan='2' align='left'>Run Date :" + DateTime.Now.ToShortDateString() + "</th></tr><tr colspan='10'></tr>";


            if (dtTotal.Rows.Count > 0)
            {
                headerContent += "<tr><th style='width:150px;'>TransType</th>" +
                                    "<th  style='width:200px'>DocNo</th><th>Master Doc No</th><th style='width:80px;'>Bill Of Lading No</th>" +
                ...
                foreach (DataRow roiReader in dtTotal.Rows)
                {
                    excelContent += "<tr><td align='left'>" + roiReader["TypeofTransaction"].ToString() + "</td><td>" +
                            ...
                            String.Format("{0:#,##0}", roiReader["MasterDocumentNo"]) + "</td><td nowrap=nowrap>" +
                            String.Format("{0:#,##0}", roiReader["BillofLadingNo"]) + "</td><td>" +
                            String.Format("{0:#,##0.00}", roiReader["ACWeight"]) + "</td><td nowrap=nowrap>" +
                            String.Format("{0:#,##0.00}", roiReader["ACValue"]) + "</td><td nowrap=nowrap>" +
                            String.Format("{0:#,##0.000}", roiReader["AcRecperLb"]) + "</td><td nowrap=nowrap>" +
                            String.Format("{0:#,##0.00}", roiReader["ERPWeight"]) + "</td><td nowrap=nowrap>" +
                            String.Format("{0:#,##0.00}", roiReader["ERPValue"]) + "</td><td>" +
                            String.Format("{0:#,##0.000}", roiReader["ERPRecperLb"]) + "</td></tr>";
                ...
                footerContent = "<tr style='font-weight:bold'><td>Grand Total</td><td align='left'>" +
                                dtTotal.Rows.Count.ToString() + "</td><td></td><td></td><td nowrap=nowrap>" +
