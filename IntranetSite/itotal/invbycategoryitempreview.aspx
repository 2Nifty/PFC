<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InvByCategoryItemPreview.aspx.cs"
    Inherits="PFC.Intranet.ITotalReports.InvByCategoryItemPreview" %>
...
<head id="Head1" runat="server">
    <title>Inventory By Category/Item - Preview</title>
                                                ...
                                                <tr>
                                                    <td style="height: 30px" width="75%">
                                                        <div class="Left5pxPadd">
                                                            <span class="BannerText">Inventory By Category/Item</span>
                                                        </div>
                                                    </td>
                                                    <td align="right">
                                    ...
                                    <table width="100%" border=0px cellpadding=0px cellspacing=0px>
                                        <tr>
                                            ...
                                            <td style="width: 300px">
                                                <span class="TabHead">
                                                    <%=Request.QueryString["CatDesc"].ToString()%>
                                                </span>
                                            </td>
                                            <td style="width: 60px" valign="middle">
 ...
 function PrintReport()
{
     ...
     prtContent=prtContent+"<table cellspacing=0 cellpadding=0 width='100%'><tr><td style='width:450px;'colspan=3><h3>Inventory By Category/Item</h3></td></tr>";
