<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InvByCategoryItem.aspx.cs"
    Inherits="PFC.Intranet.ITotalReports.InvByCategoryItem" %>
...
<link href="../ITotal/Common/StyleSheet/DHTMLPopUpMenu.css" rel="stylesheet" type="text/css" />
    ...
    {
        var hwin=window.open('InvByCategoryItemPreview.aspx?'+url, 'InvByCategoryItemPreview', 'height=700,width=1010,scrollbars=no,status=no,top='+((screen.height/2) - (1010/2))+',left='+((screen.width/2) - (1010/2))+',resizable=NO',"");
        hwin.focus();
    }
    ...
    {
        var str=InvByCategoryItem.DeleteExcel('InvByCategoryItem_'+session).value.toString();
        parent.window.close();
    }
                    ...
                    <asp:UpdatePanel ID="upnlGrid" UpdateMode="conditional" runat="server">
                        <ContentTemplate>
                            <div class="Sbar" id="div-datagrid" style="overflow-x: hidden; overflow-y: hidden; position: relative;
                                top: 0px; left: 0px; height: 497px; width: 1017px; border: 0px solid;">
