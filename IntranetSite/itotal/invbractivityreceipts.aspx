<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InvBrActivityReceipts.aspx.cs"
    Inherits="PFC.Intranet.ITotalReports.InvBrActivityReceipts" %>
...
<link href="../ITotal/Common/StyleSheet/DHTMLPopUpMenu.css" rel="stylesheet" type="text/css" />
    ...
    {
        var hwin=window.open('InvBrActivityReceiptsPreview.aspx?'+url, 'BrItemPreview', 'height=700,width=1010,scrollbars=no,status=no,top='+((screen.height/2) - (1010/2))+',left='+((screen.width/2) - (1010/2))+',resizable=NO',"");
        hwin.focus();
    }
    ...
    {
        var str=InvBrActivityReceipts.DeleteExcel('InvBrActivityReceipts_'+session).value.toString();
        parent.window.close();
    }
                                ...
                                <asp:GridView PagerSettings-Visible="false" PageSize="17" Width="100%" ID="dvBIOnhand"
                                    ...
                                    <Columns>
                                        <asp:BoundField HeaderText="TransType" DataField="TypeofTransaction" SortExpression="TypeofTransaction" ItemStyle-CssClass="Left5pxPadd">
                                            <ItemStyle HorizontalAlign="Left" CssClass="Left5pxPadd" Width="70px" />
                                        ...
                                        <asp:BoundField HeaderText="Master Doc No" HtmlEncode="false" DataField="MasterDocumentNo" SortExpression="MasterDocumentNo">
                                            <ItemStyle HorizontalAlign="Left" CssClass="Left5pxPadd" Width="80px" Wrap="False" />
                                        ...
                                        <asp:BoundField HtmlEncode="false" HeaderText="ERP Weight" DataField="ERPWeight" SortExpression="ERPWeight"
                                            DataFormatString="{0:#,##0.00}">
                                            <ItemStyle HorizontalAlign="Right" Width="80px" Wrap="False" CssClass="Right5pxPadd"/>
                                            <FooterStyle HorizontalAlign="Right" CssClass="Right10pxPadd"/>
                                        </asp:BoundField>
