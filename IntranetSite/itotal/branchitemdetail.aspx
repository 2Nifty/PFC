<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BranchItemDetail.aspx.cs"
...
<head runat="server">
    <title>Inventory Branch Item Detail Report</title>
...
<link href="../ITotal/Common/StyleSheet/DHTMLPopUpMenu.css" rel="stylesheet" type="text/css" />
    ...
    {
        var hwin=window.open('BranchItemDetailPreview.aspx?'+url, 'DailySalesReport', 'height=700,width=1010,scrollbars=no,status=no,top='+((screen.height/2) - (1010/2))+',left='+((screen.width/2) - (1010/2))+',resizable=NO',"");
        hwin.focus();
    }
    ...
    {
        var str=BranchItemDetail.DeleteExcel('BranchItemDetail_'+session).value.toString();
        parent.window.close();
    }
        ...
        <table cellpadding="0" cellspacing="0" width="100%" id="mainTable">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                    <tr>
                                        <td class="Left5pxPadd BannerText" width="70%">
                                            Inventory Branch Item Detail </td>
            ...
            <tr id="trHead" class="PageBg">
                <td class="LeftPadding TabHead" style="height: 10px" colspan="2" align="right">
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                        <tr>
                            <td width="200px" align="left" style="width: 220px">
                                        ...
                                        <table cellspacing="0" cellpadding="0" style="padding-right: 15px">
                                            <tr>
                                                ...
                                                <td style="padding-right: 200px">
                                                    <asp:CheckBox ID="chkShowUsage" runat="server" ForeColor="#CC0000" Text="Show Usage" AutoPostBack="True" OnCheckedChanged="chkShowUsage_CheckedChanged" Width="100px" />
                                                </td>
