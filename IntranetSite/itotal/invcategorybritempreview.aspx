<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InvCategoryBrItemPreview.aspx.cs"
...
<head id="Head1" runat="server">
    <title>Inventory By Category/Branch Item - Preview</title>
                                                ...
                                                <tr>
                                                    <td style="height: 30px" width="75%">
                                                        <div class="Left5pxPadd">
                                                            <span class="BannerText">Inventory Branch Item Detail</span>
                                                        </div>
                                                    </td>
                                                    <td align="right">
                            ...
                            <td class="PageBg" style="height: 25px" id="PrintDG1">
                                    <table width="100%" border=0px cellpadding=0px cellspacing=0px>
                                        <tr>
                                            ...
                                            <td style="width: 130px; height: 14px;" align=left>
                                                <span class="TabHead">
                                                    <%=Request.QueryString["BranchDesc"].ToString()%>
                                                </span>
                                            </td>
                                            <td style="width: 60px; height: 14px;" valign=middle>
                                                <span class="TabHead">Category :</span>
                                            </td>
                                            <td style="width: 250px; height: 14px;">
                                                <span class="TabHead">
                                                    <%=Request.QueryString["CategoryDesc"].ToString()%>
                                                </span>
                                            </td>
                                            <td style="width: 60px; height: 14px;" valign="middle">
 ...
 function PrintReport()
{
     ...
     prtContent=prtContent+"<table cellspacing=0 cellpadding=0 width='100%'><tr><td style='width:450px;'colspan=3><h3>Inventory By Category/Branch Item</h3></td></tr>";
