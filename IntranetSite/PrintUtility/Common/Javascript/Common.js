...
function SetDefaultHeight()
{
    ...
    if(tdPODet.style.display!='none')
	    divGrid.style.height = "230px";
	else
	    divGrid.style.height = "410px";
...
{ 
    ...
    if(divGrid!=null)
	{
        ...
        {      	
            ...
            divGrid.style.height=(tdItem.style.display!='none')?height-30:((tblItem.style.display!='none')?height:height-30);	           	
            divItemFamily.style.height=(tdItem.style.display!='none')?height-30:((tblItem.style.display!='none')?height-30:height-60);		
