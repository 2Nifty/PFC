...
<head>
    ...
    {
        var hwinHistory =window.open("PrintUtilityHistory.aspx","History",'height=540,width=850,scrollbars=no,status=no,top='+((screen.height/2) - (540/2))+',left='+((screen.width/2) - (800/2))+',resizable=NO',"");
        hwinHistory.focus();
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" style="padding-left: 10px;" width="100%">
                            <tr>
                                ...
                                <td align="right" style="padding-right: 10px;">
                                    <asp:LinkButton ID="lnkHistory"  OnClientClick="javascript:return OpenHistory();" CssClass="TabHead" Font-Bold="True" Text="View History" 
