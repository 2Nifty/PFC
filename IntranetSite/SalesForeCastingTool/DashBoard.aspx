...
<head runat="server">
    ...
    {       
        ...
        {
		    case "CS": 
			    window.open('CustomerSelectionPrompt.aspx' ,'CS','height=710,width=1020,Addressbar=0,scrollbars=no,location=no,status=no,top='+((screen.height/2) - (760/2))+',left='+((screen.width/2) - (1020/2))+',resizable=no','');	
		    break;		
		    case "BS": 
			    window.open('BranchSummaryPrompt.aspx' ,'BS','height=710,width=1020,Addressbar=0,scrollbars=no,location=no,status=no,top='+((screen.height/2) - (760/2))+',left='+((screen.width/2) - (1020/2))+',resizable=no','');	
		    break;
                                ...
                                <table width="100%"  border="0" cellpadding="0" cellspacing="0">
                                        ...
                                        <td class="TabHeadBk" colspan="2" >
                                            <table border="0" cellpadding="3" cellspacing="0" width="100%">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <strong class="redtitle2">Sales Forecasting</strong></td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <p class="10pxPadding">
                                                ...
                                                <a href="CustomerSelectionPrompt.aspx" id="x"
                                                    alt="Build customer list for sales forecasting" onmouseover="ToolTip(this,window.event);"
                                                    onmouseout="ToolTip(this,window.event);">&nbsp;Customer Selector</a>
                                                <br />
                                        </p>     
                                        <p class="10pxPadding">
                                            <img src="../Common/Images/Bullet.gif" width="10" height="9" >&nbsp;&nbsp;
                                            <a id="A1" alt="View Branch Summary"  href="BranchSummaryPrompt.aspx"
                                                onmouseout="ToolTip(this,window.event);" onmouseover="ToolTip(this,window.event);">&nbsp;Branch Summary</a>
                                            <br />
                                        </p>     
                                        </td>
                                    </tr>
