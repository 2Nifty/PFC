namespace  Novantus.Umbrella.UserControls
{
	...
	public partial class Pager : System.Web.UI.UserControl
	{
		...
		{
            txtGotoPage.Attributes.Add("onkeypress", "return ClickButton(event,'" + btnGo.ClientID + "')");
			if(!IsPostBack)
			{				
				gotoPageNumber = 0;
		...
		public int GotoPageNumber
		{
            ...
            set //Tod added 10/27/2010
            {
                gotoPageNumber = (short)value;
                txtGotoPage.Text = gotoPageNumber.ToString();
		...
		*/
        ...
        protected void btnLast_Click1(object sender, System.Web.UI.ImageClickEventArgs e)
        {
            gotoPageNumber = Convert.ToInt32(ViewState["TotalPages"].ToString()) - 1;
            ViewState["GotoPageNumber"] = gotoPageNumber;
            OnBubbleClick(e);
        ...
        protected void ibtnPrevious_Click(object sender, System.Web.UI.ImageClickEventArgs e)
        {
            try
            {
        ...
        protected void ibtnFirst_Click(object sender, System.Web.UI.ImageClickEventArgs e)
        {
            gotoPageNumber = 0;
            ViewState["GotoPageNumber"] = gotoPageNumber;
            OnBubbleClick(e);
