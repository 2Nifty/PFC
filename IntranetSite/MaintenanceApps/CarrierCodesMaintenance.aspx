...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CarrierCodesMaintenance.aspx.cs"
        ...
        <table cellpadding="0" cellspacing="0" width="100%" id="mainTable">
                    ...
                    <table style="width: 100%" class="blueBorder" cellpadding="0" cellspacing="0" >
                        <tr>
                            <td class="lightBlueBg">
                                <asp:Label ID="lblHeading" runat="server" Text="Enter Carrier Code Information" CssClass="BanText"
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr class="lightBlueBg">
                                    <td class="lightBlueBg" style="padding-top: 1px; height: 7px; width: 4%;">
                                        <span class="BanText" >Carrier Codes</span>
                                    </td>
            ...
            <tr>
                <td style="width: 1253px">
                    <uc2:Footer ID="BottomFrame2" Title="Carrier Codes" runat="server" />
                </td>
            </tr>
        </table>
    </form>
