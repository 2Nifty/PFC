<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StandardComments .aspx.cs"
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 100px">
                                            <asp:ImageButton ID="btnSearch" runat="server" ImageUrl="~/MaintenanceApps/Common/images/BtnSearch.gif"
                                                OnClick="btnSearch_Click" CausesValidation="False" TabIndex="15" /><asp:HiddenField ID="hidPrimaryKey"
                                                    runat="server" />
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <table style="width: 100%" class="blueBorder" cellpadding="0" cellspacing="0">
                            <tr>
                                <td class="lightBlueBg">
                                    <asp:Label ID="lblHeading" runat="server" Text="Enter Standard Comments Information"
                                                ...
                                                <tr>
                                                    <td style="height: 16px">
                                                        ...
                                                        <asp:ImageButton ID="btnSave" ImageUrl="~/MaintenanceApps/Common/images/BtnSave.gif"
                                                            runat="server" OnClientClick="javascript:return StandardMessageRequiredField();"
                                    ...
                                    <asp:UpdatePanel ID="upnlEntry" runat="server" UpdateMode="conditional">
                                        <ContentTemplate>
                                            <table width="175">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 300px;">
                                                        <table border="0" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                <td>
                                                                    <asp:TextBox ID="txtCode" TabIndex="1" CssClass="FormCtrl" runat="server" MaxLength="20"
                                                    ...
                                                    <td style="width: 101px; padding-left: 50px" rowspan="4">
                                                ...
                                                <tr>
                                                    <td class="Left2pxPadd DarkBluTxt boldText" style="padding-left: 10px;">
                                                        <asp:Label ID="Label3" runat="server" Height="16px" Text="Document Type" Width="111px"></asp:Label></td>
                                                    <td style="width: 100px; height: 26px">
                                                        <asp:DropDownList ID="ddlDocType" runat="server" Height="20px" CssClass="FormCtrl"
                                                ...
                                                <tr>
                                                    <td class="Left2pxPadd DarkBluTxt boldText" style="padding-left: 10px;">
                                                        <asp:Label ID="Label4" runat="server" Height="16px" Text="Comment Location" Width="111px"></asp:Label></td>
                                                    <td style="width: 100px">
                                                        <asp:DropDownList ID="ddlCommentLoc" runat="server" Height="20px" CssClass="FormCtrl"
                                                ...
                                                <tr>
                                                    <td class="Left2pxPadd DarkBluTxt boldText" style="padding-left: 10px;" valign="top">
                                                        <asp:Label ID="Label5" runat="server" Height="16px" Text="Comment" Width="111px"></asp:Label></td>
                                                    <td style="width: 100px; height: 26px;">
                                                        <asp:TextBox ID="txtComments" CssClass="FormCtrl" runat="server" TabIndex="4" MaxLength="256"
                                                            Height="80px" TextMode="MultiLine" Width="200px"></asp:TextBox></td>
                                                    <td style="width: 100px; height: 26px">
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="Left2pxPadd DarkBluTxt boldText" style="padding-left: 10px" valign="middle">
                                                        <asp:Label ID="Label1" runat="server" Height="16px" Text="Number of Spaces" Width="111px"></asp:Label></td>
                                                    <td style="width: 100px; height: 26px">
                                                        <table border="0" cellpadding="0" cellspacing="0">
                                                            <tr>
                                                                <td style="width: 100px">
                                                        <asp:TextBox ID="txtSpace" runat="server" CssClass="FormCtrl" MaxLength="20" TabIndex="5"
                                                            Width="60px"></asp:TextBox></td>
                                                                <td style="width: 100px">
                                                                    &nbsp;<asp:RegularExpressionValidator ID="reVendorNo" runat="server" ControlToValidate="txtSpace"
                                                                        ErrorMessage="Numeric Only" ValidationExpression="[0-9]+$" Width="65px"></asp:RegularExpressionValidator></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                    <td style="width: 100px; height: 26px">
                                                    </td>
                                                    <td rowspan="1" style="padding-left: 50px; width: 101px">
                                                    </td>
                                                </tr>
                                            </table>
                                        </ContentTemplate>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr class="lightBlueBg">
                                    <td class="lightBlueBg" style="padding-top: 1px; height: 7px; width: 4%;">
                                        <span class="BanText">Standard Comments</span>
                                    </td>
                                        ...
                                        <div id="div-datagrid" class="Sbar" style="overflow-x: hidden; overflow-y: auto;
                                            ...
                                            <asp:DataGrid CssClass="grid" BackColor="#f4fbfd" Style="height: auto" ID="dgCountryCode"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundColumn DataField="StdCommentsCd" HeaderText="Code" SortExpression="StdCommentsCd">
