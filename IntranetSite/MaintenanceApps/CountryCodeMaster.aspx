<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CountryCodeMaster.aspx.cs"
...
<head id="Head1" runat="server">
    <title>Country Codes Maintenance</title>
...
<body onclick="javascript:document.getElementById('lblMessage').innerText='';" onmouseup="divToolTips.style.display='none';"  onmouseout="javascript:if(document.getElementById('Tooltip')!=null)document.getElementById('Tooltip').style.display = 'none';">
    <form id="form1" runat="server" defaultfocus="txtCountryCode">
                         ...
                         <table>
                                <tr>
                                    ...
                                    <td style="width: 100px">
                                        <asp:TextBox ID="txtCountryCode" CssClass="FormCtrl" runat="server" AutoCompleteType="disabled"
                                    ...
                                    <td style="width: 100px">
                                        <asp:ImageButton ID="btnSearch" runat="server" ImageUrl="~/MaintenanceApps/Common/images/BtnSearch.gif"
                                            OnClick="btnSearch_Click" CausesValidation="False" TabIndex="14" /><asp:HiddenField ID="hidpCountryMstrID"
                                                runat="server" />
                                    </td>
                                </tr>
                            </table>
                    ...
                    <table style="width: 100%" class="blueBorder" cellpadding="0" cellspacing="0" >
                        <tr>
                            <td class="lightBlueBg">
                                <asp:Label ID="lblHeading" runat="server" Text="Enter Country Code Information" CssClass="BanText"
                                            ...
                                            <tr>
                                                <td style="height: 16px">
                                                    ...
                                                    <asp:ImageButton ID="btnSave" ImageUrl="~/MaintenanceApps/Common/images/BtnSave.gif"
                                                        runat="server" OnClientClick="javascript:return CountryRequiredField();" OnClick="btnSave_Click" Visible="false" TabIndex="9" />
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 300px; height: 26px">
                                                    <asp:TextBox ID="txtCode" TabIndex="1" CssClass="FormCtrl" runat="server" MaxLength="10"></asp:TextBox>
                                                </td>
                                                <td style="width: 300px; height: 26px">
                                                    <span style="color:Red;">*</span></td>
                                                <td style="width: 101px; padding-left: 30px" rowspan="9">
                                            ...
                                            <tr>
                                                <td class="Left2pxPadd DarkBluTxt boldText" style="padding-left: 10px">
                                                    <asp:Label ID="Label1" runat="server" Height="16px" Text="3 Char Cd (ISO3166)" Width="111px"></asp:Label></td>
                                                <td style="width: 300px;">
                                                    <asp:TextBox ID="txt3CharCd" runat="server" CssClass="FormCtrl" MaxLength="10" TabIndex="1"></asp:TextBox></td>
                                                <td style="width: 300px;">
                                                    <span style="color: #ff0000">*</span></td>
                                            </tr>
                                            <tr>
                                                <td class="Left2pxPadd DarkBluTxt boldText" style="padding-left: 10px;">
                                                    <asp:Label ID="Label3" runat="server" Height="16px" Text="Name" Width="111px"></asp:Label></td>
                                                <td style="width: 100px;">
                                                    <asp:TextBox ID="txtName"  CssClass="FormCtrl" runat="server" TabIndex="2" MaxLength="30"></asp:TextBox></td>
                                                <td style="width: 100px;">
                                                     <span style="color:Red;">*</span></td>
                                            </tr>
                                            <tr>
                                                <td class="Left2pxPadd DarkBluTxt boldText" style="padding-left: 10px;">
                                                    <asp:Label ID="Label4" runat="server" Height="16px" Text="Date Format" Width="111px"></asp:Label></td>
                                                <td style="width: 100px">
                                                    <asp:TextBox ID="txtDateFormat" CssClass="FormCtrl" runat="server" TabIndex="2" MaxLength="15"></asp:TextBox></td>
                                                <td style="width: 100px">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="Left2pxPadd DarkBluTxt boldText" style="padding-left: 10px;">
                                                    <asp:Label ID="Label5" runat="server" Height="16px" Text="Postal Code Format" Width="111px"></asp:Label></td>
                                                <td style="width: 100px; height: 26px;">
                                                    <asp:TextBox ID="txtPostalCode" CssClass="FormCtrl" runat="server" TabIndex="3" MaxLength="15"></asp:TextBox></td>
                                                <td style="width: 100px; height: 26px">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="Left2pxPadd DarkBluTxt boldText" style="padding-left: 10px;">
                                                    <asp:Label ID="Label6" runat="server" Height="16px" Text="Phone Format" Width="111px"></asp:Label></td>
                                                <td style="width: 100px; height: 16px">
                                                    <asp:TextBox ID="txtPhoneFormat" CssClass="FormCtrl" runat="server" TabIndex="4" MaxLength="15"></asp:TextBox></td>
                                                <td style="width: 100px; height: 16px">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="Left2pxPadd DarkBluTxt boldText" style="padding-left: 10px;">
                                                    <asp:Label ID="Label7" runat="server" Height="16px" Text="Currency Code" Width="111px"></asp:Label></td>
                                                <td style="width: 100px; height: 16px">
                                                    <asp:TextBox ID="txtCurrencyCode" CssClass="FormCtrl" runat="server" MaxLength="5"
                                                        Width="50px" TabIndex="5"></asp:TextBox></td>
                                                <td style="width: 100px; height: 16px">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="Left2pxPadd DarkBluTxt boldText" style="padding-left: 10px;">
                                                    <asp:Label ID="Label8" runat="server" Text="Status Code" Width="111px"></asp:Label></td>
                                                <td style="width: 100px; height: 16px">
                                                    <asp:TextBox ID="txtStatusCode" CssClass="FormCtrl" runat="server" MaxLength="2"
                                                        Width="50px" TabIndex="6"></asp:TextBox></td>
                                                <td style="width: 100px; height: 16px">
                                                </td>
                                            </tr>
                                        </table>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr class="lightBlueBg">
                                    <td class="lightBlueBg" style="padding-top: 1px; height: 7px; width: 4%;">
                                        <span class="BanText" >Country Codes</span>
                                    </td>
                                ...
                                <tr>
                                    <td style="padding-top: 1px; height: 7px;" colspan="2">
                                        <div id="div-datagrid" class="Sbar" style="overflow-x: hidden; overflow-y: auto;
                                            position: relative; top: 0px; left: 0px; height: 270px; width: 1020px; border: 0px solid;"
                                            align="left">
                                            <asp:DataGrid CssClass="grid" BackColor="#f4fbfd" Style="height: auto" ID="dgCountryCode"
                                                ...
                                                OnSortCommand="dgCountryCode_SortCommand" OnItemDataBound="dgCountryCode_ItemDataBound" TabIndex="12">
                                                ...
                                                <Columns>
                                                    <asp:TemplateColumn HeaderText="Actions">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnlEdit" CausesValidation="false" Font-Underline="true" ForeColor="#006600"
                                                                ...
                                                                CommandName="Edit" CommandArgument='<%#  DataBinder.Eval(Container.DataItem,"pCountryMstrID")%>'>Edit</asp:LinkButton>
                                                            <asp:LinkButton ID="lnlDelete" CausesValidation="false" Font-Underline="true" ForeColor="#cc0000"
                                                                ...
                                                                CommandName="Delete" CommandArgument='<%#  DataBinder.Eval(Container.DataItem,"pCountryMstrID")%>'>Delete</asp:LinkButton>
                                                        </ItemTemplate>
                                                        <ItemStyle Width="90px" />
                                                    </asp:TemplateColumn>
                                                    <asp:BoundColumn DataField="CountryCd" HeaderText="Code" SortExpression="CountryCd">
                                                        <ItemStyle CssClass="Left5pxPadd" Width="75px" HorizontalAlign="Left" />
                                                        <HeaderStyle Width="75px" />
                                                    </asp:BoundColumn>
                                                    <asp:BoundColumn DataField="856CountryCd" HeaderText="3 Ltr Code" SortExpression="856CountryCd">
                                                        <ItemStyle CssClass="Left5pxPadd" Width="75px" HorizontalAlign="Left" />
                                                        <HeaderStyle Width="75px" />
                                                    </asp:BoundColumn>
                                                    ...
                                                    <asp:BoundColumn><HeaderStyle Width="180px" /></asp:BoundColumn>
                                                </Columns>
                                            </asp:DataGrid>
