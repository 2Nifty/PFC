<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PriorityCodes.aspx.cs"
                                ...
                                <tr>
                                    ...
                                    <td style="width: 100px">
                                        <asp:ImageButton ID="btnSearch" runat="server" ImageUrl="~/MaintenanceApps/Common/images/BtnSearch.gif"
                                            OnClick="btnSearch_Click" CausesValidation="False" TabIndex="16" /><asp:HiddenField ID="hidPrimaryKey"
                                                runat="server" />
                                    </td>
                                </tr>
                            </table>
                    ...
                    <table style="width: 100%" class="blueBorder" cellpadding="0" cellspacing="0" >
                        <tr>
                            <td class="lightBlueBg">
                                <asp:Label ID="lblHeading" runat="server" Text="Enter Priority Codes Information" CssClass="BanText"
                                    ...
                                    <ContentTemplate>
                                        <table width="175">
                                            ...
                                            <tr>
                                                ...
                                                <asp:LinkButton ID="lnkCode" runat="server" Font-Underline="true" Text="Code" TabIndex="15"></asp:LinkButton>  
                                ...
                                <asp:UpdatePanel ID="upnlbtnsave" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <asp:ImageButton ID="btnDelete" ImageUrl="~/MaintenanceApps/Common/Images/btndelete.gif"
                                            runat="server" CausesValidation="False" OnClick="btnDelete_Click" TabIndex="13" />&nbsp;
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </td>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr class="lightBlueBg">
                                    <td class="lightBlueBg" style="padding-top: 1px; height: 7px; width: 4%;">
                                        <span class="BanText" >Priority Codes</span>
                                    </td>
                                    ...
                                    <td style="padding-top: 1px; height: 7px;" colspan="2">
                                        <div id="div-datagrid" class="Sbar" style="overflow-x: hidden; overflow-y: auto;
                                            ...
                                            <asp:DataGrid CssClass="grid" BackColor="#f4fbfd" Style="height: auto" ID="dgCountryCode"
                                                ...
                                                OnSortCommand="dgCountryCode_SortCommand" OnItemDataBound="dgCountryCode_ItemDataBound" TabIndex="14">
