                                    ...
                                    <tr>
                                        <td>
                                            <table border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="Label2" runat="server" Text="Search By:" Width="80px"></asp:Label></td>
                                                    <td>
                                                        <asp:Label ID="lblSch" runat="server" Text="Type" Width="35px"></asp:Label></td>
                                                    <td>
                                                        <asp:DropDownList ID="ddlType" AutoPostBack="true" runat="server" CssClass="FormCtrl"
                                                            Width="120px" Height="20px" OnSelectedIndexChanged="ddlType_SelectedIndexChanged">
                                                        </asp:DropDownList></td>
                                                    <td style="padding-left: 20px;">
                                                        <asp:Label ID="Label1" runat="server" Text="Number" Width="50px"></asp:Label></td>
                                                    <td>
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="txtCode" CssClass="FormCtrl" runat="server" MaxLength="10" Width="150px"></asp:TextBox></td>                                                    
                                                                            ...
                                                                            <table>
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="padding-top: 1px">
                                                                                        <asp:TextBox ID="txtComment" TextMode="MultiLine" runat="server" CssClass="FormCtrl"  onKeyUp="CommentsCount(this,255)" onChange="CommentsCount(this,255)" 
                                                                                            Height="70px" Width="260px"></asp:TextBox></td>
                                                                                    <td valign=top>
