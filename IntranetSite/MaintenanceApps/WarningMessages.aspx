<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WarningMessages.aspx.cs"
    Inherits="WarningMessages" %>
                    ...
                    <table style="width: 100%" class="blueBorder" cellpadding="0" cellspacing="0" >
                        <tr>
                            <td class="lightBlueBg">
                                <asp:Label ID="lblHeading" runat="server" Text="Enter Warning Message Information" CssClass="BanText"
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 101px; padding-left: 30px" rowspan="5">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 100px">
                                                    <asp:TextBox ID="txtShortDesc" CssClass="FormCtrl" runat="server" TabIndex="3" MaxLength="15" Width="200px"></asp:TextBox></td>
                                                <td style="width: 100px">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="Left2pxPadd DarkBluTxt boldText" style="padding-left: 10px">
                                                    <asp:Label ID="Label1" runat="server" Height="16px" Text="Print Document" Width="111px"></asp:Label></td>
                                                <td style="width: 100px">
                                                    <asp:DropDownList ID="ddlPrintDoc" runat="server" Height="20px" CssClass="FormCtrl" TabIndex="4"
                                                        Width="160px">
                                                    </asp:DropDownList></td>
                                                <td style="width: 100px">
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 100px; height: 26px;">
                                                    <asp:TextBox ID="txtComments" CssClass="FormCtrl" runat="server" TabIndex="5" MaxLength="256" Height="80px" TextMode="MultiLine" Width="200px"></asp:TextBox></td>
                                                <td style="width: 100px; height: 26px">
                                                </td>
                                            </tr>
                                        </table>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr class="lightBlueBg">
                                    <td class="lightBlueBg" style="padding-top: 1px; height: 7px; width: 4%;">
                                        <span class="BanText" >Warning Messages</span>
                                    </td>
