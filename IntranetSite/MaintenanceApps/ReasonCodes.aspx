<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReasonCodes.aspx.cs"
                    ...
                    <table style="width: 100%" class="blueBorder" cellpadding="0" cellspacing="0" >
                        <tr>
                            <td class="lightBlueBg">
                                <asp:Label ID="lblHeading" runat="server" Text="Enter Reason Code Information" CssClass="BanText"
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 101px; padding-left: 30px" rowspan="6">
                                            ...
                                            <tr>
                                                <td class="Left2pxPadd DarkBluTxt boldText" style="padding-left: 10px">
                                                    <asp:Label ID="Label1" runat="server" Height="16px" Text="Issue Doc" Width="111px"></asp:Label></td>
                                                <td style="width: 100px">
                                                    <asp:TextBox ID="txtIssueDoc" runat="server" CssClass="FormCtrl" MaxLength="2" TabIndex="2"
                                            ...
                                            <tr>
                                                <td class="Left2pxPadd DarkBluTxt boldText" style="padding-left: 10px">
                                                    <asp:Label ID="Label2" runat="server" Height="16px" Text="SOE 'DC' Expense" Width="111px"></asp:Label></td>
                                                <td style="width: 100px">
                                                    <asp:TextBox ID="txtSOEExpense" runat="server" CssClass="FormCtrl" MaxLength="15"
                                                        TabIndex="2" Width="50px"></asp:TextBox></td>
                                                <td style="width: 100px">
                                                </td>
                                            </tr>
                                            <tr>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr class="lightBlueBg">
                                    <td class="lightBlueBg" style="padding-top: 1px; height: 7px; width: 4%;">
                                        <span class="BanText" >Reason Code</span>
                                    </td>
                                ...
                                <tr>
                                    <td style="padding-top: 1px; height: 7px;" colspan="2">
                                        <div id="div-datagrid" class="Sbar" style="overflow-x: hidden; overflow-y: auto;
                                            position: relative; top: 0px; left: 0px; height: 255px; width: 800px; border: 0px solid;"
                                            align="left">
