<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FreightTerms.aspx.cs"
                    ...
                    <table style="width: 100%" class="blueBorder" cellpadding="0" cellspacing="0" >
                        <tr>
                            <td class="lightBlueBg">
                                <asp:Label ID="lblHeading" runat="server" Text="Enter Freight Terms Information" CssClass="BanText"
                                ...
                                <asp:UpdatePanel ID="upnlEntry" runat="server" UpdateMode="conditional">
                                    <ContentTemplate>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td class="Left2pxPadd DarkBluTxt boldText" style="padding-left: 10px">
                                                    <asp:Label ID="Label1" runat="server" Height="16px" Text="Delivery Charge" Width="111px"></asp:Label></td>
                                                <td style="width: 100px">
                                                    <asp:TextBox ID="txtDeliveryCharge" runat="server" CssClass="FormCtrl" MaxLength="2" TabIndex="2"
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr class="lightBlueBg">
                                    <td class="lightBlueBg" style="padding-top: 1px; height: 7px; width: 4%;">
                                        <span class="BanText" >Freight Terms</span>
                                    </td>
