<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ClassOfTrade.aspx.cs"
                                ...
                                <tr>
                                    ...
                                    <td style="width: 100px">
                                        <asp:TextBox ID="txtSearchCode" CssClass="FormCtrl" runat="server" AutoCompleteType="disabled"
                                            MaxLength="10" Width="150px" TabIndex="15"></asp:TextBox></td>
                                    <td style="width: 100px">
                    ...
                    <table style="width: 100%" class="blueBorder" cellpadding="0" cellspacing="0" >
                        <tr>
                            <td class="lightBlueBg">
                                <asp:Label ID="lblHeading" runat="server" Text="Enter Class of Trade Information" CssClass="BanText"
                                        ...
                                        <table  >
                                            <tr>
                                                <td style="height: 16px">
                                                    &nbsp;<img id="CloseButton" src="Common/images/close.jpg" onclick="javascript:window.close();" tabindex="17" />                                                
                                                    <asp:ImageButton ID="btnSave" ImageUrl="~/MaintenanceApps/Common/images/BtnSave.gif"
                                                        runat="server" OnClientClick="javascript:return MaintenaceAppsRequiredField();" OnClick="btnSave_Click" Visible="false" TabIndex="10" />
                                                    <asp:ImageButton ID="btnAdd" ImageUrl="~/MaintenanceApps/Common/images/newadd.gif"
                                                        runat="server" CausesValidation="False" OnClick="btnAdd_Click" TabIndex="18" /></td>
                                            </tr>
                                        </table>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                                    ...
                                    <ContentTemplate>
                                        <table width="175">
                                            ...
                                            <tr>
                                                ...
                                                <asp:LinkButton ID="lnkCode" runat="server" Font-Underline="true" Text="Code" TabIndex="16"></asp:LinkButton>  
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr class="lightBlueBg">
                                    <td class="lightBlueBg" style="padding-top: 1px; height: 7px; width: 4%;">
                                        <span class="BanText" >Class of Trade</span>
                                    </td>
                                    ...
                                    <td style="padding-top: 1px; height: 7px;" colspan="2">
                                        <div id="div-datagrid" class="Sbar" style="overflow-x: hidden; overflow-y: auto;
                                            ...
                                            <asp:DataGrid CssClass="grid" BackColor="#f4fbfd" Style="height: auto" ID="dgCountryCode"
                                                ...
                                                OnSortCommand="dgCountryCode_SortCommand" OnItemDataBound="dgCountryCode_ItemDataBound" TabIndex="9">
