...
//alert('WriteBOM');
             var qtyPer;
            //  Don't allow nulls in text box         
            {   
                qtyPer = document.frmBOM.txtQtyPer.value.replace(/'/gi, "").replace(/\"/gi, "");
                if (isNullOrEmpty(qtyPer) == true)
                {
                    alert('Please enter a Qty Per');
                    return false;
                }
            }
...
<body>
    <form id="frmBOM" runat="server">
        ...
        <table cellpadding="0" border="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
                                                    ...
                                                    <table style="width:100%;">
                                                        <tr>
                                                            <td align="right" style="padding-right: 5px;" width="28%">
                                                                <img id="imgHelp" alt="Help" src="../Common/images/help.gif" onclick="javascript:LoadHelp();" style="cursor: hand" />
                                    ...
                                    <ContentTemplate>
                                        <div id="divdatagrid" class="Sbar" runat="server" visible="false" style="overflow: auto; width: 1020px; 
                                            ...
                                            <asp:DataGrid ID="dgBOM" Width="1000px" runat="server" GridLines="both" BorderWidth="1px" 
                                                ...
                                                OnSortCommand="dgBOM_SortCommand" OnItemCommand="dgBOM_ItemCommand">
                                                 ...
                                                 <asp:TemplateColumn HeaderText="Actions">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnlEdit" CausesValidation="false" Font-Underline="true" ForeColor="#006600"
                                                                ...
                                                                CommandName="Edit" CommandArgument='<%#  DataBinder.Eval(Container.DataItem,"pBomDetailId")%>'>Edit</asp:LinkButton>
                                                            <asp:LinkButton ID="lnlDelete" CausesValidation="false" Font-Underline="true" ForeColor="#cc0000"
                                                                ...
                                                                CommandName="Delete" CommandArgument='<%#  DataBinder.Eval(Container.DataItem,"pBomDetailId")%>'>Delete</asp:LinkButton>
                                                        </ItemTemplate>
                                                ...
                                                <td>
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="text-align:center; width:100px;">
                                                                <asp:TextBox ID="txtItemInsert" runat="server" Width="90px" CssClass="FormCtrl"
                                                                   TabIndex="4" onfocus="javascript:this.select();" onkeydown="javascript:if(event.keyCode==13){return ZItem(this.value, this.id);}if(event.keyCode==9){document.frmBOM.btnHidItemInsert.click();}"></asp:TextBox> 
                                                            ...
                                                            <td style="text-align:center; width:100px;">
                                                                <asp:TextBox ID="txtQtyPer" TabIndex="5" Width="40px" onfocus="javascript:this.select();" onkeypress="javascript:ValidateNum1();" onkeydown="javascript:if(event.keyCode==13){return WriteBOM();}" CssClass="FormCtrl" runat="server" />
                                                            </td>
                                                            <td style="text-align:center; width:100px;">
                                                            ...
                                                            <td style="text-align:center; width:100px;">
                                                                <asp:TextBox ID="txtSeqNo" TabIndex="8" Width="55px" onfocus="javascript:this.select();" onkeypress="javascript:ValidateNum1();" onkeydown="javascript:if(event.keyCode==13){return WriteBOM();}" CssClass="FormCtrl" runat="server" ReadOnly="True" Enabled="False" />
                                                        ...
                                                        <tr style="padding-top:5px;">
                                                            ...
                                                            <td style="width:50px;">
                                                            <asp:HiddenField ID="hisPBomDetailId" runat="server" />
            ...
            <tr>
                <td>
                    <uc2:Footer ID="Footer1" Title="Bill Of Materials Maintenance" runat="server" />
                </td>
            </tr>
        </table>
    </form>
