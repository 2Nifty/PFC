				...
				<TR>
					<TD width="10%" >
						<TABLE id="Table3" cellSpacing="0" cellPadding="2" width="40%" border="0">
							<TR>
								<TD><asp:ImageButton ID="ibtnFirst" CausesValidation="false" runat="server" ImageUrl="../Images/PageFirst.jpg" OnClick="ibtnFirst_Click" /></TD>
								<TD><asp:ImageButton ID="ibtnPrevious" CausesValidation="false" runat="server" ImageUrl="../Images/PagePrev.jpg" OnClick="ibtnPrevious_Click"  /></TD>
								...
								<TD><asp:ImageButton ID="btnNext" CausesValidation="false" runat="server" ImageUrl="../Images/PageNext.jpg" OnClick="ImageButton1_Click" /></TD>
								<TD><asp:ImageButton ID="btnLast" CausesValidation="false" runat="server" ImageUrl="../Images/PageLast.jpg" OnClick="btnLast_Click" /></TD>
							</TR>
						</TABLE>
					</TD>
					<TD align="center" >
						...
						<TABLE id="Table4" height="0%" cellSpacing="0" cellPadding="2" border="0">
							...
							<TR>
								<TD  align="right" class="Left2pxPadd">
									<asp:Label id="lblGotoPAge" runat="server" CssClass="TabHead">Go to Page Number :</asp:Label></TD>
								<TD class="Left2pxPadd">
									<asp:TextBox id="txtGotoPage" runat="server" CssClass="FormControls" Width="25px">0</asp:TextBox></TD>
								<TD class="Left2pxPadd">
                                    <asp:ImageButton ID="btnGo" CausesValidation="false" runat="server" ImageUrl="../Images/Go.gif" OnClick="btnGo_Click" /></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
