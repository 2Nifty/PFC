	...
	<TR>
		...
		<img id="Image1"   runat="server" src="~/PreferredPartnerRebate/Common/images/datepicker.gif" onclick="javascript:return OpenDatePicker1(this.id)" />
            ...
            <asp:RegularExpressionValidator ID="rfvDate" runat="server" ControlToValidate="textBox" ValidationGroup="EmpData"
                ...
                ValidationExpression="^(((((0[1-9])|([1-9])|(1[02]))[\-\/\s]?((0[1-9])|([1-9])|([1-2][0-9])|(3[01])))|((([469])|(11))[\-\/\s]?((0[1-9])|([1-9])|([1-2][0-9])|(30)))|((02|2)[\-\/\s]?((0[1-9])|([1-9])|([1-2][0-9]))))[\-\/\s]?\d{4})(\s(((0[1-9])|([0-9])|(1[0-2]))\:(([0-5][0-9])|([0-9]))((\s)|(\:(([0-5][0-9])|([0-9]))\s))([AM|PM|am|pm]{2,2})))?$" CssClass="Required" Display="Dynamic"></asp:RegularExpressionValidator>
            <asp:RequiredFieldValidator ControlToValidate="textBox" ID="RequiredFieldValidator1" runat="server">*</asp:RequiredFieldValidator>
                </td>
