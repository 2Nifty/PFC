...
<head runat="server">
    ...
    function LoadPage(report)
    {
        switch (report){
		case "VM": 
			window.open('VendorMaintenance.aspx' ,'Orders','height=710,width=1020,Addressbar=0,scrollbars=no,location=no,status=no,top='+((screen.height/2) - (760/2))+',left='+((screen.width/2) - (1020/2))+',resizable=no','');	
		break;				
            ...
            <tr>
                <td valign="middle" class="PageHead">
                    <span class="Left5pxPadd">
                        <asp:Label ID="lblParentMenuName" CssClass="BannerText" runat="server" Text="Vendor Management"></asp:Label></span>
                </td>
            </tr>
            <tr>
                                    ...
                                    <tr>
                                        <td id="5TD" class="blackTxt" style="padding-bottom:20px" valign=middle >
                                            ...
                                            <p class="10pxPadding">
                                                ...
                                                <a onclick="LoadPage('VM');"
                                                    href="#" id="x"
                                                    alt="View Vendor Maintenance" onmouseover="ToolTip(this,window.event);"
                                                    onmouseout="ToolTip(this,window.event);">&nbsp;Vendor Maintenance</a>
                                                <br />
                                            </p>
                                        </td>
                                    </tr>
