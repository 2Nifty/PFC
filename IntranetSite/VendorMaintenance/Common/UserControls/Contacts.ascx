<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Contacts.ascx.cs" Inherits="PFC.Intranet.VendorMaintenance.Contacts" %>
...
<table cellpadding="0" cellspacing="0" width="100%" class="blueBorder" style="border-collapse: collapse;">
        ...
        <td>
            <table cellpadding="0" class="lightBlueBg" cellspacing="0" width="100%">
                <tr>
                    ...
                    <td align="right">
                        <asp:ImageButton ID="btnAdd" runat="server" ImageUrl="~/VendorMaintenance/Common/images/newAdd.gif"
                        ...
                        <asp:Button ID="btnShowContact" Visible="false" runat="server" />
    ...
    <tr>
        <td>
            <asp:Panel ID="pnlContacts" runat="server" DefaultButton="ibtnUpdate">  <table width="100%" id="tblContactEntry" runat="server" style="border-collapse: collapse;">
                <tr>
                    <td style="padding-top: 10px; padding-bottom: 10px;">
                        <table width="70%" cellpadding="1" style="border-collapse: collapse;">
                            ...
                            <tr>
                                ...
                                <td class="Left2pxPadd">
                                    <%--<asp:DropDownList ID="ddlExt" CssClass="FormCtrl" runat="server">
                                </asp:DropDownList>--%>
                                    <asp:TextBox MaxLength="7" CssClass="FormCtrl" onkeypress="javascript:ValdateNumber();" ID="txtExt"
                            ...
                            <tr>
                                ...
                                <uc1:PhoneNumber ID="txtMphone" runat="server" />
                                   <%-- <asp:TextBox CssClass="FormCtrl" ID="txtMphone" onkeypress="javascript:ValdateNumber();"
                            ...
                            <tr>
                                ...
                                <td colspan="1" class="Left2pxPadd">
                                    ...
                                    <td colspan="2">
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Invalid Email" ControlToValidate="txtEmail" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator></td>
                            </tr>
                            <tr>
                                <td class="Left2pxPadd">
                ...
                <tr height="36" valign="middle" style="padding-top: 10px;">
                    <td class="lightBlueBg" style="padding-left: 120px; vertical-align: middle; border-collapse: collapse;border:0;">
                        <asp:ImageButton ID="ibtnUpdate" OnClientClick="javascript:return CheckRequiredField(this.id);" CausesValidation="true" runat="server" ImageUrl="~/VendorMaintenance/Common/images/update.gif"
                            OnClick="ibtnUpdate_Click" />
                        <asp:ImageButton ID="ibtnCancel" runat="server" ImageUrl="~/VendorMaintenance/Common/images/cancel.png"
    ...
    <tr>
        <td style="border-collapse: collapse;" width="100%" id="tdDisplay" runat="server" align="center">
          <div id="divDisplay" runat="server" class="Sbar" style="overflow-y:auto;overflow-x:hidden;width:100%;position: relative; ">
                    ...
                    <table cellpadding="1" cellspacing="0" width="100%" style="border-collapse: collapse;">
                        <tr>
                            <td nowrap="nowrap">
                                ...
                                <asp:HiddenField ID="hidContactID" runat="server" Value='<%#DataBinder.Eval(Container,"DataItem.pVendContractID") %>' />
                                <asp:HiddenField ID="hidAddressID" runat="server" Value='<%#DataBinder.Eval(Container,"DataItem.fVendAddrID") %>' />
                            </td>
                        </tr>
                        <tr>
                            <td nowrap="nowrap">
                        ...
                        <tr>
                            <td  align="right" nowrap="nowrap">
                                ...
                                <asp:LinkButton ID="lnkDelete" Font-Underline="true" CommandArgument='<%#DataBinder.Eval(Container,"DataItem.pVendContractID") %>'
