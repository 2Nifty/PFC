<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ERPPurchImportXmlExport.aspx.cs" Inherits="ERPPurchImportXmlExport" %>
...
<head runat="server">
    ...
    <title>ERP Purchase Import XML Export</title>
</head>
            ...
            <asp:UpdatePanel ID="MainUpdatePanel1" runat="server">
                <ContentTemplate>
                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                            ...
                            <td colspan="2" class="PageHead" style="height: 40px">
                                <div class="LeftPadding">
                                    <div align="left" class="BannerText">
                                        ERP Purchase Import XML Export</div>
                                </div>
                            </td>
                        </tr>
                        <tr>
                                        ...
                                        <table cellspacing="2" cellpadding="1" border="0">
                                            <tr>
                                                <td style="width: 180px; padding-left: 10px;">
                                                    <b>ERP Puchase Order to Process</b>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <asp:HyperLink ID="XMLLink" Target="_blank" runat="server">View the XML File</asp:HyperLink>
                                                </td>
                                            </tr>
                                        </table>
                                    </ContentTemplate>
                        ...
                        <tr>
                            <td valign="top" style="height: 520px; padding-left: 10px;">
