...
//		        var pageURL = document.getElementById("hidPOESiteURL").value + "POAgingRpt/POAgingRpt.aspx?UserID=" + document.getElementById("hidUserID").value + "&UserName=" + document.getElementById("hidUserName").value + "&SessionID=" + document.getElementById("hidSessionID").value ;
		        var pageURL = "../POAgingRpt/POAgingRpt.aspx";
		    ...
		    case "LBS365": 
		        var pageURL = "../DayInventoryReport/MonthlyPurchasingBudget.aspx";
                window.open(pageURL, "LBS365", 'height=710,width=1020,scrollbars=no,status=no,top='+((screen.height/2) - (760/2))+',left='+((screen.width/2) - (1020/2))+',resizable=YES',"");
		    break;
    		
		    case "FactorMaint": 
		        var pageURL = "../DayInventoryReport/MonthlyPurchasingFactorMaint.aspx";
                window.open(pageURL, "FactorMaint", 'height=710,width=1020,scrollbars=no,status=no,top='+((screen.height/2) - (760/2))+',left='+((screen.width/2) - (1020/2))+',resizable=YES',"");
		    break;
...
<body>
    <form id="form1" runat="server">
        <div id="ToolTip" style="font-family: arial; size: 11px; display: none; position: absolute;
            ...
            layer-background-color: #ffffcc;" zindex="1">&nbsp;</div>
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td id="5TD" class="blackTxt" style="height: 92px" width="100%">
                                            ...
                                            <%--
                             <p class="10pxPadding"><img src="../Common/Images/Bullet.gif" width="10" height="9" >&nbsp;&nbsp;<a href="http://pfccrystal/prod/pmreports/CPRv8QkPreview.aspx" id="x" alt="View Corporate Purchasing Requirements Report" 
                             onMouseOver="ToolTip(this,window.event);" onMouseOut="ToolTip(this,window.event);">Corporate Purchase Requirements (Item Select) Report</a></p>
--%>
                                            <p class="10pxPadding">
                                                <img src="../Common/Images/Bullet.gif" width="10" height="9">&nbsp;&nbsp;<a href="http://pfccrystal/prod/pmreports/PBOPreview.aspx"
                                            ...
                                            <p class="10pxPadding">
                                                <img src="../Common/Images/Bullet.gif" width="10" height="9">&nbsp;&nbsp;<a href="http://pfccrystal/prod/pmreports/VCCPreview.aspx"
                                                    id="x" alt="View Vendor Price Comparision Report" onmouseover="ToolTip(this,window.event);"
                                                    onmouseout="ToolTip(this,window.event);">Vendor Price Comparison Report</a></p>
                                            <p class="10pxPadding">
                                                <img src="../Common/Images/Bullet.gif" width="10" height="9">&nbsp;&nbsp;<a href="http://pfccrystal/prod/pmreports/OpenPOPreview.aspx"
                                            ...
                                            <%--                              
                             <p class="10pxPadding"><img src="../Common/Images/Bullet.gif" width="10" height="9" >&nbsp;&nbsp;<a href="http://pfccrystal/prod/pmreports/CPRv8Preview.aspx" id="A2" alt="View CPR with ROP Multiplier Report" 
                             onMouseOver="ToolTip(this,window.event);" onMouseOut="ToolTip(this,window.event);">CPR with ROP Multiplier Report&nbsp;</a></p>
--%>
                                            <p class="10pxPadding">
                                                <img src="../Common/Images/Bullet.gif" width="10" height="9">&nbsp;&nbsp;<a href="../CPR/FrontEnd.aspx"
                                                    id="A3" alt="View CPR Web Report" onmouseover="ToolTip(this,window.event);" onmouseout="ToolTip(this,window.event);">CPR
                                                    Web Report&nbsp;</a></p>
                                            <p class="10pxPadding">
                                            ...
                                            <p class="10pxPadding">
                                                <img src="../Common/Images/Bullet.gif" width="10" height="9" onclick="LoadPage('UnrcvdPO');">&nbsp;&nbsp;<a
                                                    href="#" alt="View Unreceived Purchase Orders By Category" onclick="LoadPage('UnrcvdPO');"
                                                    onmouseover="ToolTip(this,window.event);" onmouseout="ToolTip(this,window.event);">&nbsp;Unreceived
                                                    PO Report</a></p>
                                            <%  } %>
                                            <p class="10pxPadding">
                                            ...
                                            <p class="10pxPadding">
                                                <img src="../Common/Images/Bullet.gif" width="10" height="9" onclick="LoadPage('CategoryBuy');">&nbsp;&nbsp;<a
                                                    ...
                                                    onmouseout="ToolTip(this,window.event);">&nbsp;Category Buy Report</a></p>
																						<p class="10pxPadding">
																							<img height="9" onclick="LoadPage('LBS365');" src="../Common/Images/Bullet.gif"
																								width="10">&nbsp;&nbsp;<a alt="View Monthly Purchasing Budget Worksheet" href="#" onclick="LoadPage('LBS365');"
																									onmouseout="ToolTip(this,window.event);" onmouseover="ToolTip(this,window.event);">&nbsp;
																									Monthly Purchasing Budget Worksheet</a></p>
																						<p class="10pxPadding">
																							<img height="9" onclick="LoadPage('FactorMaint');" src="../Common/Images/Bullet.gif"
																								width="10">&nbsp;&nbsp;<a alt="View Monthly Purchasing Factor Maintenance" href="#" onclick="LoadPage('FactorMaint');"
																									onmouseout="ToolTip(this,window.event);" onmouseover="ToolTip(this,window.event);">&nbsp;
																									Monthly Purchasing Factor Maintenance</a></p>
                                        </td>
                                    </tr>
                                </table>
                            </td>
