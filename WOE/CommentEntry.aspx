...
<%@ Register Src="Common/UserControls/MinFooter.ascx" TagName="MinFooter" TagPrefix="uc4" %>
...
<body onclick="javascript:document.getElementById('lblMessage').innerText='';">
    <form id="form1" runat="server">
        ...
        <table border="0" cellpadding="0" cellspacing="2" style="width: 100%; height: 100%;"
            ...
            <tr>
                <td>
                    <uc4:MinFooter ID="MinFooter1" runat="server" Title="Comment Entry" />
                </td>
            </tr>
        </table>
    </form>
