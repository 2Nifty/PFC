...
<head>
    ...
    <link href="../StyleSheet/utilityWndStyles.css" rel="stylesheet" type="text/css" />
                ...
                <div class="wndContainer clearfix" style="width: 638px">
                    <div class="wndTitle">
                        <div class="wndControls">
                            <a href="#" style="display: block; background: #cc0000; border: 1px solid #990000;
                                ...
                                text-decoration: none;" onclick="javascript:parent.window.close();">
                                X</a>
                        </div>
                    ...
                    <div class="wndBody">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" style="padding-left: 10px;" width="100%">
                            <tr>
                                <td>
                                    <asp:ImageButton ImageUrl="../Images/Print_n.gif" ID="btnPrint" runat="server"
                                        OnClick="btnPrint_Click" />
                                    <asp:ImageButton ImageUrl="../Images/Email_n.gif" ID="btnEmail" runat="server"
                                        OnClick="btnEmail_Click" />
                                    <asp:ImageButton ImageUrl="../Images/Fax_n.gif" ID="btnFax" runat="server"
                                    ...
                                    <tr>
                                        <td style="width: 600px;" valign="top">
                                            ...
                                            <table  visible="false" id="tblPrint" runat="server" width="100%">
                                                <tr>
                                                    <td  align="center">
                                                     <asp:ImageButton  ImageUrl="../Images/PrintImg.gif" ID="btnPrinter" runat="server"  />
                                                       </td>
                                                </tr>
                                            </table>
                                            ...
                                            <table cellpadding="0" cellspacing="0" border="0" style="padding-top: 10px;">
                                                <tr>
                                                    <td style="width: 438px" align="right">
                                                        <asp:ImageButton ImageUrl="../Images/PreviewDoc.gif" ID="btnPrintPreviewDoc"
                                                            runat="server" />
                                                        <asp:ImageButton ImageUrl="../Images/setdefaultprinterbig.gif" ID="btnDefaultPrinter"
                                                            runat="server" OnClick="btnDefaultPrinter_Click" />
                                                        <asp:ImageButton OnClick="btnPostPrint_Click1" ImageUrl="../Images/postrequest.gif"
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding-top: 10 px; padding-left: 20px" align="right">
                                                        <asp:ImageButton ID="ibtnSave" runat="server" ImageUrl="../Images/BtnSave.gif"
                                                            OnClick="ibtnSave_Click" />
                                                        <asp:ImageButton ID="btnCancel" ImageUrl="../Images/cancel.gif" runat="server"
                                    ...
                                    <tr>
                                        <td style="width: 700px;" valign="top">
                                                ...
                                                <tr>
                                                    <td style="width: 56px">
                                                       <%-- <asp:LinkButton ID="lnkEmail" CssClass="TabHead" Font-Bold="True" Text="Email To"
                                                        ...
                                                        <asp:Label ID="lnkEmail" runat="server" Text="Email To" Width="46px" Font-Bold="True" ></asp:Label>
                                                    </td>
                                            ...
                                            <table>
                                                <tr>
                                                    <td style="width: 438px" align="right">
                                                        <asp:ImageButton ImageUrl="../Images/PreviewDoc.gif" ID="btnEMailPreviewDoc"
                                                            runat="server" />
                                                        <asp:ImageButton ImageUrl="../Images/postrequest.gif" ID="btnPostEmail" CausesValidation="false"
                                    ...
                                    <tr>
                                        <td style="width: 700px;" valign="top">
                                            <table>
                                                <tr>
                                                    <td style="width: 80px; height: 27px;">
                                                       <%-- <asp:LinkButton ID="lnkFax" runat="server" Text="Fax To" Font-Bold="true"></asp:LinkButton>--%>
                                                        <asp:Label ID="lnkFax" runat="server" Text="Fax To" Width="80px" Font-Bold="true"></asp:Label>
                                                    </td>
                                            ...
                                            <table>
                                                <tr>
                                                    <td style="width: 438px" align="right">
                                                        <asp:ImageButton ImageUrl="../Images/PreviewDoc.gif" ID="btnFAXPreviewDoc"
                                                            runat="server" />
                                                        <asp:ImageButton ID="btnPostFax" ImageUrl="../Images/postrequest.gif" runat="server"
