<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Header.ascx.cs" Inherits="PFC.WOE.Header" %>
<div id="PageHeader" align=center style="color: #FFFFFF;" class="PageHeader">
    <div id="userInfo" >
