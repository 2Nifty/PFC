...
Inherits="PFC.WOE.ListMaintenance.NewFooter" %>
        ...
        <div id="Footer" class="Footer">
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <div align="right">
                            <asp:Image ImageUrl="~/Common/Images/userinfo_left_rev.gif" runat="server"
                    ...
                    <td>
                        <div align="left">
                            <asp:Image ImageUrl="~/Common/Images/userinfo_right_rev.gif" runat="server"
