...
Partial Class CanadaBLDetailRpt
    ...
    Protected Sub ExportDetail_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ExportDetail.Click
        ...
        ExportFile = "\CanadaBL_ERP\Excel\Detail" & Request.QueryString("BLNo") & ".xls"
        ...
        cmd2.CommandText = "SELECT * FROM tLandedCostLines ORDER BY [Cat No]"
        ...
        ExportFile = "\Intranet-PFC\CanadaBL_ERP\Excel\Detail" & Request.QueryString("BLNo") & ".xls"
