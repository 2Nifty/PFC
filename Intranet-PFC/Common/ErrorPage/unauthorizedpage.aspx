<%@ Page language="c#" Inherits="Novantus.Umbrella.Common.ErrorPage.UnauthorizedPage" CodeFile="UnauthorizedPage.aspx.cs" %>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="HeaderBk">
							<tr>
								<td width="1%" align="left" valign="top" class="HeaderTDBorder"><div align="left"><img src="images/HeaderLCurve.jpg" width="15" height="57"></div>
								</td>
								<td width="97%" class="HeaderTDBorder"><div align="left"><img src="images/GUILogo.jpg" width="149" height="57"></div>
								</td>
								<td width="2%" align="right" valign="top" class="HeaderTDBorder"><div align="right"><img src="images/HeaderRCurve.jpg" width="15" height="57"></div>
								</td>
							</tr>
						</table>
					</td>
				...
				<tr>
					<td height="400" valign="top" class="DisplayTDBk"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff" class="WhiteBorder">
							<tr>
								<td width="100%" class="IntfaceNameBotBorder"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="WhiteBorder">
										<tr>
											<td class="InterfaceNameTab"><div align="left" class="BlackBold">Novantus Security 
													System</div>
											</td>
										</tr>
									</table>
							...
							<tr>
								<td height="400" valign="top"><div class="ErrPosition"><table width="391" border="0" align="center" cellpadding="0" cellspacing="0" class="Msgblock">
											<tr>
												<td width="77"><div align="center"><img src="images/alert.gif" hspace="10"></div>
												</td>
												<td height="120"><div><span class="BlackBold">Warning !</span></div>
													<div class="BlackContent"><span> You are not authorized to view this page.Please 
				...
				<tr>
					<td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="FooterBk">
							<tr>
								...
								<td width="98%"><div align="right" class="CopyrightMsg">© Copyright 2006 @ <a href="http://www.novantus.com" class="CopyrightMsg">
											Novantus Corporation</a>. All Rights Reserved.
									</div>
								</td>
