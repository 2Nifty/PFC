namespace  Novantus.Umbrella.UserControls.VendorForecast
{
	using System;
	using System.Data;
	...
	/// </summary>
	public partial class VendorPager : System.Web.UI.UserControl
	{
        ...
        public int SetPageTotal
        {
            set
            {
                lblTotalPageCaption.Visible = true;
		...
		*/
        ...
        protected void ddlPages_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (gotoPageNumber != (Convert.ToInt32(ddlPages.SelectedItem.Value) - 1) && ddlPages.SelectedItem.Value != "-1")
            {
                ...
                lblCurrentPageCount.Text = ddlPages.SelectedItem.Value.ToString();
                OnBubbleClick(e);
            }
        }
