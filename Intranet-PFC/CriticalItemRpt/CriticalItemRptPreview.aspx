<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CriticalItemRptPreview.aspx.cs"
    Inherits="CriticalItemRptPreview" %>
                            ...
                            <td class="PageHead" colspan="2" valign="middle">
                                <div id="PrintDG1">
                                    <div align="left" class="LeftPadding">
                                        BULK Critical Item Report Summary</div>
                                </div>
                            </td>
                        </tr>
                        <tr>
                                            ...
                                            <div id="div-datagrid" class="Sbar" style="overflow: auto; position: relative; top: 0px;
                                                ...
                                                <div id="PrintDG3">
                                                    <asp:DataGrid ID="GridView1" BackColor="#F4FBFD" runat="server" BorderWidth="1px"
                                                        ...
                                                        <Columns>
                                                            <asp:BoundColumn DataField="VelocityCode" HeaderText="Velocity Code" SortExpression="VelocityCode">
                                                                <ItemStyle Font-Size="8" HorizontalAlign="Center" Width="75px" />
