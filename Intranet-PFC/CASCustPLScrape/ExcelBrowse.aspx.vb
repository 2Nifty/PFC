...
Partial Class BudgetMaint
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack Then
            ...
            If FileUpload1.HasFile Then
                ...
                If fileOK Then
                    ...
                    End Try
                    Server.Transfer("ExcelImport.aspx?xls=" & FileUpload1.FileName & "&year=" & Request.Form("LoadYear") & "&month=" & Request.Form("LoadMonth"), True)
                    'FileUpload1.Dispose()
                Else
        ...
        Else
            For ctr = 1 To 12
                LoadMonth.Items.Add(New ListItem(ctr, ctr))
                If ctr = now.month Then
                    LoadMonth.SelectedIndex = ctr - 1
                End If
            Next
            For ctr = 2005 To 2016
                LoadYear.Items.Add(New ListItem(ctr, ctr))
            Next
            LoadYear.SelectedIndex = Year(Now) - 2005
        End If
        ...
        For Each fiTemp In fi
            ...
            NewButton.ID = "Load" & fiTemp.Name
            NewButton.Width = 50
            NewButton.ToolTip = "Click To PREVIEW FILE PRIOR TO UPDATING"
            NewButton.PostBackUrl = "ExcelImport.aspx"
